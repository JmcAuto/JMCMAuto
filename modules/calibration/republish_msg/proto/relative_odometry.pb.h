...
class RelativeOdometry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.calibration.republish_msg.RelativeOdometry) */ {
 public:
  RelativeOdometry();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.calibration.republish_msg.RelativeOdometry)
 private:
  void set_has_header();
...
inline const ::jmc_auto::common::Header& RelativeOdometry::header() const {
...
inline ::jmc_auto::common::Header* RelativeOdometry::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
...
inline ::jmc_auto::common::Header* RelativeOdometry::release_header() {
...
inline void RelativeOdometry::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline const ::jmc_auto::common::PointENU& RelativeOdometry::position() const {
...
inline ::jmc_auto::common::PointENU* RelativeOdometry::mutable_position() {
  set_has_position();
  if (position_ == NULL) {
...
inline ::jmc_auto::common::PointENU* RelativeOdometry::release_position() {
...
inline void RelativeOdometry::set_allocated_position(::jmc_auto::common::PointENU* position) {
  delete position_;
  position_ = position;
  if (position) {
    set_has_position();
...
inline const ::jmc_auto::common::Quaternion& RelativeOdometry::orientation() const {
...
inline ::jmc_auto::common::Quaternion* RelativeOdometry::mutable_orientation() {
  set_has_orientation();
...
inline ::jmc_auto::common::Quaternion* RelativeOdometry::release_orientation() {
...
inline void RelativeOdometry::set_allocated_orientation(::jmc_auto::common::Quaternion* orientation) {
  delete orientation_;
