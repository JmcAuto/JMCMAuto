...
DEFINE_string(
    ...
    "/jmcauto/modules/perception/tool/data_generator/conf/adapter.conf",
    "The data generator adapter config filename.");

DEFINE_string(
    data_generator_config_file,
    "/jmcauto/modules/perception/tool/data_generator/conf/config.pb.txt",
    "The data generator config file.");

DEFINE_string(data_file_prefix,
              "/jmcauto/modules/perception/tool/data_generator/data/",
