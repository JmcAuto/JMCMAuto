...
using jmc_auto::perception::CalibrationConfigManager;
using jmc_auto::perception::CameraCalibrationPtr;
...
void GLFWFusionViewer::draw_lane_objects_ground() {
  ...
  for (size_t k = 0; k < lane_objects_->size(); ++k) {
    ...
    switch (lane_objects_->at(k).spatial) {
      case jmc_auto::perception::SpatialLabelType::L_0: {
        glColor3f(1.0f, 0.0f, 0.0f);  // red
        break;
      }
      case jmc_auto::perception::SpatialLabelType::L_1: {
        glColor3f(1.0f, 0.0f, 1.0f);  // magenta
        break;
      }
      case jmc_auto::perception::SpatialLabelType::L_2: {
        glColor3f(0.6f, 0.25f, 1.0f);  // purple
        break;
      }
      case jmc_auto::perception::SpatialLabelType::R_0: {
        glColor3f(0.0f, 0.0f, 1.0f);  // blue
        break;
      }
      case jmc_auto::perception::SpatialLabelType::R_1: {
        glColor3f(0.0f, 1.0f, 1.0f);  // cyan
        break;
      }
      case jmc_auto::perception::SpatialLabelType::R_2: {
