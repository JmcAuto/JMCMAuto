...
DEFINE_string(test_dir,
              "/jmcauto/modules/perception/data/yolo_camera_detector_test/",
              "test data directory");
...
using jmc_auto::perception::obstacle::yolo::YoloParam;
...
TEST_F(YoloCameraDetectorTest, model_init_test) {
  const std::string yolo_config =
      "/jmcauto/modules/perception/model/yolo_camera_detector/config.pt";
