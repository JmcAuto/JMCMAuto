...
bool load_types(const string &path, vector<ObjectType> *types) {
  const map<string, ObjectType> type_map = {
      {"UNKNOWN", jmc_auto::perception::ObjectType::UNKNOWN},
      {"UNKNOWN_MOVABLE", jmc_auto::perception::ObjectType::UNKNOWN_MOVABLE},
      {"UNKNOWN_UNMOVABLE", jmc_auto::perception::ObjectType::UNKNOWN_UNMOVABLE},
      {"PEDESTRIAN", jmc_auto::perception::ObjectType::PEDESTRIAN},
      {"BICYCLE", jmc_auto::perception::ObjectType::BICYCLE},
      {"VEHICLE", jmc_auto::perception::ObjectType::VEHICLE},
  };

  ifstream ifs(path, ifstream::in);
  if (!ifs.good()) {
    AERROR << "type_list not found, use default: VEHICLE, BICYCLE, PEDESTRIAN";
    (*types) = {jmc_auto::perception::ObjectType::VEHICLE,
                jmc_auto::perception::ObjectType::BICYCLE,
                jmc_auto::perception::ObjectType::PEDESTRIAN};
  } else {
    string type;
