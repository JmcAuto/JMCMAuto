...
using jmc_auto::hdmap::BoundaryEdge;
using jmc_auto::hdmap::BoundaryEdge_Type_LEFT_BOUNDARY;
using jmc_auto::hdmap::BoundaryEdge_Type_RIGHT_BOUNDARY;
using jmc_auto::hdmap::HDMapUtil;
using jmc_auto::hdmap::JunctionBoundaryPtr;
using jmc_auto::hdmap::JunctionInfoConstPtr;
using jmc_auto::hdmap::LineSegment;
using jmc_auto::hdmap::RoadROIBoundaryPtr;
