...
void UltrasonicObstacleSubnode::OnUltrasonic(
  ...
  if (!PublishDataAndEvent(timestamp, sensor_objects)) {
    ...
    sensor_objects->error_code = jmc_auto::common::PERCEPTION_ERROR_PROCESS;
    return;
  }
...
void UltrasonicObstacleSubnode::BuildSingleObject(
    const jmc_auto::canbus::Sonar& sonar,
  ...
  double sonar_relative_heading = jmc_auto::common::math::QuaternionToHeading(
...
void UltrasonicObstacleSubnode::BuildAllObjects(
    const jmc_auto::canbus::Surround& surround,
