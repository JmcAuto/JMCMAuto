...
const char polygon_file_name[] =
    "/jmcauto/modules/perception/data/hdmap_roi_filter_test/poly_mask_ut.poly";
const char pcd_file_name[] =
    "/jmcauto/modules/perception/data/hdmap_roi_filter_test/poly_mask_ut.pcd";
...
void HdmapROIFilterTest::init() {
  FLAGS_work_root = "/jmcauto/modules/perception/data";
