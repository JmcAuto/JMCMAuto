...
using jmc_auto::common::util::DisjointSetFind;
using jmc_auto::common::util::DisjointSetMakeSet;
using jmc_auto::common::util::DisjointSetUnion;
...
struct Obstacle {
  ...
  jmc_auto::perception::pcl_util::PointCloudPtr cloud;
  float score;
  float height;
  MetaType meta_type;
  ...
  Obstacle() : score(0.0), height(-5.0), meta_type(MetaType::META_UNKNOWN) {
    cloud.reset(new jmc_auto::perception::pcl_util::PointCloud);
...
class Cluster2D {
 public:
  ...
  void Cluster(const caffe::Blob<float>& category_pt_blob,
               ...
               jmc_auto::perception::pcl_util::PointCloudPtr pc_ptr,
               const jmc_auto::perception::pcl_util::PointIndices& valid_indices,
  ...
  void Filter(const caffe::Blob<float>& confidence_pt_blob,
    ...
    for (size_t obstacle_id = 0; obstacle_id < obstacles_.size();
      ...
      obs->cloud.reset(new jmc_auto::perception::pcl_util::PointCloud);
    }
  }
  ...
  void GetObjects(const float confidence_thresh, const float height_thresh,
    ...
    for (size_t obstacle_id = 0; obstacle_id < obstacles_.size();
      ...
      std::shared_ptr<Object> out_obj(new jmc_auto::perception::Object);
 ...
 private:
  ...
  jmc_auto::perception::pcl_util::PointCloudPtr pc_ptr_;
