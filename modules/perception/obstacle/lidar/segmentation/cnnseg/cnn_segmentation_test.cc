...
using jmc_auto::perception::CNNSegmentation;
using jmc_auto::perception::pcl_util::PointCloud;
using jmc_auto::perception::pcl_util::PointCloudPtr;
using jmc_auto::perception::pcl_util::PointIndices;
...
DEFINE_string(test_dir, "/jmcauto/modules/perception/data/cnnseg_test/",
              "test data directory");
...
bool GetPointCloudFromFile(const string &pcd_file, PointCloudPtr cloud) {
  ...
  for (size_t i = 0; i < ori_cloud.points.size(); ++i) {
    jmc_auto::perception::pcl_util::Point point;
