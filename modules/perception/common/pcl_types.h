...
POINT_CLOUD_REGISTER_POINT_STRUCT(
    jmc_auto::perception::pcl_util::PointD,
    (double, x, x)(double, y, y)(double, z, z)(uint8_t, intensity, intensity))

POINT_CLOUD_REGISTER_POINT_STRUCT(jmc_auto::perception::pcl_util::PointXYZIH,
                                  (float, x, x)(float, y, y)(float, z, z)(
                                      float, intensity, intensity)(float, h, h))

POINT_CLOUD_REGISTER_POINT_STRUCT(jmc_auto::perception::pcl_util::PointXYZIT,
                                  (float, x, x)(float, y, y)(float, z, z)(
                                      uint8_t, intensity,
                                      intensity)(double, timestamp, timestamp))
POINT_CLOUD_REGISTER_POINT_STRUCT(jmc_auto::perception::pcl_util::RawPointXYZIT,
                                  (float, x, x)(float, y, y)(float, z, z)(
                                      uint8_t, intensity,
                                      intensity)(double, timestamp, timestamp))

POINT_CLOUD_REGISTER_POINT_STRUCT(
    jmc_auto::perception::pcl_util::PointXYZIRT,
    (float, x, x)(float, y, y)(float, z, z)(uint8_t, intensity, intensity)(
        uint8_t, ring, ring)(double, timestamp, timestamp))

POINT_CLOUD_REGISTER_POINT_STRUCT(jmc_auto::perception::pcl_util::PointXYZITd,
                                  (double, x, x)(double, y, y)(double, z, z)(
                                      uint8_t, intensity,
                                      intensity)(double, timestamp, timestamp))

POINT_CLOUD_REGISTER_POINT_STRUCT(
    jmc_auto::perception::pcl_util::PointXYZIRTd,
    (double, x, x)(double, y, y)(double, z, z)(uint8_t, intensity, intensity)(
        uint8_t, ring, ring)(double, timestamp, timestamp))
