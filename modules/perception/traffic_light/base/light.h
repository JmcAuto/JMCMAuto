...
typedef jmc_auto::perception::TrafficLight::Color TLColor;
...
struct Light {
  ...
  explicit Light(const jmc_auto::hdmap::Signal &signal) : info(signal) {}
  jmc_auto::hdmap::Signal info;  //  Light info in the map.
...
double Distance2Stopline(
    ...
    const google::protobuf::RepeatedPtrField<jmc_auto::hdmap::Curve> &stoplines);
