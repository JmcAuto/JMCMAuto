...
class ModelConfigs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.perception.geometry_camera_converter_config.ModelConfigs) */ {
 public:
  ModelConfigs();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.perception.geometry_camera_converter_config.ModelConfigs)
 private:
  void set_has_name();
  void clear_has_name();
  ...
  friend struct protobuf_modules_2fperception_2fproto_2fgeometry_5fcamera_5fconverter_5fconfig_2eproto::TableStruct;
};
// ===================================================================
