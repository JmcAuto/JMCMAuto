...
class ModelConfigs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.perception.tracker_config.ModelConfigs) */ {
 public:
  ModelConfigs();
  ...
  ::jmc_auto::perception::tracker_config::ModelConfigs_MatcherType matcher_method() const;
  void set_matcher_method(::jmc_auto::perception::tracker_config::ModelConfigs_MatcherType value);
  ...
  ::jmc_auto::perception::tracker_config::ModelConfigs_FilterType filter_method() const;
  void set_filter_method(::jmc_auto::perception::tracker_config::ModelConfigs_FilterType value);
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.perception.tracker_config.ModelConfigs)
 private:
  void set_has_name();
  void clear_has_name();
...
inline ::jmc_auto::perception::tracker_config::ModelConfigs_MatcherType ModelConfigs::matcher_method() const {
...
inline void ModelConfigs::set_matcher_method(::jmc_auto::perception::tracker_config::ModelConfigs_MatcherType value) {
...
inline ::jmc_auto::perception::tracker_config::ModelConfigs_FilterType ModelConfigs::filter_method() const {
...
inline void ModelConfigs::set_filter_method(::jmc_auto::perception::tracker_config::ModelConfigs_FilterType value) {
...
template <> struct is_proto_enum< ::jmc_auto::perception::tracker_config::ModelConfigs_MatcherType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::perception::tracker_config::ModelConfigs_MatcherType>() {
  return ::jmc_auto::perception::tracker_config::ModelConfigs_MatcherType_descriptor();
}
template <> struct is_proto_enum< ::jmc_auto::perception::tracker_config::ModelConfigs_FilterType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::perception::tracker_config::ModelConfigs_FilterType>() {
  return ::jmc_auto::perception::tracker_config::ModelConfigs_FilterType_descriptor();
}
