...
class ModelConfigs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.perception.yolo_camera_detector_config.ModelConfigs) */ {
 public:
  ModelConfigs();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.perception.yolo_camera_detector_config.ModelConfigs)
 private:
  void set_has_name();
  void clear_has_name();
  ...
  friend struct protobuf_modules_2fperception_2fproto_2fyolo_5fcamera_5fdetector_5fconfig_2eproto::TableStruct;
};
// ===================================================================
