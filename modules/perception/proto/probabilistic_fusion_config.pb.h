...
class ModelConfigs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.perception.probabilistic_fusion_config.ModelConfigs) */ {
 public:
  ModelConfigs();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.perception.probabilistic_fusion_config.ModelConfigs)
 private:
  void set_has_name();
  void clear_has_name();
  ...
  bool use_radar_;
  bool use_lidar_;
  friend struct protobuf_modules_2fperception_2fproto_2fprobabilistic_5ffusion_5fconfig_2eproto::TableStruct;
};
// ===================================================================
