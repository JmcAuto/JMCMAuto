...
// source: modules/localization_dy/proto/measure.proto

#define INTERNAL_SUPPRESS_PROTOBUF_FIELD_DEPRECATION
#include "modules/localization_dy/proto/measure.pb.h"
...
namespace protobuf_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/localization_dy/proto/measure.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  _IntegMeasure_default_instance_.get_mutable()->header_ = const_cast< ::jmc_auto::common::Header*>(
      ::jmc_auto::common::Header::internal_default_instance());
  _IntegMeasure_default_instance_.get_mutable()->position_ = const_cast< ::jmc_auto::common::Point3D*>(
      ::jmc_auto::common::Point3D::internal_default_instance());
  _IntegMeasure_default_instance_.get_mutable()->velocity_ = const_cast< ::jmc_auto::common::Point3D*>(
      ::jmc_auto::common::Point3D::internal_default_instance());
}
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      "\n+modules/localization_dy/proto/measure."
      "proto\022\030jmc_auto.localization_dy\032!modules"
      "/common/proto/header.proto\032#modules/comm"
      "on/proto/geometry.proto\"\346\004\n\014IntegMeasure"
      "\022\'\n\006header\030\001 \001(\0132\027.jmc_auto.common.Heade"
      "r\022H\n\014measure_type\030\002 \001(\01622.jmc_auto.local"
      "ization_dy.IntegMeasure.MeasureType\022D\n\nf"
      "rame_type\030\003 \001(\01620.jmc_auto.localization_"
      "dy.IntegMeasure.FrameType\022*\n\010position\030\004 "
      "\001(\0132\030.jmc_auto.common.Point3D\022*\n\010velocit"
      "y\030\005 \001(\0132\030.jmc_auto.common.Point3D\022\013\n\003yaw"
      "\030\006 \001(\001\022\017\n\007zone_id\030\007 \001(\005\022\030\n\020is_have_varia"
      "nce\030\010 \001(\010\022\036\n\026is_gnss_double_antenna\030\t \001("
      "\010\022\031\n\rmeasure_covar\030\n \003(\001B\002\020\001\"\232\001\n\013Measure"
      "Type\022\021\n\rGNSS_POS_ONLY\020\000\022\020\n\014GNSS_POS_VEL\020"
      "\001\022\017\n\013GNSS_POS_XY\020\002\022\021\n\rGNSS_VEL_ONLY\020\003\022\023\n"
      "\017POINT_CLOUD_POS\020\004\022\025\n\021ODOMETER_VEL_ONLY\020"
      "\005\022\026\n\022VEHICLE_CONSTRAINT\020\006\"5\n\tFrameType\022\007"
      "\n\003ENU\020\000\022\010\n\004ECEF\020\001\022\007\n\003UTM\020\002\022\014\n\010ODOMETER\020\003"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 760);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "modules/localization_dy/proto/measure.proto", &protobuf_RegisterTypes);
...
const ::google::protobuf::EnumDescriptor* IntegMeasure_MeasureType_descriptor() {
  protobuf_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto::file_level_enum_descriptors[0];
}
...
const ::google::protobuf::EnumDescriptor* IntegMeasure_FrameType_descriptor() {
  protobuf_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto::file_level_enum_descriptors[1];
}
...
IntegMeasure::IntegMeasure()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto::InitDefaults();
  }
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.localization_dy.IntegMeasure)
}
IntegMeasure::IntegMeasure(const IntegMeasure& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.localization_dy.IntegMeasure)
}
...
IntegMeasure::~IntegMeasure() {
  // @@protoc_insertion_point(destructor:jmc_auto.localization_dy.IntegMeasure)
  SharedDtor();
}
...
const ::google::protobuf::Descriptor* IntegMeasure::descriptor() {
  protobuf_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.localization_dy.IntegMeasure)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:jmc_auto.localization_dy.IntegMeasure)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // optional .jmc_auto.localization_dy.IntegMeasure.MeasureType measure_type = 2;
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::jmc_auto::localization_dy::IntegMeasure_MeasureType_IsValid(value)) {
            set_measure_type(static_cast< ::jmc_auto::localization_dy::IntegMeasure_MeasureType >(value));
          } else {
      ...
      // optional .jmc_auto.localization_dy.IntegMeasure.FrameType frame_type = 3;
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::jmc_auto::localization_dy::IntegMeasure_FrameType_IsValid(value)) {
            set_frame_type(static_cast< ::jmc_auto::localization_dy::IntegMeasure_FrameType >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.localization_dy.IntegMeasure)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.localization_dy.IntegMeasure)
  return false;
#undef DO_
}
...
void IntegMeasure::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:jmc_auto.localization_dy.IntegMeasure)
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.localization_dy.IntegMeasure)
}

::google::protobuf::uint8* IntegMeasure::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.localization_dy.IntegMeasure)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.localization_dy.IntegMeasure)
  return target;
}

size_t IntegMeasure::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.localization_dy.IntegMeasure)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.localization_dy.IntegMeasure)
  GOOGLE_DCHECK_NE(&from, this);
  const IntegMeasure* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const IntegMeasure>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.localization_dy.IntegMeasure)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.localization_dy.IntegMeasure)
    MergeFrom(*source);
  }
}

void IntegMeasure::MergeFrom(const IntegMeasure& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.localization_dy.IntegMeasure)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.localization_dy.IntegMeasure)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.localization_dy.IntegMeasure)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata IntegMeasure::GetMetadata() const {
  protobuf_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
const ::jmc_auto::common::Header& IntegMeasure::header() const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization_dy.IntegMeasure.header)
  return header_ != NULL ? *header_
                         : *::jmc_auto::common::Header::internal_default_instance();
}
::jmc_auto::common::Header* IntegMeasure::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
    header_ = new ::jmc_auto::common::Header;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.localization_dy.IntegMeasure.header)
  return header_;
}
::jmc_auto::common::Header* IntegMeasure::release_header() {
  // @@protoc_insertion_point(field_release:jmc_auto.localization_dy.IntegMeasure.header)
  clear_has_header();
  ::jmc_auto::common::Header* temp = header_;
  header_ = NULL;
  return temp;
}
void IntegMeasure::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.localization_dy.IntegMeasure.header)
}
...
::jmc_auto::localization_dy::IntegMeasure_MeasureType IntegMeasure::measure_type() const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization_dy.IntegMeasure.measure_type)
  return static_cast< ::jmc_auto::localization_dy::IntegMeasure_MeasureType >(measure_type_);
}
void IntegMeasure::set_measure_type(::jmc_auto::localization_dy::IntegMeasure_MeasureType value) {
  assert(::jmc_auto::localization_dy::IntegMeasure_MeasureType_IsValid(value));
  set_has_measure_type();
  measure_type_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.localization_dy.IntegMeasure.measure_type)
}
...
::jmc_auto::localization_dy::IntegMeasure_FrameType IntegMeasure::frame_type() const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization_dy.IntegMeasure.frame_type)
  return static_cast< ::jmc_auto::localization_dy::IntegMeasure_FrameType >(frame_type_);
}
void IntegMeasure::set_frame_type(::jmc_auto::localization_dy::IntegMeasure_FrameType value) {
  assert(::jmc_auto::localization_dy::IntegMeasure_FrameType_IsValid(value));
  set_has_frame_type();
  frame_type_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.localization_dy.IntegMeasure.frame_type)
}
...
const ::jmc_auto::common::Point3D& IntegMeasure::position() const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization_dy.IntegMeasure.position)
  return position_ != NULL ? *position_
                         : *::jmc_auto::common::Point3D::internal_default_instance();
}
::jmc_auto::common::Point3D* IntegMeasure::mutable_position() {
  set_has_position();
  if (position_ == NULL) {
    position_ = new ::jmc_auto::common::Point3D;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.localization_dy.IntegMeasure.position)
  return position_;
}
::jmc_auto::common::Point3D* IntegMeasure::release_position() {
  // @@protoc_insertion_point(field_release:jmc_auto.localization_dy.IntegMeasure.position)
  clear_has_position();
  ::jmc_auto::common::Point3D* temp = position_;
  position_ = NULL;
  return temp;
}
void IntegMeasure::set_allocated_position(::jmc_auto::common::Point3D* position) {
  delete position_;
  position_ = position;
  if (position) {
    set_has_position();
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.localization_dy.IntegMeasure.position)
}
...
const ::jmc_auto::common::Point3D& IntegMeasure::velocity() const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization_dy.IntegMeasure.velocity)
  return velocity_ != NULL ? *velocity_
                         : *::jmc_auto::common::Point3D::internal_default_instance();
}
::jmc_auto::common::Point3D* IntegMeasure::mutable_velocity() {
  set_has_velocity();
  if (velocity_ == NULL) {
    velocity_ = new ::jmc_auto::common::Point3D;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.localization_dy.IntegMeasure.velocity)
  return velocity_;
}
::jmc_auto::common::Point3D* IntegMeasure::release_velocity() {
  // @@protoc_insertion_point(field_release:jmc_auto.localization_dy.IntegMeasure.velocity)
  clear_has_velocity();
  ::jmc_auto::common::Point3D* temp = velocity_;
  velocity_ = NULL;
  return temp;
}
void IntegMeasure::set_allocated_velocity(::jmc_auto::common::Point3D* velocity) {
  delete velocity_;
  velocity_ = velocity;
  if (velocity) {
    set_has_velocity();
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.localization_dy.IntegMeasure.velocity)
}
...
double IntegMeasure::yaw() const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization_dy.IntegMeasure.yaw)
  return yaw_;
}
void IntegMeasure::set_yaw(double value) {
  set_has_yaw();
  yaw_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.localization_dy.IntegMeasure.yaw)
}
...
::google::protobuf::int32 IntegMeasure::zone_id() const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization_dy.IntegMeasure.zone_id)
  return zone_id_;
}
void IntegMeasure::set_zone_id(::google::protobuf::int32 value) {
  set_has_zone_id();
  zone_id_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.localization_dy.IntegMeasure.zone_id)
}
...
bool IntegMeasure::is_have_variance() const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization_dy.IntegMeasure.is_have_variance)
  return is_have_variance_;
}
void IntegMeasure::set_is_have_variance(bool value) {
  set_has_is_have_variance();
  is_have_variance_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.localization_dy.IntegMeasure.is_have_variance)
}
...
bool IntegMeasure::is_gnss_double_antenna() const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization_dy.IntegMeasure.is_gnss_double_antenna)
  return is_gnss_double_antenna_;
}
void IntegMeasure::set_is_gnss_double_antenna(bool value) {
  set_has_is_gnss_double_antenna();
  is_gnss_double_antenna_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.localization_dy.IntegMeasure.is_gnss_double_antenna)
}
...
double IntegMeasure::measure_covar(int index) const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization_dy.IntegMeasure.measure_covar)
  return measure_covar_.Get(index);
}
void IntegMeasure::set_measure_covar(int index, double value) {
  measure_covar_.Set(index, value);
  // @@protoc_insertion_point(field_set:jmc_auto.localization_dy.IntegMeasure.measure_covar)
}
void IntegMeasure::add_measure_covar(double value) {
  measure_covar_.Add(value);
  // @@protoc_insertion_point(field_add:jmc_auto.localization_dy.IntegMeasure.measure_covar)
}
const ::google::protobuf::RepeatedField< double >&
IntegMeasure::measure_covar() const {
  // @@protoc_insertion_point(field_list:jmc_auto.localization_dy.IntegMeasure.measure_covar)
  return measure_covar_;
}
::google::protobuf::RepeatedField< double >*
IntegMeasure::mutable_measure_covar() {
  // @@protoc_insertion_point(field_mutable_list:jmc_auto.localization_dy.IntegMeasure.measure_covar)
  return &measure_covar_;
}
