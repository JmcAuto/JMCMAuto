...
#ifndef PROTOBUF_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto__INCLUDED
#define PROTOBUF_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto__INCLUDED
...
class IntegMeasure : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.localization_dy.IntegMeasure) */ {
 public:
  IntegMeasure();
  ...
  ::jmc_auto::localization_dy::IntegMeasure_MeasureType measure_type() const;
  void set_measure_type(::jmc_auto::localization_dy::IntegMeasure_MeasureType value);
  ...
  ::jmc_auto::localization_dy::IntegMeasure_FrameType frame_type() const;
  void set_frame_type(::jmc_auto::localization_dy::IntegMeasure_FrameType value);
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.localization_dy.IntegMeasure)
 private:
  void set_has_header();
  ...
  friend struct protobuf_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto::TableStruct;
};
// ===================================================================
...
inline ::jmc_auto::localization_dy::IntegMeasure_MeasureType IntegMeasure::measure_type() const {
...
inline void IntegMeasure::set_measure_type(::jmc_auto::localization_dy::IntegMeasure_MeasureType value) {
...
inline ::jmc_auto::localization_dy::IntegMeasure_FrameType IntegMeasure::frame_type() const {
...
inline void IntegMeasure::set_frame_type(::jmc_auto::localization_dy::IntegMeasure_FrameType value) {
...
template <> struct is_proto_enum< ::jmc_auto::localization_dy::IntegMeasure_MeasureType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::localization_dy::IntegMeasure_MeasureType>() {
  return ::jmc_auto::localization_dy::IntegMeasure_MeasureType_descriptor();
}
template <> struct is_proto_enum< ::jmc_auto::localization_dy::IntegMeasure_FrameType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::localization_dy::IntegMeasure_FrameType>() {
  return ::jmc_auto::localization_dy::IntegMeasure_FrameType_descriptor();
}
...
#endif  // PROTOBUF_modules_2flocalization_5fdy_2fproto_2fmeasure_2eproto__INCLUDED
