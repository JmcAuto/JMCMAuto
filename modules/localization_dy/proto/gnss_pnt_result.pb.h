...
#ifndef PROTOBUF_modules_2flocalization_5fdy_2fproto_2fgnss_5fpnt_5fresult_2eproto__INCLUDED
#define PROTOBUF_modules_2flocalization_5fdy_2fproto_2fgnss_5fpnt_5fresult_2eproto__INCLUDED
...
class SatDirCosine : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.localization_dy.SatDirCosine) */ {
 public:
  SatDirCosine();
  ...
  inline SatDirCosine* New() const PROTOBUF_FINAL { return New(NULL); }

  SatDirCosine* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.localization_dy.SatDirCosine)
 private:
  void set_has_sat_prn();
  void clear_has_sat_prn();
  void set_has_sat_sys();
  void clear_has_sat_sys();
  void set_has_cosine_x();
  void clear_has_cosine_x();
  void set_has_cosine_y();
  void clear_has_cosine_y();
  void set_has_cosine_z();
  void clear_has_cosine_z();
  ...
  double cosine_y_;
  double cosine_z_;
  friend struct protobuf_modules_2flocalization_5fdy_2fproto_2fgnss_5fpnt_5fresult_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class GnssPntResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.localization_dy.GnssPntResult) */ {
 public:
  GnssPntResult();
  ...
  inline GnssPntResult* New() const PROTOBUF_FINAL { return New(NULL); }

  GnssPntResult* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  const ::jmc_auto::localization_dy::SatDirCosine& sat_dir_cosine(int index) const;
  ::jmc_auto::localization_dy::SatDirCosine* mutable_sat_dir_cosine(int index);
  ::jmc_auto::localization_dy::SatDirCosine* add_sat_dir_cosine();
  ...
  ::jmc_auto::localization_dy::PntType pnt_type() const;
  void set_pnt_type(::jmc_auto::localization_dy::PntType value);
  ...
  ::jmc_auto::drivers::gnss::GnssTimeType time_type() const;
  void set_time_type(::jmc_auto::drivers::gnss::GnssTimeType value);

  // @@protoc_insertion_point(class_scope:jmc_auto.localization_dy.GnssPntResult)
 private:
  void set_has_receiver_id();
  void clear_has_receiver_id();
  void set_has_time_type();
  void clear_has_time_type();
  void set_has_gnss_week();
  void clear_has_gnss_week();
  void set_has_gnss_second_s();
  void clear_has_gnss_second_s();
  void set_has_pnt_type();
  void clear_has_pnt_type();
  void set_has_pos_x_m();
  void clear_has_pos_x_m();
  void set_has_pos_y_m();
  void clear_has_pos_y_m();
  void set_has_pos_z_m();
  void clear_has_pos_z_m();
  void set_has_std_pos_x_m();
  void clear_has_std_pos_x_m();
  void set_has_std_pos_y_m();
  void clear_has_std_pos_y_m();
  void set_has_std_pos_z_m();
  void clear_has_std_pos_z_m();
  void set_has_vel_x_m();
  void clear_has_vel_x_m();
  void set_has_vel_y_m();
  void clear_has_vel_y_m();
  void set_has_vel_z_m();
  void clear_has_vel_z_m();
  void set_has_std_vel_x_m();
  void clear_has_std_vel_x_m();
  void set_has_std_vel_y_m();
  void clear_has_std_vel_y_m();
  void set_has_std_vel_z_m();
  void clear_has_std_vel_z_m();
  void set_has_sovled_sat_num();
  void clear_has_sovled_sat_num();
  void set_has_pdop();
  void clear_has_pdop();
  void set_has_hdop();
  void clear_has_hdop();
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::jmc_auto::localization_dy::SatDirCosine > sat_dir_cosine_;
...
inline ::jmc_auto::drivers::gnss::GnssTimeType GnssPntResult::time_type() const {
...
inline void GnssPntResult::set_time_type(::jmc_auto::drivers::gnss::GnssTimeType value) {
...
inline ::jmc_auto::localization_dy::PntType GnssPntResult::pnt_type() const {
...
inline void GnssPntResult::set_pnt_type(::jmc_auto::localization_dy::PntType value) {
...
inline const ::jmc_auto::localization_dy::SatDirCosine& GnssPntResult::sat_dir_cosine(int index) const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization_dy.GnssPntResult.sat_dir_cosine)
  return sat_dir_cosine_.Get(index);
}
inline ::jmc_auto::localization_dy::SatDirCosine* GnssPntResult::mutable_sat_dir_cosine(int index) {
...
inline ::jmc_auto::localization_dy::SatDirCosine* GnssPntResult::add_sat_dir_cosine() {
  // @@protoc_insertion_point(field_add:jmc_auto.localization_dy.GnssPntResult.sat_dir_cosine)
  return sat_dir_cosine_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::jmc_auto::localization_dy::SatDirCosine >*
...
inline const ::google::protobuf::RepeatedPtrField< ::jmc_auto::localization_dy::SatDirCosine >&
...
template <> struct is_proto_enum< ::jmc_auto::localization_dy::PntType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::localization_dy::PntType>() {
  return ::jmc_auto::localization_dy::PntType_descriptor();
}
...
#endif  // PROTOBUF_modules_2flocalization_5fdy_2fproto_2fgnss_5fpnt_5fresult_2eproto__INCLUDED
