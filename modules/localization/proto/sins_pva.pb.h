...
class IntegSinsPva : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.localization.IntegSinsPva) */ {
 public:
  IntegSinsPva();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.localization.IntegSinsPva)
 private:
  void set_has_header();
