...
#ifndef PROTOBUF_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto__INCLUDED
#define PROTOBUF_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto__INCLUDED
...
class SatDirCosine : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.localization.SatDirCosine) */ {
 public:
  SatDirCosine();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.localization.SatDirCosine)
 private:
  ...
  double cosine_y_;
  double cosine_z_;
  friend struct protobuf_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class GnssPntResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.localization.GnssPntResult) */ {
 public:
  GnssPntResult();
  ...
  const ::jmc_auto::localization::SatDirCosine& sat_dir_cosine(int index) const;
  ::jmc_auto::localization::SatDirCosine* mutable_sat_dir_cosine(int index);
  ::jmc_auto::localization::SatDirCosine* add_sat_dir_cosine();
  ...
  ::jmc_auto::localization::PntType pnt_type() const;
  void set_pnt_type(::jmc_auto::localization::PntType value);
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.localization.GnssPntResult)
 private:
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::jmc_auto::localization::SatDirCosine > sat_dir_cosine_;
...
inline ::jmc_auto::localization::PntType GnssPntResult::pnt_type() const {
...
inline void GnssPntResult::set_pnt_type(::jmc_auto::localization::PntType value) {
...
inline const ::jmc_auto::localization::SatDirCosine& GnssPntResult::sat_dir_cosine(int index) const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization.GnssPntResult.sat_dir_cosine)
  return sat_dir_cosine_.Get(index);
}
inline ::jmc_auto::localization::SatDirCosine* GnssPntResult::mutable_sat_dir_cosine(int index) {
...
inline ::jmc_auto::localization::SatDirCosine* GnssPntResult::add_sat_dir_cosine() {
  // @@protoc_insertion_point(field_add:jmc_auto.localization.GnssPntResult.sat_dir_cosine)
  return sat_dir_cosine_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::jmc_auto::localization::SatDirCosine >*
...
inline const ::google::protobuf::RepeatedPtrField< ::jmc_auto::localization::SatDirCosine >&
...
template <> struct is_proto_enum< ::jmc_auto::localization::PntType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::localization::PntType>() {
  return ::jmc_auto::localization::PntType_descriptor();
}
...
#endif  // PROTOBUF_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto__INCLUDED
