...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "n_config.proto\022\025jmc_auto.localization\"\240\001"
      "\n\022LocalizationConfig\022Z\n\021localization_typ"
      "e\030\001 \001(\0162:.jmc_auto.localization.Localiza"
      "tionConfig.LocalizationType:\003RTK\".\n\020Loca"
      "lizationType\022\007\n\003RTK\020\000\022\007\n\003MSF\020\001\022\010\n\004VINS\020\002"
  };
...
LocalizationConfig::LocalizationConfig()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.localization.LocalizationConfig)
}
LocalizationConfig::LocalizationConfig(const LocalizationConfig& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.localization.LocalizationConfig)
}
...
LocalizationConfig::~LocalizationConfig() {
  // @@protoc_insertion_point(destructor:jmc_auto.localization.LocalizationConfig)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.localization.LocalizationConfig)
  localization_type_ = 0;
  _has_bits_.Clear();
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:jmc_auto.localization.LocalizationConfig)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional .jmc_auto.localization.LocalizationConfig.LocalizationType localization_type = 1 [default = RTK];
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::jmc_auto::localization::LocalizationConfig_LocalizationType_IsValid(value)) {
            set_localization_type(static_cast< ::jmc_auto::localization::LocalizationConfig_LocalizationType >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.localization.LocalizationConfig)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.localization.LocalizationConfig)
  return false;
#undef DO_
}
...
void LocalizationConfig::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:jmc_auto.localization.LocalizationConfig)
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.localization.LocalizationConfig)
}

::google::protobuf::uint8* LocalizationConfig::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.localization.LocalizationConfig)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.localization.LocalizationConfig)
  return target;
}

size_t LocalizationConfig::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.localization.LocalizationConfig)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.localization.LocalizationConfig)
  GOOGLE_DCHECK_NE(&from, this);
  const LocalizationConfig* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const LocalizationConfig>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.localization.LocalizationConfig)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.localization.LocalizationConfig)
    MergeFrom(*source);
  }
}

void LocalizationConfig::MergeFrom(const LocalizationConfig& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.localization.LocalizationConfig)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.localization.LocalizationConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.localization.LocalizationConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::jmc_auto::localization::LocalizationConfig_LocalizationType LocalizationConfig::localization_type() const {
  // @@protoc_insertion_point(field_get:jmc_auto.localization.LocalizationConfig.localization_type)
  return static_cast< ::jmc_auto::localization::LocalizationConfig_LocalizationType >(localization_type_);
}
void LocalizationConfig::set_localization_type(::jmc_auto::localization::LocalizationConfig_LocalizationType value) {
  assert(::jmc_auto::localization::LocalizationConfig_LocalizationType_IsValid(value));
  set_has_localization_type();
  localization_type_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.localization.LocalizationConfig.localization_type)
}
