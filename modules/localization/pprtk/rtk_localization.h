 ...
 * @brief The class of PPSevenRTKLocalization
 */
...
/**
 * @class PPSevenRTKLocalization
 *
 * @brief generate localization info based on RTK
 */
class PPSevenRTKLocalization : public LocalizationBase {
 public:
  PPSevenRTKLocalization();
  virtual ~PPSevenRTKLocalization();
 ...
 private:
  ...
  FRIEND_TEST(PPSevenRTKLocalizationTest, InterpolateIMU);
  FRIEND_TEST(PPSevenRTKLocalizationTest, ComposeLocalizationMsg);
};
