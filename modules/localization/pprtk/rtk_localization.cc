...
#include "modules/localization/pprtk/rtk_localization.h"
...
Status PPSevenRTKLocalization::Start() {
  ...
  timer_ = AdapterManager::CreateTimer(ros::Duration(duration),
                                       &PPSevenRTKLocalization::OnTimer, this);
...
Status PPSevenRTKLocalization::Stop() {
  timer_.stop();
  return Status::OK();
}

void PPSevenRTKLocalization::OnTimer(const ros::TimerEvent &event) {
  double time_delay =
...
template <class T>
T PPSevenRTKLocalization::InterpolateXYZ(const T &p1, const T &p2,
                                  const double frac1) {
  T p;
...
bool PPSevenRTKLocalization::FindMatchingIMU(const double gps_timestamp_sec,
...
bool PPSevenRTKLocalization::InterpolateIMU(const CorrectedImu &imu1,
...
void PPSevenRTKLocalization::PrepareLocalizationMsg(
...
void PPSevenRTKLocalization::ComposeLocalizationMsg(
...
void PPSevenRTKLocalization::PublishLocalization() {
  LocalizationEstimate localization;
...
void PPSevenRTKLocalization::RunWatchDog() {
