...
using jmc_auto::cyber::proto::Channel;
using jmc_auto::cyber::proto::ChunkBody;
using jmc_auto::cyber::proto::ChunkHeader;
using jmc_auto::cyber::proto::Header;
using jmc_auto::cyber::proto::SectionType;
using jmc_auto::cyber::proto::SingleMessage;

constexpr char kChan1[] = "/test1";
constexpr char kChan2[] = "/test2";
constexpr char kMsgType[] = "jmc_auto.cyber.proto.Test";
