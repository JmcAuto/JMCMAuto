...
#include "modules/common/record/file/record_file_writer.h"
...
using jmc_auto::common::proto::Channel;
using jmc_auto::common::proto::ChannelCache;
using jmc_auto::common::proto::ChunkBody;
using jmc_auto::common::proto::ChunkBodyCache;
using jmc_auto::common::proto::ChunkHeader;
using jmc_auto::common::proto::ChunkHeaderCache;
using jmc_auto::common::proto::Header;
using jmc_auto::common::proto::SectionType;
using jmc_auto::common::proto::SingleIndex;
...
bool RecordFileWriter::Open(const std::string& path) {
  ...
  path_ = path;
  if (::jmc_auto::common::util::PathExists(path_)) {
