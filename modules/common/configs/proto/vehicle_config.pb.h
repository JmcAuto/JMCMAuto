...
#ifndef PROTOBUF_modules_2fcommon_2fconfigs_2fproto_2fvehicle_5fconfig_2eproto__INCLUDED
#define PROTOBUF_modules_2fcommon_2fconfigs_2fproto_2fvehicle_5fconfig_2eproto__INCLUDED
...
enum VehicleParam_VehicleBrand {
  ...
  VehicleParam_VehicleBrand_CH = 2,
  VehicleParam_VehicleBrand_TESHUN = 3
};
...
const VehicleParam_VehicleBrand VehicleParam_VehicleBrand_VehicleBrand_MAX = VehicleParam_VehicleBrand_TESHUN;
...
class Transform : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.Transform) */ {
 public:
  Transform();
  virtual ~Transform();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.common.Transform)
 private:
  ...
  friend struct protobuf_modules_2fcommon_2fconfigs_2fproto_2fvehicle_5fconfig_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Extrinsics : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.Extrinsics) */ {
 public:
  Extrinsics();
  virtual ~Extrinsics();
  ...
  inline Extrinsics* New() const PROTOBUF_FINAL { return New(NULL); }

  Extrinsics* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  const ::jmc_auto::common::Transform& tansforms(int index) const;
  ::jmc_auto::common::Transform* mutable_tansforms(int index);
  ::jmc_auto::common::Transform* add_tansforms();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.common.Extrinsics)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::jmc_auto::common::Transform > tansforms_;
  friend struct protobuf_modules_2fcommon_2fconfigs_2fproto_2fvehicle_5fconfig_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class VehicleParam : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.VehicleParam) */ {
 public:
  VehicleParam();
  ...
  static const VehicleBrand CH =
    VehicleParam_VehicleBrand_CH;
  static const VehicleBrand TESHUN =
    VehicleParam_VehicleBrand_TESHUN;
  ...
  ::jmc_auto::common::VehicleParam_VehicleBrand brand() const;
  void set_brand(::jmc_auto::common::VehicleParam_VehicleBrand value);
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.common.VehicleParam)
 private:
  void set_has_brand();
...
class VehicleConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.VehicleConfig) */ {
 public:
  VehicleConfig();
  ...
  inline VehicleConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  VehicleConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  const ::jmc_auto::common::VehicleParam& vehicle_param() const;
  ::jmc_auto::common::VehicleParam* mutable_vehicle_param();
  ::jmc_auto::common::VehicleParam* release_vehicle_param();
  void set_allocated_vehicle_param(::jmc_auto::common::VehicleParam* vehicle_param);
  ...
  const ::jmc_auto::common::Extrinsics& extrinsics() const;
  ::jmc_auto::common::Extrinsics* mutable_extrinsics();
  ::jmc_auto::common::Extrinsics* release_extrinsics();
  void set_allocated_extrinsics(::jmc_auto::common::Extrinsics* extrinsics);

  // @@protoc_insertion_point(class_scope:jmc_auto.common.VehicleConfig)
 private:
  void set_has_header();
  ...
  ::jmc_auto::common::VehicleParam* vehicle_param_;
  ::jmc_auto::common::Extrinsics* extrinsics_;
  friend struct protobuf_modules_2fcommon_2fconfigs_2fproto_2fvehicle_5fconfig_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::jmc_auto::common::Point3D& Transform::translation() const {
...
inline ::jmc_auto::common::Point3D* Transform::mutable_translation() {
  set_has_translation();
...
inline ::jmc_auto::common::Point3D* Transform::release_translation() {
...
inline void Transform::set_allocated_translation(::jmc_auto::common::Point3D* translation) {
  delete translation_;
...
inline const ::jmc_auto::common::Quaternion& Transform::rotation() const {
...
inline ::jmc_auto::common::Quaternion* Transform::mutable_rotation() {
  set_has_rotation();
  if (rotation_ == NULL) {
...
inline ::jmc_auto::common::Quaternion* Transform::release_rotation() {
...
inline void Transform::set_allocated_rotation(::jmc_auto::common::Quaternion* rotation) {
  delete rotation_;
  rotation_ = rotation;
  if (rotation) {
    set_has_rotation();
...
inline ::jmc_auto::common::VehicleParam_VehicleBrand VehicleParam::brand() const {
...
inline void VehicleParam::set_brand(::jmc_auto::common::VehicleParam_VehicleBrand value) {
...
inline const ::jmc_auto::common::Header& VehicleConfig::header() const {
...
inline ::jmc_auto::common::Header* VehicleConfig::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
...
inline ::jmc_auto::common::Header* VehicleConfig::release_header() {
...
inline void VehicleConfig::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline const ::jmc_auto::common::VehicleParam& VehicleConfig::vehicle_param() const {
...
inline ::jmc_auto::common::VehicleParam* VehicleConfig::mutable_vehicle_param() {
...
inline ::jmc_auto::common::VehicleParam* VehicleConfig::release_vehicle_param() {
...
inline void VehicleConfig::set_allocated_vehicle_param(::jmc_auto::common::VehicleParam* vehicle_param) {
...
inline const ::jmc_auto::common::Extrinsics& VehicleConfig::extrinsics() const {
...
inline ::jmc_auto::common::Extrinsics* VehicleConfig::mutable_extrinsics() {
  set_has_extrinsics();
  if (extrinsics_ == NULL) {
...
inline ::jmc_auto::common::Extrinsics* VehicleConfig::release_extrinsics() {
...
inline void VehicleConfig::set_allocated_extrinsics(::jmc_auto::common::Extrinsics* extrinsics) {
  delete extrinsics_;
...
template <> struct is_proto_enum< ::jmc_auto::common::VehicleParam_VehicleBrand> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::common::VehicleParam_VehicleBrand>() {
  return ::jmc_auto::common::VehicleParam_VehicleBrand_descriptor();
}
...
#endif  // PROTOBUF_modules_2fcommon_2fconfigs_2fproto_2fvehicle_5fconfig_2eproto__INCLUDED
