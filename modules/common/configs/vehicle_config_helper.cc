...
void VehicleConfigHelper::Init(const std::string &config_file) {
  ...
  CHECK(jmc_auto::common::util::GetProtoFromFile(config_file, &params))
...
jmc_auto::common::math::Box2d VehicleConfigHelper::GetBoundingBox(
  ...
  return jmc_auto::common::math::Box2d(true_center, path_point.theta(),
