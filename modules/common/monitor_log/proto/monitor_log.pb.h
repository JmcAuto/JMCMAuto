...
#ifndef PROTOBUF_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto__INCLUDED
#define PROTOBUF_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto__INCLUDED
...
enum MonitorMessageItem_MessageSource {
  ...
  MonitorMessageItem_MessageSource_REMOTECONTROL = 15,
  MonitorMessageItem_MessageSource_LOCALIZATION_DY = 16
};
...
const MonitorMessageItem_MessageSource MonitorMessageItem_MessageSource_MessageSource_MAX = MonitorMessageItem_MessageSource_LOCALIZATION_DY;
...
class MonitorMessageItem : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.monitor.MonitorMessageItem) */ {
 public:
  MonitorMessageItem();
  ...
  static const MessageSource REMOTECONTROL =
    MonitorMessageItem_MessageSource_REMOTECONTROL;
  static const MessageSource LOCALIZATION_DY =
    MonitorMessageItem_MessageSource_LOCALIZATION_DY;
  ...
  ::jmc_auto::common::monitor::MonitorMessageItem_LogLevel log_level() const;
  void set_log_level(::jmc_auto::common::monitor::MonitorMessageItem_LogLevel value);

  // optional .jmc_auto.common.monitor.MonitorMessageItem.MessageSource source = 1 [default = UNKNOWN];
  bool has_source() const;
  void clear_source();
  static const int kSourceFieldNumber = 1;
  ::jmc_auto::common::monitor::MonitorMessageItem_MessageSource source() const;
  void set_source(::jmc_auto::common::monitor::MonitorMessageItem_MessageSource value);

  // @@protoc_insertion_point(class_scope:jmc_auto.common.monitor.MonitorMessageItem)
 private:
  void set_has_source();
...
class MonitorMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.monitor.MonitorMessage) */ {
 public:
  MonitorMessage();
  ...
  const ::jmc_auto::common::monitor::MonitorMessageItem& item(int index) const;
  ::jmc_auto::common::monitor::MonitorMessageItem* mutable_item(int index);
  ::jmc_auto::common::monitor::MonitorMessageItem* add_item();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.common.monitor.MonitorMessage)
 private:
  void set_has_header();
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::jmc_auto::common::monitor::MonitorMessageItem > item_;
...
inline ::jmc_auto::common::monitor::MonitorMessageItem_MessageSource MonitorMessageItem::source() const {
...
inline void MonitorMessageItem::set_source(::jmc_auto::common::monitor::MonitorMessageItem_MessageSource value) {
...
inline ::jmc_auto::common::monitor::MonitorMessageItem_LogLevel MonitorMessageItem::log_level() const {
...
inline void MonitorMessageItem::set_log_level(::jmc_auto::common::monitor::MonitorMessageItem_LogLevel value) {
...
inline const ::jmc_auto::common::Header& MonitorMessage::header() const {
...
inline ::jmc_auto::common::Header* MonitorMessage::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
...
inline ::jmc_auto::common::Header* MonitorMessage::release_header() {
...
inline void MonitorMessage::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline const ::jmc_auto::common::monitor::MonitorMessageItem& MonitorMessage::item(int index) const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.monitor.MonitorMessage.item)
  return item_.Get(index);
}
inline ::jmc_auto::common::monitor::MonitorMessageItem* MonitorMessage::mutable_item(int index) {
  // @@protoc_insertion_point(field_mutable:jmc_auto.common.monitor.MonitorMessage.item)
  return item_.Mutable(index);
}
inline ::jmc_auto::common::monitor::MonitorMessageItem* MonitorMessage::add_item() {
  // @@protoc_insertion_point(field_add:jmc_auto.common.monitor.MonitorMessage.item)
  return item_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::jmc_auto::common::monitor::MonitorMessageItem >*
MonitorMessage::mutable_item() {
  // @@protoc_insertion_point(field_mutable_list:jmc_auto.common.monitor.MonitorMessage.item)
  return &item_;
}
inline const ::google::protobuf::RepeatedPtrField< ::jmc_auto::common::monitor::MonitorMessageItem >&
...
template <> struct is_proto_enum< ::jmc_auto::common::monitor::MonitorMessageItem_MessageSource> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::common::monitor::MonitorMessageItem_MessageSource>() {
  return ::jmc_auto::common::monitor::MonitorMessageItem_MessageSource_descriptor();
}
template <> struct is_proto_enum< ::jmc_auto::common::monitor::MonitorMessageItem_LogLevel> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::common::monitor::MonitorMessageItem_LogLevel>() {
  return ::jmc_auto::common::monitor::MonitorMessageItem_LogLevel_descriptor();
}
...
#endif  // PROTOBUF_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto__INCLUDED
