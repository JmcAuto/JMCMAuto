...
class VehicleSignal : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.VehicleSignal) */ {
 public:
  VehicleSignal();
  ...
  ::jmc_auto::common::VehicleSignal_TurnSignal turn_signal() const;
  void set_turn_signal(::jmc_auto::common::VehicleSignal_TurnSignal value);
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.common.VehicleSignal)
 private:
...
inline ::jmc_auto::common::VehicleSignal_TurnSignal VehicleSignal::turn_signal() const {
...
inline void VehicleSignal::set_turn_signal(::jmc_auto::common::VehicleSignal_TurnSignal value) {
...
template <> struct is_proto_enum< ::jmc_auto::common::VehicleSignal_TurnSignal> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::common::VehicleSignal_TurnSignal>() {
  return ::jmc_auto::common::VehicleSignal_TurnSignal_descriptor();
}
