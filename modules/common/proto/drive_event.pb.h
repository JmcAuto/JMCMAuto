...
class DriveEvent : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.DriveEvent) */ {
 public:
  DriveEvent();
  virtual ~DriveEvent();
  ...
  const ::jmc_auto::localization::Pose& location() const;
  ::jmc_auto::localization::Pose* mutable_location();
  ::jmc_auto::localization::Pose* release_location();
  void set_allocated_location(::jmc_auto::localization::Pose* location);

  // @@protoc_insertion_point(class_scope:jmc_auto.common.DriveEvent)
 private:
  void set_has_header();
  ...
  ::jmc_auto::localization::Pose* location_;
...
inline ::jmc_auto::common::Header* DriveEvent::release_header() {
...
inline void DriveEvent::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline const ::jmc_auto::localization::Pose& DriveEvent::location() const {
...
inline ::jmc_auto::localization::Pose* DriveEvent::mutable_location() {
  set_has_location();
  if (location_ == NULL) {
...
inline ::jmc_auto::localization::Pose* DriveEvent::release_location() {
...
inline void DriveEvent::set_allocated_location(::jmc_auto::localization::Pose* location) {
  delete location_;
  location_ = location;
  if (location) {
    set_has_location();
