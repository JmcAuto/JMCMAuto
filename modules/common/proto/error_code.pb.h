...
class StatusPb : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.StatusPb) */ {
 public:
  StatusPb();
  virtual ~StatusPb();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.common.StatusPb)
 private:
...
inline ::jmc_auto::common::ErrorCode StatusPb::error_code() const {
...
inline void StatusPb::set_error_code(::jmc_auto::common::ErrorCode value) {
...
template <> struct is_proto_enum< ::jmc_auto::common::ErrorCode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::common::ErrorCode>() {
  return ::jmc_auto::common::ErrorCode_descriptor();
}
