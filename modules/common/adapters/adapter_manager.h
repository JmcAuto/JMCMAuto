...
private:                                                                       \
  ...
  {                                                                            \
    ...
    {                                                                          \
        jmc_auto::proxy::name##ServiceInterfaceProxy::StartFindService(        \
            ...
            handles, ara::com::FindServiceHandle handler)                      \
            {                                                                  \
  ...
  void ServiceAvailabilityCallback##name(ara::com::ServiceHandleContainer      \
  <jmc_auto::proxy::name##ServiceInterfaceProxy::HandleType> handles,          \
      ...
      {                                                                        \
        ...
        {                                                                      \
          ...
          {                                                                    \
            ...
            <jmc_auto::proxy::name##ServiceInterfaceProxy>(handles[i]);        \
