...
enum AdapterConfig_MessageType {
  ...
  AdapterConfig_MessageType_REMOTE_CONTROL = 63,
  AdapterConfig_MessageType_CONTI_RADAR_FRONT = 64,
  AdapterConfig_MessageType_CONTI_RADAR_LEFT = 65,
  AdapterConfig_MessageType_CONTI_RADAR_RIGHT = 66,
  AdapterConfig_MessageType_LOCALIZATION_DY = 67
};
...
const AdapterConfig_MessageType AdapterConfig_MessageType_MessageType_MAX = AdapterConfig_MessageType_LOCALIZATION_DY;
...
class AdapterConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.adapter.AdapterConfig) */ {
 public:
  AdapterConfig();
  ...
  static const MessageType VOICE_DETECTION_REQUEST =
    AdapterConfig_MessageType_VOICE_DETECTION_REQUEST;
  static const MessageType VOICE_DETECTION_RESPONSE =
  ...
  static const MessageType POINT_CLOUD_RAW =
    AdapterConfig_MessageType_POINT_CLOUD_RAW;
  static const MessageType VELODYNE_RAW =
    AdapterConfig_MessageType_VELODYNE_RAW;
  static const MessageType POINT_CLOUD_FUSION =
    AdapterConfig_MessageType_POINT_CLOUD_FUSION;
  static const MessageType REMOTE_CONTROL =
    AdapterConfig_MessageType_REMOTE_CONTROL;
  static const MessageType CONTI_RADAR_FRONT =
    AdapterConfig_MessageType_CONTI_RADAR_FRONT;
  static const MessageType CONTI_RADAR_LEFT =
    AdapterConfig_MessageType_CONTI_RADAR_LEFT;
  static const MessageType CONTI_RADAR_RIGHT =
    AdapterConfig_MessageType_CONTI_RADAR_RIGHT;
  static const MessageType LOCALIZATION_DY =
    AdapterConfig_MessageType_LOCALIZATION_DY;
  ...
  ::jmc_auto::common::adapter::AdapterConfig_Mode mode() const;
  void set_mode(::jmc_auto::common::adapter::AdapterConfig_Mode value);
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.common.adapter.AdapterConfig)
 private:
  void set_has_type();
  void clear_has_type();
  void set_has_mode();
...
class AdapterManagerConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.adapter.AdapterManagerConfig) */ {
 public:
  ...
  const ::jmc_auto::common::adapter::AdapterConfig& config(int index) const;
  ::jmc_auto::common::adapter::AdapterConfig* mutable_config(int index);
  ::jmc_auto::common::adapter::AdapterConfig* add_config();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.common.adapter.AdapterManagerConfig)
 private:
  void set_has_is_ros();
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::jmc_auto::common::adapter::AdapterConfig > config_;
  bool is_ros_;
  friend struct protobuf_modules_2fcommon_2fadapters_2fproto_2fadapter_5fconfig_2eproto::TableStruct;
};
// ===================================================================
...
inline ::jmc_auto::common::adapter::AdapterConfig_MessageType AdapterConfig::type() const {
...
inline void AdapterConfig::set_type(::jmc_auto::common::adapter::AdapterConfig_MessageType value) {
...
inline ::jmc_auto::common::adapter::AdapterConfig_Mode AdapterConfig::mode() const {
...
inline void AdapterConfig::set_mode(::jmc_auto::common::adapter::AdapterConfig_Mode value) {
...
inline const ::jmc_auto::common::adapter::AdapterConfig& AdapterManagerConfig::config(int index) const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.adapter.AdapterManagerConfig.config)
  return config_.Get(index);
}
inline ::jmc_auto::common::adapter::AdapterConfig* AdapterManagerConfig::mutable_config(int index) {
  // @@protoc_insertion_point(field_mutable:jmc_auto.common.adapter.AdapterManagerConfig.config)
  return config_.Mutable(index);
}
inline ::jmc_auto::common::adapter::AdapterConfig* AdapterManagerConfig::add_config() {
  // @@protoc_insertion_point(field_add:jmc_auto.common.adapter.AdapterManagerConfig.config)
  return config_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::jmc_auto::common::adapter::AdapterConfig >*
...
inline const ::google::protobuf::RepeatedPtrField< ::jmc_auto::common::adapter::AdapterConfig >&
...
template <> struct is_proto_enum< ::jmc_auto::common::adapter::AdapterConfig_MessageType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::common::adapter::AdapterConfig_MessageType>() {
  return ::jmc_auto::common::adapter::AdapterConfig_MessageType_descriptor();
}
template <> struct is_proto_enum< ::jmc_auto::common::adapter::AdapterConfig_Mode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::common::adapter::AdapterConfig_Mode>() {
  return ::jmc_auto::common::adapter::AdapterConfig_Mode_descriptor();
}
