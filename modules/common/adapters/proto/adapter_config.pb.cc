...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "config.proto\022\027jmc_auto.common.adapter\"\340\014"
      "\n\rAdapterConfig\022@\n\004type\030\001 \002(\01622.jmc_auto"
      ".common.adapter.AdapterConfig.MessageTyp"
      "e\0229\n\004mode\030\002 \002(\0162+.jmc_auto.common.adapte"
      "r.AdapterConfig.Mode\022!\n\025message_history_"
      "limit\030\003 \001(\005:\00210\022\024\n\005latch\030\004 \001(\010:\005false\"\340\n"
      "\n\013MessageType\022\017\n\013POINT_CLOUD\020\001\022\025\n\021VLP16_"
      "POINT_CLOUD\020:\022\007\n\003GPS\020\002\022\007\n\003IMU\020\003\022\013\n\007CHASS"
      "IS\020\004\022\020\n\014LOCALIZATION\020\005\022\027\n\023PLANNING_TRAJE"
      "CTORY\020\006\022\013\n\007MONITOR\020\007\022\007\n\003PAD\020\010\022\023\n\017CONTROL"
      "_COMMAND\020\t\022\016\n\nPREDICTION\020\n\022\030\n\024PERCEPTION"
      "_OBSTACLES\020\013\022\033\n\027TRAFFIC_LIGHT_DETECTION\020"
      ...
      "E_SHORT\020\034\022\016\n\nIMAGE_LONG\020\035\022\017\n\013DRIVE_EVENT"
      "\020\036\022\020\n\014GNSS_RTK_OBS\020\037\022\020\n\014GNSS_RTK_EPH\020 \022\022"
      "\n\016GNSS_BEST_POSE\020!\022\031\n\025LOCALIZATION_MSF_G"
      "NSS\020\"\022\032\n\026LOCALIZATION_MSF_LIDAR\020#\022\035\n\031LOC"
      "ALIZATION_MSF_SINS_PVA\020$\022\013\n\007RAW_IMU\020%\022\033\n"
      "\027LOCALIZATION_MSF_STATUS\020&\022\017\n\013STATIC_INF"
      "O\020\'\022\020\n\014RELATIVE_MAP\020(\022\016\n\nNAVIGATION\020)\022\024\n"
      "\020ULTRASONIC_RADAR\020*\022\033\n\027VOICE_DETECTION_R"
      "EQUEST\020+\022\034\n\030VOICE_DETECTION_RESPONSE\020,\022\017"
      "\n\013IMAGE_FRONT\020-\022\027\n\023PANDORA_POINT_CLOUD\020."
      "\022\036\n\032PANDORA_CAMERA_FRONT_COLOR\020/\022\035\n\031PAND"
      "ORA_CAMERA_RIGHT_GRAY\0200\022\034\n\030PANDORA_CAMER"
      "A_LEFT_GRAY\0201\022\035\n\031PANDORA_CAMERA_FRONT_GR"
      "AY\0202\022\034\n\030PANDORA_CAMERA_BACK_GRAY\0203\022\030\n\024PE"
      "RCEPTION_LANE_MASK\0204\022\014\n\010GUARDIAN\0205\022\021\n\rGN"
      "SS_RAW_DATA\0206\022\021\n\rSTREAM_STATUS\0207\022\020\n\014GNSS"
      "_HEADING\0208\022\r\n\tRTCM_DATA\0209\022\021\n\rRACOBIT_RAD"
      "AR\020;\022\023\n\017POINT_CLOUD_RAW\020<\022\020\n\014VELODYNE_RA"
      "W\020=\022\026\n\022POINT_CLOUD_FUSION\020>\022\022\n\016REMOTE_CO"
      "NTROL\020\?\022\025\n\021CONTI_RADAR_FRONT\020@\022\024\n\020CONTI_"
      "RADAR_LEFT\020A\022\025\n\021CONTI_RADAR_RIGHT\020B\022\023\n\017L"
      "OCALIZATION_DY\020C\"6\n\004Mode\022\020\n\014RECEIVE_ONLY"
      "\020\000\022\020\n\014PUBLISH_ONLY\020\001\022\n\n\006DUPLEX\020\002\"^\n\024Adap"
      "terManagerConfig\0226\n\006config\030\001 \003(\0132&.jmc_a"
      "uto.common.adapter.AdapterConfig\022\016\n\006is_r"
      "os\030\002 \002(\010"
  };
...
const AdapterConfig_MessageType AdapterConfig::VOICE_DETECTION_REQUEST;
const AdapterConfig_MessageType AdapterConfig::VOICE_DETECTION_RESPONSE;
...
const AdapterConfig_MessageType AdapterConfig::POINT_CLOUD_RAW;
const AdapterConfig_MessageType AdapterConfig::VELODYNE_RAW;
const AdapterConfig_MessageType AdapterConfig::POINT_CLOUD_FUSION;
const AdapterConfig_MessageType AdapterConfig::REMOTE_CONTROL;
const AdapterConfig_MessageType AdapterConfig::CONTI_RADAR_FRONT;
const AdapterConfig_MessageType AdapterConfig::CONTI_RADAR_LEFT;
const AdapterConfig_MessageType AdapterConfig::CONTI_RADAR_RIGHT;
const AdapterConfig_MessageType AdapterConfig::LOCALIZATION_DY;
...
AdapterConfig::AdapterConfig()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.common.adapter.AdapterConfig)
}
AdapterConfig::AdapterConfig(const AdapterConfig& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.common.adapter.AdapterConfig)
}
...
AdapterConfig::~AdapterConfig() {
  // @@protoc_insertion_point(destructor:jmc_auto.common.adapter.AdapterConfig)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.common.adapter.AdapterConfig)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:jmc_auto.common.adapter.AdapterConfig)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // required .jmc_auto.common.adapter.AdapterConfig.MessageType type = 1;
      case 1: {
      ...
      // required .jmc_auto.common.adapter.AdapterConfig.Mode mode = 2;
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::jmc_auto::common::adapter::AdapterConfig_Mode_IsValid(value)) {
            set_mode(static_cast< ::jmc_auto::common::adapter::AdapterConfig_Mode >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.common.adapter.AdapterConfig)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.common.adapter.AdapterConfig)
  return false;
#undef DO_
}
...
void AdapterConfig::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:jmc_auto.common.adapter.AdapterConfig)
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.common.adapter.AdapterConfig)
}

::google::protobuf::uint8* AdapterConfig::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.common.adapter.AdapterConfig)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.common.adapter.AdapterConfig)
  return target;
}

size_t AdapterConfig::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:jmc_auto.common.adapter.AdapterConfig)
  size_t total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.common.adapter.AdapterConfig)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.common.adapter.AdapterConfig)
  GOOGLE_DCHECK_NE(&from, this);
  const AdapterConfig* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const AdapterConfig>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.common.adapter.AdapterConfig)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.common.adapter.AdapterConfig)
    MergeFrom(*source);
  }
}

void AdapterConfig::MergeFrom(const AdapterConfig& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.common.adapter.AdapterConfig)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.common.adapter.AdapterConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.common.adapter.AdapterConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::jmc_auto::common::adapter::AdapterConfig_MessageType AdapterConfig::type() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.adapter.AdapterConfig.type)
  return static_cast< ::jmc_auto::common::adapter::AdapterConfig_MessageType >(type_);
}
void AdapterConfig::set_type(::jmc_auto::common::adapter::AdapterConfig_MessageType value) {
  assert(::jmc_auto::common::adapter::AdapterConfig_MessageType_IsValid(value));
  set_has_type();
  type_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.adapter.AdapterConfig.type)
}
...
::jmc_auto::common::adapter::AdapterConfig_Mode AdapterConfig::mode() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.adapter.AdapterConfig.mode)
  return static_cast< ::jmc_auto::common::adapter::AdapterConfig_Mode >(mode_);
}
void AdapterConfig::set_mode(::jmc_auto::common::adapter::AdapterConfig_Mode value) {
  assert(::jmc_auto::common::adapter::AdapterConfig_Mode_IsValid(value));
  set_has_mode();
  mode_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.adapter.AdapterConfig.mode)
}
...
::google::protobuf::int32 AdapterConfig::message_history_limit() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.adapter.AdapterConfig.message_history_limit)
...
void AdapterConfig::set_message_history_limit(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:jmc_auto.common.adapter.AdapterConfig.message_history_limit)
}
...
bool AdapterConfig::latch() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.adapter.AdapterConfig.latch)
  return latch_;
}
void AdapterConfig::set_latch(bool value) {
  set_has_latch();
  latch_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.adapter.AdapterConfig.latch)
}
...
AdapterManagerConfig::AdapterManagerConfig()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.common.adapter.AdapterManagerConfig)
}
AdapterManagerConfig::AdapterManagerConfig(const AdapterManagerConfig& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.common.adapter.AdapterManagerConfig)
}
...
AdapterManagerConfig::~AdapterManagerConfig() {
  // @@protoc_insertion_point(destructor:jmc_auto.common.adapter.AdapterManagerConfig)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.common.adapter.AdapterManagerConfig)
  config_.Clear();
  is_ros_ = false;
  _has_bits_.Clear();
  _internal_metadata_.Clear();
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:jmc_auto.common.adapter.AdapterManagerConfig)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // repeated .jmc_auto.common.adapter.AdapterConfig config = 1;
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.common.adapter.AdapterManagerConfig)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.common.adapter.AdapterManagerConfig)
  return false;
#undef DO_
}
...
void AdapterManagerConfig::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:jmc_auto.common.adapter.AdapterManagerConfig)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.common.adapter.AdapterManagerConfig)
}

::google::protobuf::uint8* AdapterManagerConfig::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.common.adapter.AdapterManagerConfig)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.common.adapter.AdapterManagerConfig)
  return target;
}

size_t AdapterManagerConfig::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.common.adapter.AdapterManagerConfig)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.common.adapter.AdapterManagerConfig)
  GOOGLE_DCHECK_NE(&from, this);
  const AdapterManagerConfig* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const AdapterManagerConfig>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.common.adapter.AdapterManagerConfig)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.common.adapter.AdapterManagerConfig)
    MergeFrom(*source);
  }
}

void AdapterManagerConfig::MergeFrom(const AdapterManagerConfig& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.common.adapter.AdapterManagerConfig)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.common.adapter.AdapterManagerConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.common.adapter.AdapterManagerConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::jmc_auto::common::adapter::AdapterConfig& AdapterManagerConfig::config(int index) const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.adapter.AdapterManagerConfig.config)
  return config_.Get(index);
}
::jmc_auto::common::adapter::AdapterConfig* AdapterManagerConfig::mutable_config(int index) {
  // @@protoc_insertion_point(field_mutable:jmc_auto.common.adapter.AdapterManagerConfig.config)
  return config_.Mutable(index);
}
::jmc_auto::common::adapter::AdapterConfig* AdapterManagerConfig::add_config() {
  // @@protoc_insertion_point(field_add:jmc_auto.common.adapter.AdapterManagerConfig.config)
  return config_.Add();
}
::google::protobuf::RepeatedPtrField< ::jmc_auto::common::adapter::AdapterConfig >*
AdapterManagerConfig::mutable_config() {
  // @@protoc_insertion_point(field_mutable_list:jmc_auto.common.adapter.AdapterManagerConfig.config)
  return &config_;
}
const ::google::protobuf::RepeatedPtrField< ::jmc_auto::common::adapter::AdapterConfig >&
AdapterManagerConfig::config() const {
  // @@protoc_insertion_point(field_list:jmc_auto.common.adapter.AdapterManagerConfig.config)
  return config_;
}
...
bool AdapterManagerConfig::is_ros() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.adapter.AdapterManagerConfig.is_ros)
  return is_ros_;
}
void AdapterManagerConfig::set_is_ros(bool value) {
  set_has_is_ros();
  is_ros_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.adapter.AdapterManagerConfig.is_ros)
}
