...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common/vehicle_state/proto/vehicle_state.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  _VehicleState_default_instance_.get_mutable()->pose_ = const_cast< ::jmc_auto::localization::Pose*>(
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "icle_state.proto\022\017jmc_auto.common\032\"modul"
      "es/canbus/proto/chassis.proto\032%modules/l"
      "ocalization/proto/pose.proto\"\234\003\n\014Vehicle"
      ...
      "\001(\001:\0010\022\020\n\005pitch\030\006 \001(\001:\0010\022\016\n\003yaw\030\007 \001(\001:\0010"
      "\022\022\n\007heading\030\010 \001(\001:\0010\022\020\n\005kappa\030\t \001(\001:\0010\022\032"
      "\n\017linear_velocity\030\n \001(\001:\0010\022\033\n\020angular_ve"
      "locity\030\013 \001(\001:\0010\022\036\n\023linear_acceleration\030\014"
      " \001(\001:\0010\0223\n\004gear\030\r \001(\0162%.jmc_auto.canbus."
      "Chassis.GearPosition\022:\n\014driving_mode\030\016 \001"
      "(\0162$.jmc_auto.canbus.Chassis.DrivingMode"
      "\022)\n\004pose\030\017 \001(\0132\033.jmc_auto.localization.P"
      "ose"
  };
...
VehicleState::VehicleState()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_2fvehicle_5fstate_2fproto_2fvehicle_5fstate_2eproto::InitDefaults();
  }
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.common.VehicleState)
}
VehicleState::VehicleState(const VehicleState& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.common.VehicleState)
}
...
VehicleState::~VehicleState() {
  // @@protoc_insertion_point(destructor:jmc_auto.common.VehicleState)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.common.VehicleState)
  if (has_pose()) {
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:jmc_auto.common.VehicleState)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // optional .jmc_auto.canbus.Chassis.GearPosition gear = 13;
      case 13: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
      ...
      // optional .jmc_auto.canbus.Chassis.DrivingMode driving_mode = 14;
      case 14: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
      ...
      // optional .jmc_auto.localization.Pose pose = 15;
      case 15: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.common.VehicleState)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.common.VehicleState)
  return false;
#undef DO_
}
...
void VehicleState::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:jmc_auto.common.VehicleState)
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.common.VehicleState)
}

::google::protobuf::uint8* VehicleState::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.common.VehicleState)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.common.VehicleState)
  return target;
}

size_t VehicleState::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.common.VehicleState)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.common.VehicleState)
  GOOGLE_DCHECK_NE(&from, this);
  const VehicleState* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const VehicleState>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.common.VehicleState)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.common.VehicleState)
    MergeFrom(*source);
  }
}

void VehicleState::MergeFrom(const VehicleState& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.common.VehicleState)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.common.VehicleState)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.common.VehicleState)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
double VehicleState::x() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.x)
  return x_;
}
void VehicleState::set_x(double value) {
  set_has_x();
  x_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.x)
}
...
double VehicleState::y() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.y)
  return y_;
}
void VehicleState::set_y(double value) {
  set_has_y();
  y_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.y)
}
...
double VehicleState::z() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.z)
  return z_;
}
void VehicleState::set_z(double value) {
  set_has_z();
  z_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.z)
}
...
double VehicleState::timestamp() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.timestamp)
  return timestamp_;
}
void VehicleState::set_timestamp(double value) {
  set_has_timestamp();
  timestamp_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.timestamp)
}
...
double VehicleState::roll() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.roll)
  return roll_;
}
void VehicleState::set_roll(double value) {
  set_has_roll();
  roll_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.roll)
}
...
double VehicleState::pitch() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.pitch)
  return pitch_;
}
void VehicleState::set_pitch(double value) {
  set_has_pitch();
  pitch_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.pitch)
}
...
double VehicleState::yaw() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.yaw)
  return yaw_;
}
void VehicleState::set_yaw(double value) {
  set_has_yaw();
  yaw_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.yaw)
}
...
double VehicleState::heading() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.heading)
  return heading_;
}
void VehicleState::set_heading(double value) {
  set_has_heading();
  heading_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.heading)
}
...
double VehicleState::kappa() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.kappa)
  return kappa_;
}
void VehicleState::set_kappa(double value) {
  set_has_kappa();
  kappa_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.kappa)
}
...
double VehicleState::linear_velocity() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.linear_velocity)
  return linear_velocity_;
}
void VehicleState::set_linear_velocity(double value) {
  set_has_linear_velocity();
  linear_velocity_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.linear_velocity)
}
...
double VehicleState::angular_velocity() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.angular_velocity)
  return angular_velocity_;
}
void VehicleState::set_angular_velocity(double value) {
  set_has_angular_velocity();
  angular_velocity_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.angular_velocity)
}
...
double VehicleState::linear_acceleration() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.linear_acceleration)
  return linear_acceleration_;
}
void VehicleState::set_linear_acceleration(double value) {
  set_has_linear_acceleration();
  linear_acceleration_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.linear_acceleration)
}
...
::jmc_auto::canbus::Chassis_GearPosition VehicleState::gear() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.gear)
  return static_cast< ::jmc_auto::canbus::Chassis_GearPosition >(gear_);
}
void VehicleState::set_gear(::jmc_auto::canbus::Chassis_GearPosition value) {
  assert(::jmc_auto::canbus::Chassis_GearPosition_IsValid(value));
  set_has_gear();
  gear_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.gear)
}
...
::jmc_auto::canbus::Chassis_DrivingMode VehicleState::driving_mode() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.driving_mode)
  return static_cast< ::jmc_auto::canbus::Chassis_DrivingMode >(driving_mode_);
}
void VehicleState::set_driving_mode(::jmc_auto::canbus::Chassis_DrivingMode value) {
  assert(::jmc_auto::canbus::Chassis_DrivingMode_IsValid(value));
  set_has_driving_mode();
  driving_mode_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.common.VehicleState.driving_mode)
}
...
const ::jmc_auto::localization::Pose& VehicleState::pose() const {
  // @@protoc_insertion_point(field_get:jmc_auto.common.VehicleState.pose)
  return pose_ != NULL ? *pose_
                         : *::jmc_auto::localization::Pose::internal_default_instance();
}
::jmc_auto::localization::Pose* VehicleState::mutable_pose() {
  set_has_pose();
  if (pose_ == NULL) {
    pose_ = new ::jmc_auto::localization::Pose;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.common.VehicleState.pose)
  return pose_;
}
::jmc_auto::localization::Pose* VehicleState::release_pose() {
  // @@protoc_insertion_point(field_release:jmc_auto.common.VehicleState.pose)
  clear_has_pose();
  ::jmc_auto::localization::Pose* temp = pose_;
  pose_ = NULL;
  return temp;
}
void VehicleState::set_allocated_pose(::jmc_auto::localization::Pose* pose) {
  delete pose_;
  pose_ = pose;
  if (pose) {
    set_has_pose();
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.common.VehicleState.pose)
}
