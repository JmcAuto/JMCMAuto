...
class VehicleState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.common.VehicleState) */ {
 public:
  VehicleState();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.common.VehicleState)
 private:
  void set_has_x();
  void clear_has_x();
  void set_has_y();
  ...
  int gear_;
  int driving_mode_;
  friend struct protobuf_modules_2fcommon_2fvehicle_5fstate_2fproto_2fvehicle_5fstate_2eproto::TableStruct;
};
// ===================================================================
...
inline ::jmc_auto::canbus::Chassis_GearPosition VehicleState::gear() const {
...
inline void VehicleState::set_gear(::jmc_auto::canbus::Chassis_GearPosition value) {
...
inline ::jmc_auto::canbus::Chassis_DrivingMode VehicleState::driving_mode() const {
...
inline void VehicleState::set_driving_mode(::jmc_auto::canbus::Chassis_DrivingMode value) {
...
inline const ::jmc_auto::localization::Pose& VehicleState::pose() const {
...
inline ::jmc_auto::localization::Pose* VehicleState::mutable_pose() {
  set_has_pose();
  if (pose_ == NULL) {
...
inline ::jmc_auto::localization::Pose* VehicleState::release_pose() {
...
inline void VehicleState::set_allocated_pose(::jmc_auto::localization::Pose* pose) {
  delete pose_;
  pose_ = pose;
  if (pose) {
    set_has_pose();
