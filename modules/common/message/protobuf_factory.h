...
#ifndef MODULES_COMMON_MESSAGE_PROTOBUF_FACTORY_H_
#define MODULES_COMMON_MESSAGE_PROTOBUF_FACTORY_H_
...
using jmc_auto::common::proto::ProtoDesc;
...
class ProtobufFactory {
 ...
 private:
  ...
  DECLARE_SINGLETON_PTR(ProtobufFactory);
};
...
#endif  // MODULES_COMMON_MESSAGE_PROTOBUF_FACTORY_H_
