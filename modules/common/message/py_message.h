...
#ifndef MODULES_COMMON_MESSAGE_PY_MESSAGE_H_
#define MODULES_COMMON_MESSAGE_PY_MESSAGE_H_
...
const char* const PY_MESSAGE_FULLNAME = "jmc_auto.common.message.PyMessage";
...
#endif  // MODULES_COMMON_MESSAGE_PY_MESSAGE_H_
