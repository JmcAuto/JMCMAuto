...
TEST(ProtobufFactory, register_and_generate) {
  ...
  jmc_auto::cyber::proto::ProtoDesc proto_desc;
  proto::UnitTest ut;
  ...
  get_desc_str.clear();
  factory->GetDescriptorString("jmc_auto.cyber.proto.UnitTest", &get_desc_str);
  EXPECT_EQ(get_desc_str, proto_desc_str);
  ...
  message = factory->GenerateMessageByType("jmc_auto.cyber.proto.UnitTest");
  ...
  desc_ptr = factory->FindMessageTypeByName("jmc_auto.cyber.proto.UnitTest");
