...
using jmc_auto::common::util::LookupOrInsert;

MonitorManager::MonitorManager() :
  logger_(jmc_auto::common::monitor::MonitorMessageItem::MONITOR),
  log_buffer_(&logger_) {
  CHECK(jmc_auto::common::util::GetProtoFromASCIIFile(FLAGS_monitor_conf_path,
                                                    &config_));
}

jmc_auto::common::monitor::MonitorLogBuffer &MonitorManager::LogBuffer() {
