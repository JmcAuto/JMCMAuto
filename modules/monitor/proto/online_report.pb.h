...
class VehicleStateReport : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.monitor.VehicleStateReport) */ {
 public:
  VehicleStateReport();
  ...
  const ::jmc_auto::data::VehicleInfo& vehicle_info() const;
  ::jmc_auto::data::VehicleInfo* mutable_vehicle_info();
  ::jmc_auto::data::VehicleInfo* release_vehicle_info();
  void set_allocated_vehicle_info(::jmc_auto::data::VehicleInfo* vehicle_info);
  ...
  const ::jmc_auto::common::VehicleState& vehicle_state() const;
  ::jmc_auto::common::VehicleState* mutable_vehicle_state();
  ::jmc_auto::common::VehicleState* release_vehicle_state();
  void set_allocated_vehicle_state(::jmc_auto::common::VehicleState* vehicle_state);

  // @@protoc_insertion_point(class_scope:jmc_auto.monitor.VehicleStateReport)
 private:
  ...
  ::jmc_auto::data::VehicleInfo* vehicle_info_;
  ::jmc_auto::common::VehicleState* vehicle_state_;
...
inline const ::jmc_auto::data::VehicleInfo& VehicleStateReport::vehicle_info() const {
...
inline ::jmc_auto::data::VehicleInfo* VehicleStateReport::mutable_vehicle_info() {
...
inline ::jmc_auto::data::VehicleInfo* VehicleStateReport::release_vehicle_info() {
...
inline void VehicleStateReport::set_allocated_vehicle_info(::jmc_auto::data::VehicleInfo* vehicle_info) {
...
inline const ::jmc_auto::common::VehicleState& VehicleStateReport::vehicle_state() const {
...
inline ::jmc_auto::common::VehicleState* VehicleStateReport::mutable_vehicle_state() {
...
inline ::jmc_auto::common::VehicleState* VehicleStateReport::release_vehicle_state() {
...
inline void VehicleStateReport::set_allocated_vehicle_state(::jmc_auto::common::VehicleState* vehicle_state) {
