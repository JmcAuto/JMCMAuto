...
class ClearArea : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.hdmap.ClearArea) */ {
 public:
  ClearArea();
  virtual ~ClearArea();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.hdmap.ClearArea)
 private:
  void set_has_id();
  void clear_has_id();
...
inline ::jmc_auto::hdmap::Id* ClearArea::release_id() {
...
inline void ClearArea::set_allocated_id(::jmc_auto::hdmap::Id* id) {
  delete id_;
  id_ = id;
  if (id) {
    set_has_id();
...
inline const ::jmc_auto::hdmap::Polygon& ClearArea::polygon() const {
...
inline ::jmc_auto::hdmap::Polygon* ClearArea::mutable_polygon() {
  set_has_polygon();
  if (polygon_ == NULL) {
...
inline ::jmc_auto::hdmap::Polygon* ClearArea::release_polygon() {
...
inline void ClearArea::set_allocated_polygon(::jmc_auto::hdmap::Polygon* polygon) {
  delete polygon_;
  polygon_ = polygon;
  if (polygon) {
    set_has_polygon();
