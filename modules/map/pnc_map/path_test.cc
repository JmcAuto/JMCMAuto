...
using Lane = jmc_auto::hdmap::Lane;
using LaneSampleAssociation = jmc_auto::hdmap::LaneSampleAssociation;
using Point = jmc_auto::common::PointENU;
using RoutingRequest = jmc_auto::routing::RoutingRequest;
using RoutingResponse = jmc_auto::routing::RoutingResponse;
using MapPathPoint = jmc_auto::hdmap::MapPathPoint;
using AABox2d = jmc_auto::common::math::AABox2d;
using Box2d = jmc_auto::common::math::Box2d;
using Polygon2d = jmc_auto::common::math::Polygon2d;
using Vec2d = jmc_auto::common::math::Vec2d;
using LaneWaypoint = jmc_auto::hdmap::LaneWaypoint;
using LaneInfoConstPtr = jmc_auto::hdmap::LaneInfoConstPtr;
...
std::string ToString(const T& val) {
  return jmc_auto::common::util::StrCat(val);
}
