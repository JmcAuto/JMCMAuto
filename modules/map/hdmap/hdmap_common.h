...
/**
 * @namespace jmc_auto::hdmap
 * @brief jmc_auto::hdmap
 */
namespace jmc_auto {
namespace hdmap {
...
class ObjectWithAABox {
 public:
  ObjectWithAABox(const jmc_auto::common::math::AABox2d &aabox,
                  const Object *object, const GeoObject *geo_object,
                  const int id)
      : aabox_(aabox), object_(object), geo_object_(geo_object), id_(id) {}
  ~ObjectWithAABox() {}
  const jmc_auto::common::math::AABox2d &aabox() const { return aabox_; }
  double DistanceTo(const jmc_auto::common::math::Vec2d &point) const {
    return geo_object_->DistanceTo(point);
  }
  double DistanceSquareTo(const jmc_auto::common::math::Vec2d &point) const {
 ...
 private:
  jmc_auto::common::math::AABox2d aabox_;
...
struct LineBoundary {
  std::vector<jmc_auto::common::PointENU> line_points;
};
...
struct PolygonBoundary {
  std::vector<jmc_auto::common::PointENU> polygon_points;
};
...
using LaneSegmentBox =
    ObjectWithAABox<LaneInfo, jmc_auto::common::math::LineSegment2d>;
using LaneSegmentKDTree = jmc_auto::common::math::AABoxKDTree2d<LaneSegmentBox>;
...
class LaneInfo {
 public:
  ...
  const std::vector<jmc_auto::common::math::Vec2d> &points() const {
    return points_;
  }
  const std::vector<jmc_auto::common::math::Vec2d> &unit_directions() const {
  ...
  const std::vector<jmc_auto::common::math::LineSegment2d> &segments() const {
    return segments_;
  }
  ...
  bool IsOnLane(const jmc_auto::common::math::Vec2d &point) const;
  bool IsOnLane(const jmc_auto::common::math::Box2d &box) const;

  jmc_auto::common::PointENU GetSmoothPoint(double s) const;
  double DistanceTo(const jmc_auto::common::math::Vec2d &point) const;
  double DistanceTo(const jmc_auto::common::math::Vec2d &point,
                    jmc_auto::common::math::Vec2d *map_point, double *s_offset,
                    int *s_offset_index) const;
  jmc_auto::common::PointENU GetNearestPoint(
      const jmc_auto::common::math::Vec2d &point, double *distance) const;
  bool GetProjection(const jmc_auto::common::math::Vec2d &point,
 ...
 private:
  const Lane &lane_;
  std::vector<jmc_auto::common::math::Vec2d> points_;
  std::vector<jmc_auto::common::math::Vec2d> unit_directions_;
  std::vector<double> headings_;
  std::vector<jmc_auto::common::math::LineSegment2d> segments_;
...
class JunctionInfo {
 public:
  ...
  const jmc_auto::common::math::Polygon2d &polygon() const { return polygon_; }
 ...
 private:
  ...
  jmc_auto::common::math::Polygon2d polygon_;

  std::vector<Id> overlap_stop_sign_ids_;
  std::vector<Id> overlap_ids_;
};
using JunctionPolygonBox =
    ObjectWithAABox<JunctionInfo, jmc_auto::common::math::Polygon2d>;
using JunctionPolygonKDTree =
    jmc_auto::common::math::AABoxKDTree2d<JunctionPolygonBox>;
...
using SignalSegmentBox =
    ObjectWithAABox<SignalInfo, jmc_auto::common::math::LineSegment2d>;
using SignalSegmentKDTree =
    jmc_auto::common::math::AABoxKDTree2d<SignalSegmentBox>;
...
using CrosswalkPolygonBox =
    ObjectWithAABox<CrosswalkInfo, jmc_auto::common::math::Polygon2d>;
using CrosswalkPolygonKDTree =
    jmc_auto::common::math::AABoxKDTree2d<CrosswalkPolygonBox>;
...
using StopSignSegmentBox =
    ObjectWithAABox<StopSignInfo, jmc_auto::common::math::LineSegment2d>;
using StopSignSegmentKDTree =
    jmc_auto::common::math::AABoxKDTree2d<StopSignSegmentBox>;
...
using YieldSignSegmentBox =
    ObjectWithAABox<YieldSignInfo, jmc_auto::common::math::LineSegment2d>;
using YieldSignSegmentKDTree =
    jmc_auto::common::math::AABoxKDTree2d<YieldSignSegmentBox>;
...
using ClearAreaPolygonBox =
    ObjectWithAABox<ClearAreaInfo, jmc_auto::common::math::Polygon2d>;
using ClearAreaPolygonKDTree =
    jmc_auto::common::math::AABoxKDTree2d<ClearAreaPolygonBox>;
...
using SpeedBumpSegmentBox =
    ObjectWithAABox<SpeedBumpInfo, jmc_auto::common::math::LineSegment2d>;
using SpeedBumpSegmentKDTree =
    jmc_auto::common::math::AABoxKDTree2d<SpeedBumpSegmentBox>;
...
using ParkingSpacePolygonBox =
    ObjectWithAABox<ParkingSpaceInfo, jmc_auto::common::math::Polygon2d>;
using ParkingSpacePolygonKDTree =
    jmc_auto::common::math::AABoxKDTree2d<ParkingSpacePolygonBox>;
...
using PNCJunctionPolygonBox =
    ObjectWithAABox<PNCJunctionInfo, jmc_auto::common::math::Polygon2d>;
using PNCJunctionPolygonKDTree =
    jmc_auto::common::math::AABoxKDTree2d<PNCJunctionPolygonBox>;
