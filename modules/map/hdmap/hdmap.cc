...
int HDMap::GetLanes(const jmc_auto::common::PointENU& point, double distance,
                    std::vector<LaneInfoConstPtr>* lanes) const {
  return impl_.GetLanes(point, distance, lanes);
}

int HDMap::GetJunctions(const jmc_auto::common::PointENU& point, double distance,
...
int HDMap::GetSignals(const jmc_auto::common::PointENU& point, double distance,
                      std::vector<SignalInfoConstPtr>* signals) const {
  return impl_.GetSignals(point, distance, signals);
}

int HDMap::GetCrosswalks(const jmc_auto::common::PointENU& point, double distance,
                         std::vector<CrosswalkInfoConstPtr>* crosswalks) const {
  return impl_.GetCrosswalks(point, distance, crosswalks);
}

int HDMap::GetStopSigns(const jmc_auto::common::PointENU& point, double distance,
...
int HDMap::GetRoads(const jmc_auto::common::PointENU& point, double distance,
...
int HDMap::GetNearestLaneWithHeading(const jmc_auto::common::PointENU& point,
...
int HDMap::GetLanesWithHeading(const jmc_auto::common::PointENU& point,
                               const double distance,
                               const double central_heading,
                               const double max_heading_difference,
                               std::vector<LaneInfoConstPtr>* lanes) const {
...
int HDMap::GetRoadBoundaries(
    const jmc_auto::common::PointENU& point, double radius,
