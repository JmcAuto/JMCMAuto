...
void HDMapCommonTestSuite::InitLaneObj(Lane* lane) {
  ...
  jmc_auto::common::PointENU* pt = line_segment->add_point();
  pt->set_x(170001.0);
  pt->set_y(1.0);
...
void HDMapCommonTestSuite::InitJunctionObj(Junction* junction) {
  ...
  jmc_auto::common::PointENU* pt = polygon->add_point();
  pt->set_x(170001.0);
  pt->set_y(170001.0);
...
TEST_F(HDMapCommonTestSuite, BoxIsOnLane) {
  ...
  jmc_auto::common::math::Box2d target_in_box(
      jmc_auto::common::math::LineSegment2d({170002, 1}, {170003, 1}), 0.5);
  EXPECT_TRUE(lane_info.IsOnLane(target_in_box));

  jmc_auto::common::math::Box2d target_out_box(
      jmc_auto::common::math::LineSegment2d({170002, 1}, {170003, 1}), 4);
...
TEST_F(HDMapCommonTestSuite, DistanceToWithMoreInfo) {
  ...
  jmc_auto::common::math::Vec2d foot_point;
  double s_offset = 0.0;
