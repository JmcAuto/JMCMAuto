...
class HDMapImpl {
 ...
 public:
   ...
   * @return 0:success, otherwise failed
   */
  int GetLanes(const jmc_auto::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetJunctions(const jmc_auto::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetCrosswalks(const jmc_auto::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetSignals(const jmc_auto::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetStopSigns(const jmc_auto::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetYieldSigns(const jmc_auto::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetClearAreas(const jmc_auto::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetSpeedBumps(const jmc_auto::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetRoads(const jmc_auto::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetParkingSpaces(const jmc_auto::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise, failed.
   */
  int GetNearestLane(const jmc_auto::common::PointENU& point,
   ...
   * @return 0:success, otherwise, failed.
   */
  int GetNearestLaneWithHeading(const jmc_auto::common::PointENU& point,
   ...
   * @return 0:success, otherwise, failed.
   */
  int GetLanesWithHeading(const jmc_auto::common::PointENU& point,
   ...
   * @return 0:success, otherwise failed
   */
  int GetRoadBoundaries(const jmc_auto::common::PointENU& point, double radius,
 ...
 private:
  int GetLanes(const jmc_auto::common::math::Vec2d& point, double distance,
               std::vector<LaneInfoConstPtr>* lanes) const;
  int GetJunctions(const jmc_auto::common::math::Vec2d& point, double distance,
                   std::vector<JunctionInfoConstPtr>* junctions) const;
  int GetCrosswalks(const jmc_auto::common::math::Vec2d& point, double distance,
                    std::vector<CrosswalkInfoConstPtr>* crosswalks) const;
  int GetSignals(const jmc_auto::common::math::Vec2d& point, double distance,
                 std::vector<SignalInfoConstPtr>* signals) const;
  int GetStopSigns(const jmc_auto::common::math::Vec2d& point, double distance,
                   std::vector<StopSignInfoConstPtr>* stop_signs) const;
  int GetYieldSigns(const jmc_auto::common::math::Vec2d& point, double distance,
                    std::vector<YieldSignInfoConstPtr>* yield_signs) const;
  int GetClearAreas(const jmc_auto::common::math::Vec2d& point, double distance,
                    std::vector<ClearAreaInfoConstPtr>* clear_areas) const;
  int GetSpeedBumps(const jmc_auto::common::math::Vec2d& point, double distance,
                    std::vector<SpeedBumpInfoConstPtr>* speed_bumps) const;
  int GetParkingSpaces(const jmc_auto::common::math::Vec2d& point,
                       double distance,
                       std::vector<ParkingSpaceInfoConstPtr>*
                       parking_spaces) const;
  int GetPNCJunctions(
      ...
      std::vector<PNCJunctionInfoConstPtr>* pnc_junctions) const;
  int GetNearestLane(const jmc_auto::common::math::Vec2d& point,
                     LaneInfoConstPtr* nearest_lane, double* nearest_s,
                     double* nearest_l) const;
  int GetNearestLaneWithHeading(const jmc_auto::common::math::Vec2d& point,
                                const double distance,
                                const double central_heading,
                                const double max_heading_difference,
                                LaneInfoConstPtr* nearest_lane,
                                double* nearest_s, double* nearest_l) const;
  int GetLanesWithHeading(const jmc_auto::common::math::Vec2d& point,
                          const double distance, const double central_heading,
                          const double max_heading_difference,
                          std::vector<LaneInfoConstPtr>* lanes) const;
  int GetRoads(const jmc_auto::common::math::Vec2d& point, double distance,
               std::vector<RoadInfoConstPtr>* roads) const;

  template <class Table, class BoxTable, class KDTree>
  static void BuildSegmentKDTree(
      const Table& table, const jmc_auto::common::math::AABoxKDTreeParams& params,
  ...
  static int SearchObjects(const jmc_auto::common::math::Vec2d& center,
