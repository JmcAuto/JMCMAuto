...
void TableStruct::InitDefaultsImpl() {
  ...
  ::jmc_auto::monitor::protobuf_modules_2fmonitor_2fproto_2fsystem_5fstatus_2eproto::InitDefaults();
  ...
  *HMIStatus::_default_current_mode_.get_mutable() = ::std::string("Standard", 8);
  ...
  _HMIStatus_default_instance_.get_mutable()->system_status_ = const_cast< ::jmc_auto::monitor::SystemStatus*>(
      ::jmc_auto::monitor::SystemStatus::internal_default_instance());
}
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "to\022\022jmc_auto.dreamview\032)modules/monitor/"
      "proto/system_status.proto\"\220\001\n\tHMIStatus\022"
      "5\n\rsystem_status\030\001 \001(\0132\036.jmc_auto.monito"
      "r.SystemStatus\022\023\n\013current_map\030\002 \001(\t\022\027\n\017c"
      "urrent_vehicle\030\003 \001(\t\022\036\n\014current_mode\030\004 \001"
      "(\t:\010Standard"
  };
  ...
  ::jmc_auto::monitor::protobuf_modules_2fmonitor_2fproto_2fsystem_5fstatus_2eproto::AddDescriptors();
...
HMIStatus::HMIStatus()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.dreamview.HMIStatus)
}
HMIStatus::HMIStatus(const HMIStatus& from)
  ...
  if (from.has_system_status()) {
    system_status_ = new ::jmc_auto::monitor::SystemStatus(*from.system_status_);
  } else {
    system_status_ = NULL;
  }
  // @@protoc_insertion_point(copy_constructor:jmc_auto.dreamview.HMIStatus)
}
...
HMIStatus::~HMIStatus() {
  // @@protoc_insertion_point(destructor:jmc_auto.dreamview.HMIStatus)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.dreamview.HMIStatus)
  if (_has_bits_[0 / 32] & 15u) {
    ...
    if (has_system_status()) {
      ...
      system_status_->::jmc_auto::monitor::SystemStatus::Clear();
    }
  }
  _has_bits_.Clear();
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:jmc_auto.dreamview.HMIStatus)
  for (;;) {
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            "jmc_auto.dreamview.HMIStatus.current_map");
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            ::google::protobuf::internal::WireFormat::PARSE,
            "jmc_auto.dreamview.HMIStatus.current_vehicle");
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 4: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            ::google::protobuf::internal::WireFormat::PARSE,
            "jmc_auto.dreamview.HMIStatus.current_mode");
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.dreamview.HMIStatus)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.dreamview.HMIStatus)
  return false;
#undef DO_
}
...
void HMIStatus::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:jmc_auto.dreamview.HMIStatus)
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.dreamview.HMIStatus)
}

::google::protobuf::uint8* HMIStatus::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.dreamview.HMIStatus)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.dreamview.HMIStatus)
  return target;
}

size_t HMIStatus::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.dreamview.HMIStatus)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.dreamview.HMIStatus)
  GOOGLE_DCHECK_NE(&from, this);
  const HMIStatus* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const HMIStatus>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.dreamview.HMIStatus)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.dreamview.HMIStatus)
    MergeFrom(*source);
  }
}

void HMIStatus::MergeFrom(const HMIStatus& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.dreamview.HMIStatus)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 15u) {
    ...
    if (cached_has_bits & 0x00000008u) {
      mutable_system_status()->::jmc_auto::monitor::SystemStatus::MergeFrom(from.system_status());
    }
  }
}

void HMIStatus::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.dreamview.HMIStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.dreamview.HMIStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void HMIStatus::clear_system_status() {
  if (system_status_ != NULL) system_status_->::jmc_auto::monitor::SystemStatus::Clear();
  clear_has_system_status();
}
const ::jmc_auto::monitor::SystemStatus& HMIStatus::system_status() const {
  // @@protoc_insertion_point(field_get:jmc_auto.dreamview.HMIStatus.system_status)
  return system_status_ != NULL ? *system_status_
                         : *::jmc_auto::monitor::SystemStatus::internal_default_instance();
}
::jmc_auto::monitor::SystemStatus* HMIStatus::mutable_system_status() {
  set_has_system_status();
  if (system_status_ == NULL) {
    system_status_ = new ::jmc_auto::monitor::SystemStatus;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.dreamview.HMIStatus.system_status)
  return system_status_;
}
::jmc_auto::monitor::SystemStatus* HMIStatus::release_system_status() {
  // @@protoc_insertion_point(field_release:jmc_auto.dreamview.HMIStatus.system_status)
  clear_has_system_status();
  ::jmc_auto::monitor::SystemStatus* temp = system_status_;
  system_status_ = NULL;
  return temp;
}
void HMIStatus::set_allocated_system_status(::jmc_auto::monitor::SystemStatus* system_status) {
  delete system_status_;
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.dreamview.HMIStatus.system_status)
}
...
const ::std::string& HMIStatus::current_map() const {
  // @@protoc_insertion_point(field_get:jmc_auto.dreamview.HMIStatus.current_map)
...
void HMIStatus::set_current_map(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:jmc_auto.dreamview.HMIStatus.current_map)
}
#if LANG_CXX11
void HMIStatus::set_current_map(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:jmc_auto.dreamview.HMIStatus.current_map)
}
#endif
void HMIStatus::set_current_map(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:jmc_auto.dreamview.HMIStatus.current_map)
}
void HMIStatus::set_current_map(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:jmc_auto.dreamview.HMIStatus.current_map)
}
::std::string* HMIStatus::mutable_current_map() {
  set_has_current_map();
  // @@protoc_insertion_point(field_mutable:jmc_auto.dreamview.HMIStatus.current_map)
...
::std::string* HMIStatus::release_current_map() {
  // @@protoc_insertion_point(field_release:jmc_auto.dreamview.HMIStatus.current_map)
  clear_has_current_map();
...
void HMIStatus::set_allocated_current_map(::std::string* current_map) {
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.dreamview.HMIStatus.current_map)
}
...
const ::std::string& HMIStatus::current_vehicle() const {
  // @@protoc_insertion_point(field_get:jmc_auto.dreamview.HMIStatus.current_vehicle)
...
void HMIStatus::set_current_vehicle(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:jmc_auto.dreamview.HMIStatus.current_vehicle)
}
#if LANG_CXX11
void HMIStatus::set_current_vehicle(::std::string&& value) {
  ...
  current_vehicle_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:jmc_auto.dreamview.HMIStatus.current_vehicle)
}
#endif
void HMIStatus::set_current_vehicle(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:jmc_auto.dreamview.HMIStatus.current_vehicle)
}
void HMIStatus::set_current_vehicle(const char* value, size_t size) {
  ...
  current_vehicle_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:jmc_auto.dreamview.HMIStatus.current_vehicle)
}
::std::string* HMIStatus::mutable_current_vehicle() {
  set_has_current_vehicle();
  // @@protoc_insertion_point(field_mutable:jmc_auto.dreamview.HMIStatus.current_vehicle)
...
::std::string* HMIStatus::release_current_vehicle() {
  // @@protoc_insertion_point(field_release:jmc_auto.dreamview.HMIStatus.current_vehicle)
  clear_has_current_vehicle();
...
void HMIStatus::set_allocated_current_vehicle(::std::string* current_vehicle) {
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.dreamview.HMIStatus.current_vehicle)
}
...
const ::std::string& HMIStatus::current_mode() const {
  // @@protoc_insertion_point(field_get:jmc_auto.dreamview.HMIStatus.current_mode)
...
void HMIStatus::set_current_mode(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:jmc_auto.dreamview.HMIStatus.current_mode)
}
#if LANG_CXX11
void HMIStatus::set_current_mode(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:jmc_auto.dreamview.HMIStatus.current_mode)
}
#endif
void HMIStatus::set_current_mode(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:jmc_auto.dreamview.HMIStatus.current_mode)
}
void HMIStatus::set_current_mode(const char* value, size_t size) {
  ...
  current_mode_.SetNoArena(&HMIStatus::_default_current_mode_.get(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:jmc_auto.dreamview.HMIStatus.current_mode)
}
::std::string* HMIStatus::mutable_current_mode() {
  set_has_current_mode();
  // @@protoc_insertion_point(field_mutable:jmc_auto.dreamview.HMIStatus.current_mode)
  return current_mode_.MutableNoArena(&HMIStatus::_default_current_mode_.get());
}
::std::string* HMIStatus::release_current_mode() {
  // @@protoc_insertion_point(field_release:jmc_auto.dreamview.HMIStatus.current_mode)
  clear_has_current_mode();
...
void HMIStatus::set_allocated_current_mode(::std::string* current_mode) {
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.dreamview.HMIStatus.current_mode)
}
