...
class HMIStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.dreamview.HMIStatus) */ {
 public:
  HMIStatus();
  virtual ~HMIStatus();
  ...
  const ::jmc_auto::monitor::SystemStatus& system_status() const;
  ::jmc_auto::monitor::SystemStatus* mutable_system_status();
  ::jmc_auto::monitor::SystemStatus* release_system_status();
  void set_allocated_system_status(::jmc_auto::monitor::SystemStatus* system_status);

  // @@protoc_insertion_point(class_scope:jmc_auto.dreamview.HMIStatus)
 private:
...
inline const ::jmc_auto::monitor::SystemStatus& HMIStatus::system_status() const {
...
inline ::jmc_auto::monitor::SystemStatus* HMIStatus::mutable_system_status() {
...
inline ::jmc_auto::monitor::SystemStatus* HMIStatus::release_system_status() {
...
inline void HMIStatus::set_allocated_system_status(::jmc_auto::monitor::SystemStatus* system_status) {
