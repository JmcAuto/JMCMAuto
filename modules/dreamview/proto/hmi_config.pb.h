...
class Component : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.dreamview.Component) */ {
 public:
  Component();
  virtual ~Component();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.dreamview.Component)
 private:
...
class Mode : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.dreamview.Mode) */ {
 public:
  Mode();
  virtual ~Mode();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.dreamview.Mode)
 private:
...
class AudioCapturingConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.dreamview.AudioCapturingConfig) */ {
 public:
  ...
  inline AudioCapturingConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  AudioCapturingConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.dreamview.AudioCapturingConfig)
 private:
  void set_has_channels();
  void clear_has_channels();
  void set_has_sample_rate();
  void clear_has_sample_rate();
  void set_has_bits_per_sample();
  void clear_has_bits_per_sample();
...
class HMIConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.dreamview.HMIConfig) */ {
 public:
  HMIConfig();
  virtual ~HMIConfig();
  ...
  const ::jmc_auto::dreamview::AudioCapturingConfig& audio_capturing_conf() const;
  ::jmc_auto::dreamview::AudioCapturingConfig* mutable_audio_capturing_conf();
  ::jmc_auto::dreamview::AudioCapturingConfig* release_audio_capturing_conf();
  void set_allocated_audio_capturing_conf(::jmc_auto::dreamview::AudioCapturingConfig* audio_capturing_conf);
  ...
  ::jmc_auto::dreamview::HMIAction chassis_high_beam_action() const;
  void set_chassis_high_beam_action(::jmc_auto::dreamview::HMIAction value);

  // @@protoc_insertion_point(class_scope:jmc_auto.dreamview.HMIConfig)
 private:
  void set_has_docker_image();
  void clear_has_docker_image();
  void set_has_utm_zone_id();
  void clear_has_utm_zone_id();
  void set_has_audio_capturing_conf();
  void clear_has_audio_capturing_conf();
  void set_has_chassis_high_beam_action();
  void clear_has_chassis_high_beam_action();
  ...
  ::jmc_auto::dreamview::AudioCapturingConfig* audio_capturing_conf_;
...
class VehicleData_DataFile : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.dreamview.VehicleData.DataFile) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.dreamview.VehicleData.DataFile)
 private:
...
class VehicleData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.dreamview.VehicleData) */ {
 public:
  VehicleData();
  virtual ~VehicleData();
  ...
  const ::jmc_auto::dreamview::VehicleData_DataFile& data_files(int index) const;
  ::jmc_auto::dreamview::VehicleData_DataFile* mutable_data_files(int index);
  ::jmc_auto::dreamview::VehicleData_DataFile* add_data_files();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.dreamview.VehicleData)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::jmc_auto::dreamview::VehicleData_DataFile > data_files_;
  friend struct protobuf_modules_2fdreamview_2fproto_2fhmi_5fconfig_2eproto::TableStruct;
};
// ===================================================================
...
#if LANG_CXX11
inline void HMIConfig::set_docker_image(::std::string&& value) {
  set_has_docker_image();
...
inline const ::google::protobuf::Map< ::std::string, ::jmc_auto::dreamview::Component >&
HMIConfig::modules() const {
  // @@protoc_insertion_point(field_map:jmc_auto.dreamview.HMIConfig.modules)
  return modules_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::jmc_auto::dreamview::Component >*
...
inline const ::google::protobuf::Map< ::std::string, ::jmc_auto::dreamview::Mode >&
HMIConfig::modes() const {
  // @@protoc_insertion_point(field_map:jmc_auto.dreamview.HMIConfig.modes)
  return modes_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::jmc_auto::dreamview::Mode >*
...
inline const ::jmc_auto::dreamview::AudioCapturingConfig& HMIConfig::audio_capturing_conf() const {
...
inline ::jmc_auto::dreamview::AudioCapturingConfig* HMIConfig::mutable_audio_capturing_conf() {
...
inline ::jmc_auto::dreamview::AudioCapturingConfig* HMIConfig::release_audio_capturing_conf() {
...
inline void HMIConfig::set_allocated_audio_capturing_conf(::jmc_auto::dreamview::AudioCapturingConfig* audio_capturing_conf) {
...
inline ::jmc_auto::dreamview::HMIAction HMIConfig::chassis_high_beam_action() const {
...
inline void HMIConfig::set_chassis_high_beam_action(::jmc_auto::dreamview::HMIAction value) {
...
template <> struct is_proto_enum< ::jmc_auto::dreamview::HMIAction> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::dreamview::HMIAction>() {
  return ::jmc_auto::dreamview::HMIAction_descriptor();
}
