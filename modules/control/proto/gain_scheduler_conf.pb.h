...
class GainScheduler : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.control.GainScheduler) */ {
 public:
  GainScheduler();
  ...
  const ::jmc_auto::control::GainSchedulerInfo& scheduler(int index) const;
  ::jmc_auto::control::GainSchedulerInfo* mutable_scheduler(int index);
  ::jmc_auto::control::GainSchedulerInfo* add_scheduler();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.control.GainScheduler)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::jmc_auto::control::GainSchedulerInfo > scheduler_;
  friend struct protobuf_modules_2fcontrol_2fproto_2fgain_5fscheduler_5fconf_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class GainSchedulerInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.control.GainSchedulerInfo) */ {
 public:
  GainSchedulerInfo();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.control.GainSchedulerInfo)
 private:
  void set_has_speed();
