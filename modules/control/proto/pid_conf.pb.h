...
class PidConf : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.control.PidConf) */ {
 public:
  PidConf();
  virtual ~PidConf();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.control.PidConf)
 private:
