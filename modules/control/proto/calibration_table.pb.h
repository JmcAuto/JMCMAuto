...
#ifndef PROTOBUF_modules_2fcontrol_2fproto_2fcalibration_5ftable_2eproto__INCLUDED
#define PROTOBUF_modules_2fcontrol_2fproto_2fcalibration_5ftable_2eproto__INCLUDED
...
class ControlCalibrationTable : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.control.calibrationtable.ControlCalibrationTable) */ {
 public:
  ...
  inline ControlCalibrationTable* New() const PROTOBUF_FINAL { return New(NULL); }

  ControlCalibrationTable* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  const ::jmc_auto::control::calibrationtable::ControlCalibrationInfo& calibration(int index) const;
  ::jmc_auto::control::calibrationtable::ControlCalibrationInfo* mutable_calibration(int index);
  ::jmc_auto::control::calibrationtable::ControlCalibrationInfo* add_calibration();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.control.calibrationtable.ControlCalibrationTable)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::jmc_auto::control::calibrationtable::ControlCalibrationInfo > calibration_;
  friend struct protobuf_modules_2fcontrol_2fproto_2fcalibration_5ftable_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class ControlCalibrationInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.control.calibrationtable.ControlCalibrationInfo) */ {
 public:
  ...
  inline ControlCalibrationInfo* New() const PROTOBUF_FINAL { return New(NULL); }

  ControlCalibrationInfo* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.control.calibrationtable.ControlCalibrationInfo)
 private:
  void set_has_speed();
...
inline const ::jmc_auto::control::calibrationtable::ControlCalibrationInfo& ControlCalibrationTable::calibration(int index) const {
...
inline ::jmc_auto::control::calibrationtable::ControlCalibrationInfo* ControlCalibrationTable::mutable_calibration(int index) {
...
inline ::jmc_auto::control::calibrationtable::ControlCalibrationInfo* ControlCalibrationTable::add_calibration() {
...
inline ::google::protobuf::RepeatedPtrField< ::jmc_auto::control::calibrationtable::ControlCalibrationInfo >*
...
inline const ::google::protobuf::RepeatedPtrField< ::jmc_auto::control::calibrationtable::ControlCalibrationInfo >&
...
#endif  // PROTOBUF_modules_2fcontrol_2fproto_2fcalibration_5ftable_2eproto__INCLUDED
