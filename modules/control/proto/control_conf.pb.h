...
class ControlConf : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.control.ControlConf) */ {
 public:
  ControlConf();
  virtual ~ControlConf();
  ...
  ::jmc_auto::control::ControlConf_ControllerType active_controllers(int index) const;
  void set_active_controllers(int index, ::jmc_auto::control::ControlConf_ControllerType value);
  void add_active_controllers(::jmc_auto::control::ControlConf_ControllerType value);
  ...
  const ::jmc_auto::control::LatControllerConf& lat_controller_conf() const;
  ::jmc_auto::control::LatControllerConf* mutable_lat_controller_conf();
  ::jmc_auto::control::LatControllerConf* release_lat_controller_conf();
  void set_allocated_lat_controller_conf(::jmc_auto::control::LatControllerConf* lat_controller_conf);
  ...
  const ::jmc_auto::control::LonControllerConf& lon_controller_conf() const;
  ::jmc_auto::control::LonControllerConf* mutable_lon_controller_conf();
  ::jmc_auto::control::LonControllerConf* release_lon_controller_conf();
  void set_allocated_lon_controller_conf(::jmc_auto::control::LonControllerConf* lon_controller_conf);
  ...
  bool has_soft_estop_brake_acceleration() const;
  void clear_soft_estop_brake_acceleration();
  static const int kSoftEstopBrakeAccelerationFieldNumber = 6;
  double soft_estop_brake_acceleration() const;
  void set_soft_estop_brake_acceleration(double value);
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.control.ControlConf)
 private:
  ...
  void set_has_soft_estop_brake_acceleration();
  void clear_has_soft_estop_brake_acceleration();
  ...
  void set_has_query_relative_time();
  void clear_has_query_relative_time();
  ...
  ::jmc_auto::control::LatControllerConf* lat_controller_conf_;
  ::jmc_auto::control::LonControllerConf* lon_controller_conf_;
  double control_period_;
  double max_planning_interval_sec_;
  double max_planning_delay_threshold_;
  int driving_mode_;
  int action_;
  double soft_estop_brake_acceleration_;
...
inline ::jmc_auto::canbus::Chassis_DrivingMode ControlConf::driving_mode() const {
...
inline void ControlConf::set_driving_mode(::jmc_auto::canbus::Chassis_DrivingMode value) {
...
inline ::jmc_auto::control::DrivingAction ControlConf::action() const {
...
inline void ControlConf::set_action(::jmc_auto::control::DrivingAction value) {
...
// optional double soft_estop_brake_acceleration = 6;
inline bool ControlConf::has_soft_estop_brake_acceleration() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void ControlConf::set_has_soft_estop_brake_acceleration() {
  _has_bits_[0] |= 0x00000080u;
}
inline void ControlConf::clear_has_soft_estop_brake_acceleration() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void ControlConf::clear_soft_estop_brake_acceleration() {
  soft_estop_brake_acceleration_ = 0;
  clear_has_soft_estop_brake_acceleration();
}
inline double ControlConf::soft_estop_brake_acceleration() const {
...
inline void ControlConf::set_soft_estop_brake_acceleration(double value) {
...
inline ::jmc_auto::control::ControlConf_ControllerType ControlConf::active_controllers(int index) const {
...
inline void ControlConf::set_active_controllers(int index, ::jmc_auto::control::ControlConf_ControllerType value) {
...
inline void ControlConf::add_active_controllers(::jmc_auto::control::ControlConf_ControllerType value) {
  assert(::jmc_auto::control::ControlConf_ControllerType_IsValid(value));
...
inline const ::jmc_auto::control::LatControllerConf& ControlConf::lat_controller_conf() const {
...
inline ::jmc_auto::control::LatControllerConf* ControlConf::mutable_lat_controller_conf() {
...
inline ::jmc_auto::control::LatControllerConf* ControlConf::release_lat_controller_conf() {
...
inline void ControlConf::set_allocated_lat_controller_conf(::jmc_auto::control::LatControllerConf* lat_controller_conf) {
...
inline const ::jmc_auto::control::LonControllerConf& ControlConf::lon_controller_conf() const {
...
inline ::jmc_auto::control::LonControllerConf* ControlConf::mutable_lon_controller_conf() {
...
inline ::jmc_auto::control::LonControllerConf* ControlConf::release_lon_controller_conf() {
...
inline void ControlConf::set_allocated_lon_controller_conf(::jmc_auto::control::LonControllerConf* lon_controller_conf) {
...
template <> struct is_proto_enum< ::jmc_auto::control::ControlConf_ControllerType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::control::ControlConf_ControllerType>() {
  return ::jmc_auto::control::ControlConf_ControllerType_descriptor();
}
