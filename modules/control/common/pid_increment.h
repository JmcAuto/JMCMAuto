...
/**
 * @file pid_increment.h
 * @brief Defines the Increment PIDController class.
 * deta_u=Kp*[e(n)-e(n-1)]+Ki*e(n)+Kd*[e(n)-2e(n-1)+e(n-2)]
 */

#ifndef MODULES_CONTROL_COMMON_PID_INCREMENT_H_
#define MODULES_CONTROL_COMMON_PID_INCREMENT_H_
...
class PIDIncrement {
 ...
 protected:
  ...
  double previous_last_error = 0.0 ;
