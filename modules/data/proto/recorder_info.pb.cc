...
void TableStruct::InitDefaultsImpl() {
  ...
  _RecorderInfo_default_instance_.get_mutable()->task_ = const_cast< ::jmc_auto::data::recorder::Task*>(
      ::jmc_auto::data::recorder::Task::internal_default_instance());
  _RecorderInfo_default_instance_.get_mutable()->writing_disk_ = const_cast< ::jmc_auto::data::recorder::Disk*>(
      ::jmc_auto::data::recorder::Disk::internal_default_instance());
  _RecorderInfo_default_instance_.get_mutable()->data_ = const_cast< ::jmc_auto::data::recorder::Data*>(
      ::jmc_auto::data::recorder::Data::internal_default_instance());
  _RecorderInfo_default_instance_.get_mutable()->resources_ = const_cast< ::jmc_auto::data::recorder::Resources*>(
      ::jmc_auto::data::recorder::Resources::internal_default_instance());
}
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "\022\026jmc_auto.data.recorder\"\340\001\n\014RecorderInf"
      "o\022\016\n\006status\030\001 \001(\r\022*\n\004task\030\002 \001(\0132\034.jmc_au"
      "to.data.recorder.Task\0222\n\014writing_disk\030\003 "
      "\001(\0132\034.jmc_auto.data.recorder.Disk\022*\n\004dat"
      "a\030\004 \001(\0132\034.jmc_auto.data.recorder.Data\0224\n"
      "\tresources\030\005 \001(\0132!.jmc_auto.data.recorde"
      "r.Resources\"6\n\004Task\022\n\n\002id\030\001 \001(\t\022\020\n\010seque"
      "nce\030\002 \001(\r\022\020\n\010duration\030\003 \001(\001\"{\n\004Disk\022\n\n\002s"
      "n\030\001 \001(\t\022\n\n\002fs\030\002 \001(\t\022\014\n\004size\030\003 \001(\001\022\014\n\004use"
      "d\030\004 \001(\001\022\r\n\005avail\030\005 \001(\001\022\023\n\013use_percent\030\006 "
      "\001(\001\022\r\n\005mount\030\007 \001(\t\022\014\n\004slot\030\010 \001(\t\"8\n\tReso"
      "urces\022+\n\005disks\030\001 \003(\0132\034.jmc_auto.data.rec"
      "order.Disk\"1\n\004Data\022)\n\004bags\030\001 \003(\0132\033.jmc_a"
      "uto.data.recorder.Bag\"\037\n\003Bag\022\030\n\020writing_"
      "filename\030\001 \001(\t*\333\001\n\nStatusType\022\026\n\022DATA_RE"
      "CORDER_INIT\020\000\022\031\n\025DATA_RECORDER_RUNNING\020\001"
      "\022\026\n\022DATA_RECORD_ENABLE\020\002\022\024\n\020DATA_SYNC_EN"
      "ABLE\020\004\022\027\n\023DISK_SPACE_WARNNING\020\010\022\024\n\020DISK_"
      "SPACE_ALERT\020\020\022\025\n\021DELETING_OLD_DATA\020 \022\026\n\022"
      "DATA_RECORDER_EXIT\020@\022\016\n\tUNDEFINED\020\200\001"
  };
...
RecorderInfo::RecorderInfo()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.data.recorder.RecorderInfo)
}
RecorderInfo::RecorderInfo(const RecorderInfo& from)
  ...
  if (from.has_task()) {
    task_ = new ::jmc_auto::data::recorder::Task(*from.task_);
  } else {
    task_ = NULL;
  }
  if (from.has_writing_disk()) {
    writing_disk_ = new ::jmc_auto::data::recorder::Disk(*from.writing_disk_);
  } else {
    writing_disk_ = NULL;
  }
  if (from.has_data()) {
    data_ = new ::jmc_auto::data::recorder::Data(*from.data_);
  } else {
    data_ = NULL;
  }
  if (from.has_resources()) {
    resources_ = new ::jmc_auto::data::recorder::Resources(*from.resources_);
  } else {
    resources_ = NULL;
  }
  status_ = from.status_;
  // @@protoc_insertion_point(copy_constructor:jmc_auto.data.recorder.RecorderInfo)
}
...
RecorderInfo::~RecorderInfo() {
  // @@protoc_insertion_point(destructor:jmc_auto.data.recorder.RecorderInfo)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.data.recorder.RecorderInfo)
  if (_has_bits_[0 / 32] & 15u) {
    if (has_task()) {
      GOOGLE_DCHECK(task_ != NULL);
      task_->::jmc_auto::data::recorder::Task::Clear();
    }
    if (has_writing_disk()) {
      GOOGLE_DCHECK(writing_disk_ != NULL);
      writing_disk_->::jmc_auto::data::recorder::Disk::Clear();
    }
    if (has_data()) {
      GOOGLE_DCHECK(data_ != NULL);
      data_->::jmc_auto::data::recorder::Data::Clear();
    }
    if (has_resources()) {
      GOOGLE_DCHECK(resources_ != NULL);
      resources_->::jmc_auto::data::recorder::Resources::Clear();
    }
  }
  status_ = 0u;
  _has_bits_.Clear();
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:jmc_auto.data.recorder.RecorderInfo)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // optional .jmc_auto.data.recorder.Task task = 2;
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
      ...
      // optional .jmc_auto.data.recorder.Disk writing_disk = 3;
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
      ...
      // optional .jmc_auto.data.recorder.Data data = 4;
      case 4: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
      ...
      // optional .jmc_auto.data.recorder.Resources resources = 5;
      case 5: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.data.recorder.RecorderInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.data.recorder.RecorderInfo)
  return false;
#undef DO_
}
...
void RecorderInfo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:jmc_auto.data.recorder.RecorderInfo)
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.data.recorder.RecorderInfo)
}

::google::protobuf::uint8* RecorderInfo::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.data.recorder.RecorderInfo)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.data.recorder.RecorderInfo)
  return target;
}

size_t RecorderInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.data.recorder.RecorderInfo)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.data.recorder.RecorderInfo)
  GOOGLE_DCHECK_NE(&from, this);
  const RecorderInfo* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const RecorderInfo>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.data.recorder.RecorderInfo)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.data.recorder.RecorderInfo)
    MergeFrom(*source);
  }
}

void RecorderInfo::MergeFrom(const RecorderInfo& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.data.recorder.RecorderInfo)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 31u) {
    if (cached_has_bits & 0x00000001u) {
      mutable_task()->::jmc_auto::data::recorder::Task::MergeFrom(from.task());
    }
    if (cached_has_bits & 0x00000002u) {
      mutable_writing_disk()->::jmc_auto::data::recorder::Disk::MergeFrom(from.writing_disk());
    }
    if (cached_has_bits & 0x00000004u) {
      mutable_data()->::jmc_auto::data::recorder::Data::MergeFrom(from.data());
    }
    if (cached_has_bits & 0x00000008u) {
      mutable_resources()->::jmc_auto::data::recorder::Resources::MergeFrom(from.resources());
    }
    if (cached_has_bits & 0x00000010u) {
      status_ = from.status_;
    }
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.data.recorder.RecorderInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.data.recorder.RecorderInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::uint32 RecorderInfo::status() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.RecorderInfo.status)
  return status_;
}
void RecorderInfo::set_status(::google::protobuf::uint32 value) {
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.RecorderInfo.status)
}
...
void RecorderInfo::clear_task() {
  if (task_ != NULL) task_->::jmc_auto::data::recorder::Task::Clear();
  clear_has_task();
}
const ::jmc_auto::data::recorder::Task& RecorderInfo::task() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.RecorderInfo.task)
  return task_ != NULL ? *task_
                         : *::jmc_auto::data::recorder::Task::internal_default_instance();
}
::jmc_auto::data::recorder::Task* RecorderInfo::mutable_task() {
  set_has_task();
  if (task_ == NULL) {
    task_ = new ::jmc_auto::data::recorder::Task;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.RecorderInfo.task)
  return task_;
}
::jmc_auto::data::recorder::Task* RecorderInfo::release_task() {
  // @@protoc_insertion_point(field_release:jmc_auto.data.recorder.RecorderInfo.task)
  clear_has_task();
  ::jmc_auto::data::recorder::Task* temp = task_;
  task_ = NULL;
  return temp;
}
void RecorderInfo::set_allocated_task(::jmc_auto::data::recorder::Task* task) {
  delete task_;
  task_ = task;
  if (task) {
    set_has_task();
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.data.recorder.RecorderInfo.task)
}
...
void RecorderInfo::clear_writing_disk() {
  if (writing_disk_ != NULL) writing_disk_->::jmc_auto::data::recorder::Disk::Clear();
  clear_has_writing_disk();
}
const ::jmc_auto::data::recorder::Disk& RecorderInfo::writing_disk() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.RecorderInfo.writing_disk)
  return writing_disk_ != NULL ? *writing_disk_
                         : *::jmc_auto::data::recorder::Disk::internal_default_instance();
}
::jmc_auto::data::recorder::Disk* RecorderInfo::mutable_writing_disk() {
  set_has_writing_disk();
  if (writing_disk_ == NULL) {
    writing_disk_ = new ::jmc_auto::data::recorder::Disk;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.RecorderInfo.writing_disk)
  return writing_disk_;
}
::jmc_auto::data::recorder::Disk* RecorderInfo::release_writing_disk() {
  // @@protoc_insertion_point(field_release:jmc_auto.data.recorder.RecorderInfo.writing_disk)
  clear_has_writing_disk();
  ::jmc_auto::data::recorder::Disk* temp = writing_disk_;
  writing_disk_ = NULL;
  return temp;
}
void RecorderInfo::set_allocated_writing_disk(::jmc_auto::data::recorder::Disk* writing_disk) {
  delete writing_disk_;
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.data.recorder.RecorderInfo.writing_disk)
}
...
void RecorderInfo::clear_data() {
  if (data_ != NULL) data_->::jmc_auto::data::recorder::Data::Clear();
  clear_has_data();
}
const ::jmc_auto::data::recorder::Data& RecorderInfo::data() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.RecorderInfo.data)
  return data_ != NULL ? *data_
                         : *::jmc_auto::data::recorder::Data::internal_default_instance();
}
::jmc_auto::data::recorder::Data* RecorderInfo::mutable_data() {
  set_has_data();
  if (data_ == NULL) {
    data_ = new ::jmc_auto::data::recorder::Data;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.RecorderInfo.data)
  return data_;
}
::jmc_auto::data::recorder::Data* RecorderInfo::release_data() {
  // @@protoc_insertion_point(field_release:jmc_auto.data.recorder.RecorderInfo.data)
  clear_has_data();
  ::jmc_auto::data::recorder::Data* temp = data_;
  data_ = NULL;
  return temp;
}
void RecorderInfo::set_allocated_data(::jmc_auto::data::recorder::Data* data) {
  delete data_;
  data_ = data;
  if (data) {
    set_has_data();
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.data.recorder.RecorderInfo.data)
}
...
void RecorderInfo::clear_resources() {
  if (resources_ != NULL) resources_->::jmc_auto::data::recorder::Resources::Clear();
  clear_has_resources();
}
const ::jmc_auto::data::recorder::Resources& RecorderInfo::resources() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.RecorderInfo.resources)
  return resources_ != NULL ? *resources_
                         : *::jmc_auto::data::recorder::Resources::internal_default_instance();
}
::jmc_auto::data::recorder::Resources* RecorderInfo::mutable_resources() {
  set_has_resources();
  if (resources_ == NULL) {
    resources_ = new ::jmc_auto::data::recorder::Resources;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.RecorderInfo.resources)
  return resources_;
}
::jmc_auto::data::recorder::Resources* RecorderInfo::release_resources() {
  // @@protoc_insertion_point(field_release:jmc_auto.data.recorder.RecorderInfo.resources)
  clear_has_resources();
  ::jmc_auto::data::recorder::Resources* temp = resources_;
  resources_ = NULL;
  return temp;
}
void RecorderInfo::set_allocated_resources(::jmc_auto::data::recorder::Resources* resources) {
  delete resources_;
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.data.recorder.RecorderInfo.resources)
}
...
Task::Task()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.data.recorder.Task)
}
Task::Task(const Task& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.data.recorder.Task)
}
...
Task::~Task() {
  // @@protoc_insertion_point(destructor:jmc_auto.data.recorder.Task)
  SharedDtor();
}
...
void Task::Clear() {
// @@protoc_insertion_point(message_clear_start:jmc_auto.data.recorder.Task)
  if (has_id()) {
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:jmc_auto.data.recorder.Task)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            "jmc_auto.data.recorder.Task.id");
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.data.recorder.Task)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.data.recorder.Task)
  return false;
#undef DO_
}
...
void Task::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:jmc_auto.data.recorder.Task)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.data.recorder.Task)
}

::google::protobuf::uint8* Task::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.data.recorder.Task)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.data.recorder.Task)
  return target;
}

size_t Task::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.data.recorder.Task)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.data.recorder.Task)
  GOOGLE_DCHECK_NE(&from, this);
  const Task* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const Task>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.data.recorder.Task)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.data.recorder.Task)
    MergeFrom(*source);
  }
}

void Task::MergeFrom(const Task& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.data.recorder.Task)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.data.recorder.Task)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.data.recorder.Task)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::std::string& Task::id() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Task.id)
  return id_.GetNoArena();
}
void Task::set_id(const ::std::string& value) {
  set_has_id();
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Task.id)
}
#if LANG_CXX11
void Task::set_id(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:jmc_auto.data.recorder.Task.id)
}
#endif
void Task::set_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:jmc_auto.data.recorder.Task.id)
}
void Task::set_id(const char* value, size_t size) {
  set_has_id();
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:jmc_auto.data.recorder.Task.id)
}
::std::string* Task::mutable_id() {
  set_has_id();
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.Task.id)
  return id_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* Task::release_id() {
  // @@protoc_insertion_point(field_release:jmc_auto.data.recorder.Task.id)
  clear_has_id();
...
void Task::set_allocated_id(::std::string* id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.data.recorder.Task.id)
}
...
::google::protobuf::uint32 Task::sequence() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Task.sequence)
  return sequence_;
}
void Task::set_sequence(::google::protobuf::uint32 value) {
  set_has_sequence();
  sequence_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Task.sequence)
}
...
double Task::duration() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Task.duration)
  return duration_;
}
void Task::set_duration(double value) {
  set_has_duration();
  duration_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Task.duration)
}
...
Disk::Disk()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.data.recorder.Disk)
}
Disk::Disk(const Disk& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.data.recorder.Disk)
}
...
Disk::~Disk() {
  // @@protoc_insertion_point(destructor:jmc_auto.data.recorder.Disk)
  SharedDtor();
}
...
void Disk::Clear() {
// @@protoc_insertion_point(message_clear_start:jmc_auto.data.recorder.Disk)
  if (_has_bits_[0 / 32] & 15u) {
    if (has_sn()) {
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:jmc_auto.data.recorder.Disk)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            ::google::protobuf::internal::WireFormat::PARSE,
            "jmc_auto.data.recorder.Disk.sn");
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            ::google::protobuf::internal::WireFormat::PARSE,
            "jmc_auto.data.recorder.Disk.fs");
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 7: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            ::google::protobuf::internal::WireFormat::PARSE,
            "jmc_auto.data.recorder.Disk.mount");
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 8: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            ::google::protobuf::internal::WireFormat::PARSE,
            "jmc_auto.data.recorder.Disk.slot");
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.data.recorder.Disk)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.data.recorder.Disk)
  return false;
#undef DO_
}
...
void Disk::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:jmc_auto.data.recorder.Disk)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.data.recorder.Disk)
}

::google::protobuf::uint8* Disk::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.data.recorder.Disk)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.data.recorder.Disk)
  return target;
}

size_t Disk::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.data.recorder.Disk)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.data.recorder.Disk)
  GOOGLE_DCHECK_NE(&from, this);
  const Disk* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const Disk>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.data.recorder.Disk)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.data.recorder.Disk)
    MergeFrom(*source);
  }
}

void Disk::MergeFrom(const Disk& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.data.recorder.Disk)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.data.recorder.Disk)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.data.recorder.Disk)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::std::string& Disk::sn() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Disk.sn)
...
void Disk::set_sn(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Disk.sn)
}
#if LANG_CXX11
void Disk::set_sn(::std::string&& value) {
  ...
  sn_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:jmc_auto.data.recorder.Disk.sn)
}
#endif
void Disk::set_sn(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:jmc_auto.data.recorder.Disk.sn)
}
void Disk::set_sn(const char* value, size_t size) {
  set_has_sn();
  sn_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:jmc_auto.data.recorder.Disk.sn)
}
::std::string* Disk::mutable_sn() {
  set_has_sn();
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.Disk.sn)
  return sn_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* Disk::release_sn() {
  // @@protoc_insertion_point(field_release:jmc_auto.data.recorder.Disk.sn)
  clear_has_sn();
...
void Disk::set_allocated_sn(::std::string* sn) {
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.data.recorder.Disk.sn)
}
...
const ::std::string& Disk::fs() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Disk.fs)
...
void Disk::set_fs(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Disk.fs)
}
#if LANG_CXX11
void Disk::set_fs(::std::string&& value) {
  ...
  fs_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:jmc_auto.data.recorder.Disk.fs)
}
#endif
void Disk::set_fs(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:jmc_auto.data.recorder.Disk.fs)
}
void Disk::set_fs(const char* value, size_t size) {
  set_has_fs();
  fs_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:jmc_auto.data.recorder.Disk.fs)
}
::std::string* Disk::mutable_fs() {
  set_has_fs();
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.Disk.fs)
  return fs_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* Disk::release_fs() {
  // @@protoc_insertion_point(field_release:jmc_auto.data.recorder.Disk.fs)
  clear_has_fs();
...
void Disk::set_allocated_fs(::std::string* fs) {
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.data.recorder.Disk.fs)
}
...
double Disk::size() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Disk.size)
  return size_;
}
void Disk::set_size(double value) {
  set_has_size();
  size_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Disk.size)
}
...
double Disk::used() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Disk.used)
  return used_;
}
void Disk::set_used(double value) {
  set_has_used();
  used_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Disk.used)
}
...
double Disk::avail() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Disk.avail)
  return avail_;
}
void Disk::set_avail(double value) {
  set_has_avail();
  avail_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Disk.avail)
}
...
double Disk::use_percent() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Disk.use_percent)
  return use_percent_;
}
void Disk::set_use_percent(double value) {
  set_has_use_percent();
  use_percent_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Disk.use_percent)
}
...
const ::std::string& Disk::mount() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Disk.mount)
...
void Disk::set_mount(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Disk.mount)
}
#if LANG_CXX11
void Disk::set_mount(::std::string&& value) {
  ...
  mount_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:jmc_auto.data.recorder.Disk.mount)
}
#endif
void Disk::set_mount(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:jmc_auto.data.recorder.Disk.mount)
}
void Disk::set_mount(const char* value, size_t size) {
  set_has_mount();
  mount_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:jmc_auto.data.recorder.Disk.mount)
}
::std::string* Disk::mutable_mount() {
  set_has_mount();
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.Disk.mount)
  return mount_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* Disk::release_mount() {
  // @@protoc_insertion_point(field_release:jmc_auto.data.recorder.Disk.mount)
  clear_has_mount();
...
void Disk::set_allocated_mount(::std::string* mount) {
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.data.recorder.Disk.mount)
}
...
const ::std::string& Disk::slot() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Disk.slot)
...
void Disk::set_slot(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Disk.slot)
}
#if LANG_CXX11
void Disk::set_slot(::std::string&& value) {
  ...
  slot_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:jmc_auto.data.recorder.Disk.slot)
}
#endif
void Disk::set_slot(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:jmc_auto.data.recorder.Disk.slot)
}
void Disk::set_slot(const char* value, size_t size) {
  set_has_slot();
  slot_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:jmc_auto.data.recorder.Disk.slot)
}
::std::string* Disk::mutable_slot() {
  set_has_slot();
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.Disk.slot)
  return slot_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* Disk::release_slot() {
  // @@protoc_insertion_point(field_release:jmc_auto.data.recorder.Disk.slot)
  clear_has_slot();
...
void Disk::set_allocated_slot(::std::string* slot) {
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.data.recorder.Disk.slot)
}
...
Resources::Resources()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.data.recorder.Resources)
}
Resources::Resources(const Resources& from)
  : ::google::protobuf::Message(),
      ...
      disks_(from.disks_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:jmc_auto.data.recorder.Resources)
}
...
Resources::~Resources() {
  // @@protoc_insertion_point(destructor:jmc_auto.data.recorder.Resources)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.data.recorder.Resources)
  disks_.Clear();
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:jmc_auto.data.recorder.Resources)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // repeated .jmc_auto.data.recorder.Disk disks = 1;
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(10u)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.data.recorder.Resources)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.data.recorder.Resources)
  return false;
#undef DO_
}
...
void Resources::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:jmc_auto.data.recorder.Resources)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.data.recorder.Resources)
}

::google::protobuf::uint8* Resources::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.data.recorder.Resources)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.data.recorder.Resources)
  return target;
}

size_t Resources::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.data.recorder.Resources)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.data.recorder.Resources)
  GOOGLE_DCHECK_NE(&from, this);
  const Resources* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const Resources>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.data.recorder.Resources)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.data.recorder.Resources)
    MergeFrom(*source);
  }
}

void Resources::MergeFrom(const Resources& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.data.recorder.Resources)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.data.recorder.Resources)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.data.recorder.Resources)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::jmc_auto::data::recorder::Disk& Resources::disks(int index) const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Resources.disks)
  return disks_.Get(index);
}
::jmc_auto::data::recorder::Disk* Resources::mutable_disks(int index) {
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.Resources.disks)
  return disks_.Mutable(index);
}
::jmc_auto::data::recorder::Disk* Resources::add_disks() {
  // @@protoc_insertion_point(field_add:jmc_auto.data.recorder.Resources.disks)
  return disks_.Add();
}
::google::protobuf::RepeatedPtrField< ::jmc_auto::data::recorder::Disk >*
Resources::mutable_disks() {
  // @@protoc_insertion_point(field_mutable_list:jmc_auto.data.recorder.Resources.disks)
  return &disks_;
}
const ::google::protobuf::RepeatedPtrField< ::jmc_auto::data::recorder::Disk >&
Resources::disks() const {
  // @@protoc_insertion_point(field_list:jmc_auto.data.recorder.Resources.disks)
  return disks_;
}
...
Data::Data()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.data.recorder.Data)
}
Data::Data(const Data& from)
  : ::google::protobuf::Message(),
      ...
      bags_(from.bags_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:jmc_auto.data.recorder.Data)
}
...
Data::~Data() {
  // @@protoc_insertion_point(destructor:jmc_auto.data.recorder.Data)
  SharedDtor();
}
...
void Data::Clear() {
// @@protoc_insertion_point(message_clear_start:jmc_auto.data.recorder.Data)
  bags_.Clear();
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:jmc_auto.data.recorder.Data)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // repeated .jmc_auto.data.recorder.Bag bags = 1;
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(10u)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.data.recorder.Data)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.data.recorder.Data)
  return false;
#undef DO_
}
...
void Data::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:jmc_auto.data.recorder.Data)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.data.recorder.Data)
}

::google::protobuf::uint8* Data::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.data.recorder.Data)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.data.recorder.Data)
  return target;
}

size_t Data::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.data.recorder.Data)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.data.recorder.Data)
  GOOGLE_DCHECK_NE(&from, this);
  const Data* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const Data>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.data.recorder.Data)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.data.recorder.Data)
    MergeFrom(*source);
  }
}

void Data::MergeFrom(const Data& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.data.recorder.Data)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.data.recorder.Data)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.data.recorder.Data)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::jmc_auto::data::recorder::Bag& Data::bags(int index) const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Data.bags)
  return bags_.Get(index);
}
::jmc_auto::data::recorder::Bag* Data::mutable_bags(int index) {
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.Data.bags)
  return bags_.Mutable(index);
}
::jmc_auto::data::recorder::Bag* Data::add_bags() {
  // @@protoc_insertion_point(field_add:jmc_auto.data.recorder.Data.bags)
  return bags_.Add();
}
::google::protobuf::RepeatedPtrField< ::jmc_auto::data::recorder::Bag >*
Data::mutable_bags() {
  // @@protoc_insertion_point(field_mutable_list:jmc_auto.data.recorder.Data.bags)
  return &bags_;
}
const ::google::protobuf::RepeatedPtrField< ::jmc_auto::data::recorder::Bag >&
Data::bags() const {
  // @@protoc_insertion_point(field_list:jmc_auto.data.recorder.Data.bags)
  return bags_;
}
...
Bag::Bag()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.data.recorder.Bag)
}
Bag::Bag(const Bag& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.data.recorder.Bag)
}
...
Bag::~Bag() {
  // @@protoc_insertion_point(destructor:jmc_auto.data.recorder.Bag)
  SharedDtor();
}
...
void Bag::Clear() {
// @@protoc_insertion_point(message_clear_start:jmc_auto.data.recorder.Bag)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:jmc_auto.data.recorder.Bag)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            ::google::protobuf::internal::WireFormat::PARSE,
            "jmc_auto.data.recorder.Bag.writing_filename");
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.data.recorder.Bag)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.data.recorder.Bag)
  return false;
#undef DO_
}
...
void Bag::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:jmc_auto.data.recorder.Bag)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.data.recorder.Bag)
}

::google::protobuf::uint8* Bag::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.data.recorder.Bag)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.data.recorder.Bag)
  return target;
}

size_t Bag::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.data.recorder.Bag)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.data.recorder.Bag)
  GOOGLE_DCHECK_NE(&from, this);
  const Bag* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const Bag>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.data.recorder.Bag)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.data.recorder.Bag)
    MergeFrom(*source);
  }
}

void Bag::MergeFrom(const Bag& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.data.recorder.Bag)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.data.recorder.Bag)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.data.recorder.Bag)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::std::string& Bag::writing_filename() const {
  // @@protoc_insertion_point(field_get:jmc_auto.data.recorder.Bag.writing_filename)
...
void Bag::set_writing_filename(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:jmc_auto.data.recorder.Bag.writing_filename)
}
#if LANG_CXX11
void Bag::set_writing_filename(::std::string&& value) {
  ...
  writing_filename_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:jmc_auto.data.recorder.Bag.writing_filename)
}
#endif
void Bag::set_writing_filename(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:jmc_auto.data.recorder.Bag.writing_filename)
}
void Bag::set_writing_filename(const char* value, size_t size) {
  ...
  writing_filename_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:jmc_auto.data.recorder.Bag.writing_filename)
}
::std::string* Bag::mutable_writing_filename() {
  set_has_writing_filename();
  // @@protoc_insertion_point(field_mutable:jmc_auto.data.recorder.Bag.writing_filename)
...
::std::string* Bag::release_writing_filename() {
  // @@protoc_insertion_point(field_release:jmc_auto.data.recorder.Bag.writing_filename)
  clear_has_writing_filename();
...
void Bag::set_allocated_writing_filename(::std::string* writing_filename) {
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.data.recorder.Bag.writing_filename)
}
