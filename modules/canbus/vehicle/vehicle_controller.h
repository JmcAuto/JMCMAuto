...
class VehicleController {
 public:
  ...
  virtual common::ErrorCode Init(
      ...
      MessageManager<::jmc_auto::canbus::ChassisDetail>
 ...
 private:
  ...
  //CX75
  virtual void SteerTorque(double torque) = 0;
  virtual void PamStopDistance(int distance) = 0;
  virtual void SpeedTarget(float speed) = 0;
 ...
 protected:
  ...
  CanSender<::jmc_auto::canbus::ChassisDetail> *can_sender_ = nullptr;
  MessageManager<::jmc_auto::canbus::ChassisDetail> *message_manager_ = nullptr;
