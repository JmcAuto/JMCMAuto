...
#ifndef MODULES_CANBUS_VEHICLE_CX75_PROTOCOL_INS_STD_507_H_
#define MODULES_CANBUS_VEHICLE_CX75_PROTOCOL_INS_STD_507_H_
...
class Insstd507 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double ins_std_lat(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double ins_std_lon(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double ins_std_locatheight(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double inins_std_heading(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_CX75_PROTOCOL_INS_STD_507_H_
