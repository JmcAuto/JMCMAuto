...
#ifndef MODULES_CANBUS_VEHICLE_TESHUN_PROTOCOL_GW_ABS_0X211_211_H_
#define MODULES_CANBUS_VEHICLE_TESHUN_PROTOCOL_GW_ABS_0X211_211_H_
...
class Gwabs0x211211 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Gw_abs_0x211_211::Abs_whlspdreristatusType abs_whlspdreristatus(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Gw_abs_0x211_211::Abs_whlspdrelestatusType abs_whlspdrelestatus(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Gw_abs_0x211_211::Abs_whlspdfrntristatusType abs_whlspdfrntristatus(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Gw_abs_0x211_211::Abs_whlspdfrntlestatusType abs_whlspdfrntlestatus(const std::uint8_t* bytes, const int32_t length) const;
...
#endif  // MODULES_CANBUS_VEHICL_TESHUN_PROTOCOL_GW_ABS_0X211_211_H_
