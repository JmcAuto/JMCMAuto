...
#ifndef MODULES_CANBUS_VEHICLE_TESHUN_PROTOCOL_GW_ABS_STS_0X221_221_H_
#define MODULES_CANBUS_VEHICLE_TESHUN_PROTOCOL_GW_ABS_STS_0X221_221_H_
...
class Gwabssts0x221221 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  int rolling_counter_0x221(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Gw_abs_sts_0x221_221::Abs_whlmilgfrntlestatusType abs_whlmilgfrntlestatus(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Gw_abs_sts_0x221_221::Abs_whlmilgfrntristatusType abs_whlmilgfrntristatus(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Gw_abs_sts_0x221_221::Abs_vehspdlgtstatusType abs_vehspdlgtstatus(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Gw_abs_sts_0x221_221::Abs_vehspddirectionType abs_vehspddirection(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Gw_abs_sts_0x221_221::Abs_ebdflgfltType abs_ebdflgflt(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Gw_abs_sts_0x221_221::Abs_absflgfltType abs_absflgflt(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Gw_abs_sts_0x221_221::Abs_absctrlactvType abs_absctrlactv(const std::uint8_t* bytes, const int32_t length) const;
...
#endif  // MODULES_CANBUS_VEHICL_TESHUN_PROTOCOL_GW_ABS_STS_0X221_221_H_
