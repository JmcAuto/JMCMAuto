...
class CanbusConf : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.canbus.CanbusConf) */ {
 public:
  CanbusConf();
  virtual ~CanbusConf();
  ...
  const ::jmc_auto::canbus::VehicleParameter& vehicle_parameter() const;
  ::jmc_auto::canbus::VehicleParameter* mutable_vehicle_parameter();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.canbus.CanbusConf)
 private:
...
inline const ::jmc_auto::canbus::VehicleParameter& CanbusConf::vehicle_parameter() const {
...
inline ::jmc_auto::canbus::VehicleParameter* CanbusConf::mutable_vehicle_parameter() {
...
inline ::jmc_auto::canbus::VehicleParameter* CanbusConf::release_vehicle_parameter() {
...
inline void CanbusConf::set_allocated_vehicle_parameter(::jmc_auto::canbus::VehicleParameter* vehicle_parameter) {
