...
class Planner {
 public:
  ...
  virtual jmc_auto::common::Status Init(const PlanningConfig& config) = 0;
   ...
   */
  virtual jmc_auto::common::Status Plan(
...
class PlannerWithReferenceLine : public Planner {
 public:
   ...
   * @return OK if planning succeeds; error otherwise.
   */
  virtual jmc_auto::common::Status PlanOnReferenceLine(
      const common::TrajectoryPoint& planning_init_point, Frame* frame,
