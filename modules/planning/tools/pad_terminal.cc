...
using jmc_auto::cyber::CreateNode;
using jmc_auto::cyber::Node;
using jmc_auto::cyber::Writer;
using jmc_auto::planning::DrivingAction;
...
class PadTerminal {
 public:
  ...
  void send(int action) {
    ...
    jmc_auto::common::util::FillHeader("terminal", &pad);
...
int main(int argc, char **argv) {
  jmc_auto::cyber::Init("planning_pad_terminal");
  ...
  pad_terminal.init();
  pad_terminal.help();
  jmc_auto::cyber::WaitForShutdown();
  pad_terminal.stop();
  return 0;
}
