...
using jmc_auto::common::SLPoint;
using jmc_auto::common::math::CartesianFrenetConverter;
using jmc_auto::common::math::Vec2d;
using jmc_auto::common::util::DistanceXY;
using jmc_auto::hdmap::InterpolatedIndex;
...
std::string ReferenceLine::DebugString() const {
  ...
  return absl::StrCat(
      ...
      absl::StrJoin(reference_points_.begin(),
                    ...
                    jmc_auto::common::util::DebugStringFormatter()));
}
