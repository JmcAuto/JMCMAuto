...
class TrajectoryEvaluator {
 ...
 public:
  TrajectoryEvaluator(
      ...
      std::shared_ptr<std::vector<jmc_auto::common::PathPoint>> reference_line);
 ...
 private:
  ...
  bool InterpolateDenseStPoints(
      const std::vector<jmc_auto::common::SpeedPoint>& st_points, double t,
      double* traj_s) const;
  ...
  std::shared_ptr<std::vector<jmc_auto::common::PathPoint>> reference_line_;
