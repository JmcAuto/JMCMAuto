...
#ifndef PROTOBUF_modules_2fplanning_2fproto_2fqp_5fproblem_2eproto__INCLUDED
#define PROTOBUF_modules_2fplanning_2fproto_2fqp_5fproblem_2eproto__INCLUDED
...
class QuadraticProgrammingProblem : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.planning.QuadraticProgrammingProblem) */ {
 public:
  ...
  const ::jmc_auto::planning::QPMatrix& quadratic_matrix() const;
  ::jmc_auto::planning::QPMatrix* mutable_quadratic_matrix();
  ::jmc_auto::planning::QPMatrix* release_quadratic_matrix();
  void set_allocated_quadratic_matrix(::jmc_auto::planning::QPMatrix* quadratic_matrix);
  ...
  const ::jmc_auto::planning::QPMatrix& equality_matrix() const;
  ::jmc_auto::planning::QPMatrix* mutable_equality_matrix();
  ::jmc_auto::planning::QPMatrix* release_equality_matrix();
  void set_allocated_equality_matrix(::jmc_auto::planning::QPMatrix* equality_matrix);
  ...
  const ::jmc_auto::planning::QPMatrix& inequality_matrix() const;
  ::jmc_auto::planning::QPMatrix* mutable_inequality_matrix();
  ::jmc_auto::planning::QPMatrix* release_inequality_matrix();
  void set_allocated_inequality_matrix(::jmc_auto::planning::QPMatrix* inequality_matrix);
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.planning.QuadraticProgrammingProblem)
 private:
  ...
  ::jmc_auto::planning::QPMatrix* quadratic_matrix_;
  ::jmc_auto::planning::QPMatrix* equality_matrix_;
  ::jmc_auto::planning::QPMatrix* inequality_matrix_;
  ::google::protobuf::int32 param_size_;
  friend struct protobuf_modules_2fplanning_2fproto_2fqp_5fproblem_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class QPMatrix : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.planning.QPMatrix) */ {
 public:
  QPMatrix();
  virtual ~QPMatrix();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.planning.QPMatrix)
 private:
...
class QuadraticProgrammingProblemSet : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.planning.QuadraticProgrammingProblemSet) */ {
 public:
  ...
  const ::jmc_auto::planning::QuadraticProgrammingProblem& problem(int index) const;
  ::jmc_auto::planning::QuadraticProgrammingProblem* mutable_problem(int index);
  ::jmc_auto::planning::QuadraticProgrammingProblem* add_problem();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.planning.QuadraticProgrammingProblemSet)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::jmc_auto::planning::QuadraticProgrammingProblem > problem_;
  friend struct protobuf_modules_2fplanning_2fproto_2fqp_5fproblem_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::jmc_auto::planning::QPMatrix& QuadraticProgrammingProblem::quadratic_matrix() const {
...
inline ::jmc_auto::planning::QPMatrix* QuadraticProgrammingProblem::mutable_quadratic_matrix() {
...
inline ::jmc_auto::planning::QPMatrix* QuadraticProgrammingProblem::release_quadratic_matrix() {
...
inline void QuadraticProgrammingProblem::set_allocated_quadratic_matrix(::jmc_auto::planning::QPMatrix* quadratic_matrix) {
...
inline const ::jmc_auto::planning::QPMatrix& QuadraticProgrammingProblem::equality_matrix() const {
...
inline ::jmc_auto::planning::QPMatrix* QuadraticProgrammingProblem::mutable_equality_matrix() {
...
inline ::jmc_auto::planning::QPMatrix* QuadraticProgrammingProblem::release_equality_matrix() {
...
inline void QuadraticProgrammingProblem::set_allocated_equality_matrix(::jmc_auto::planning::QPMatrix* equality_matrix) {
...
inline const ::jmc_auto::planning::QPMatrix& QuadraticProgrammingProblem::inequality_matrix() const {
...
inline ::jmc_auto::planning::QPMatrix* QuadraticProgrammingProblem::mutable_inequality_matrix() {
...
inline ::jmc_auto::planning::QPMatrix* QuadraticProgrammingProblem::release_inequality_matrix() {
...
inline void QuadraticProgrammingProblem::set_allocated_inequality_matrix(::jmc_auto::planning::QPMatrix* inequality_matrix) {
...
inline const ::jmc_auto::planning::QuadraticProgrammingProblem& QuadraticProgrammingProblemSet::problem(int index) const {
  // @@protoc_insertion_point(field_get:jmc_auto.planning.QuadraticProgrammingProblemSet.problem)
  return problem_.Get(index);
}
inline ::jmc_auto::planning::QuadraticProgrammingProblem* QuadraticProgrammingProblemSet::mutable_problem(int index) {
...
inline ::jmc_auto::planning::QuadraticProgrammingProblem* QuadraticProgrammingProblemSet::add_problem() {
  // @@protoc_insertion_point(field_add:jmc_auto.planning.QuadraticProgrammingProblemSet.problem)
  return problem_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::jmc_auto::planning::QuadraticProgrammingProblem >*
...
inline const ::google::protobuf::RepeatedPtrField< ::jmc_auto::planning::QuadraticProgrammingProblem >&
...
#endif  // PROTOBUF_modules_2fplanning_2fproto_2fqp_5fproblem_2eproto__INCLUDED
