...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SLBoundary, boundary_point_),
  0,
  1,
  2,
  3,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "to\022\021jmc_auto.planning\032$modules/common/pr"
      "oto/pnc_point.proto\"~\n\nSLBoundary\022\017\n\007sta"
      "rt_s\030\001 \001(\001\022\r\n\005end_s\030\002 \001(\001\022\017\n\007start_l\030\003 \001"
      "(\001\022\r\n\005end_l\030\004 \001(\001\0220\n\016boundary_point\030\005 \003("
      "\0132\030.jmc_auto.common.SLPoint"
  };
...
SLBoundary::SLBoundary()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.planning.SLBoundary)
}
SLBoundary::SLBoundary(const SLBoundary& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.planning.SLBoundary)
}
...
SLBoundary::~SLBoundary() {
  // @@protoc_insertion_point(destructor:jmc_auto.planning.SLBoundary)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.planning.SLBoundary)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:jmc_auto.planning.SLBoundary)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // repeated .jmc_auto.common.SLPoint boundary_point = 5;
      case 5: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.planning.SLBoundary)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.planning.SLBoundary)
  return false;
#undef DO_
}
...
void SLBoundary::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:jmc_auto.planning.SLBoundary)
  ...
  // repeated .jmc_auto.common.SLPoint boundary_point = 5;
  for (unsigned int i = 0, n = this->boundary_point_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      5, this->boundary_point(i), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.planning.SLBoundary)
}

::google::protobuf::uint8* SLBoundary::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.planning.SLBoundary)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  for (unsigned int i = 0, n = this->boundary_point_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        5, this->boundary_point(i), deterministic, target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.planning.SLBoundary)
  return target;
}

size_t SLBoundary::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.planning.SLBoundary)
  size_t total_size = 0;
  ...
  // repeated .jmc_auto.common.SLPoint boundary_point = 5;
  {
    unsigned int count = this->boundary_point_size();
    total_size += 1UL * count;
    for (unsigned int i = 0; i < count; i++) {
      total_size +=
        ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
          this->boundary_point(i));
    }
  }
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.planning.SLBoundary)
  GOOGLE_DCHECK_NE(&from, this);
  const SLBoundary* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const SLBoundary>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.planning.SLBoundary)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.planning.SLBoundary)
    MergeFrom(*source);
  }
}

void SLBoundary::MergeFrom(const SLBoundary& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.planning.SLBoundary)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.planning.SLBoundary)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.planning.SLBoundary)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
double SLBoundary::start_s() const {
  // @@protoc_insertion_point(field_get:jmc_auto.planning.SLBoundary.start_s)
  return start_s_;
}
void SLBoundary::set_start_s(double value) {
  set_has_start_s();
  start_s_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.planning.SLBoundary.start_s)
}
...
double SLBoundary::end_s() const {
  // @@protoc_insertion_point(field_get:jmc_auto.planning.SLBoundary.end_s)
  return end_s_;
}
void SLBoundary::set_end_s(double value) {
  set_has_end_s();
  end_s_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.planning.SLBoundary.end_s)
}
...
double SLBoundary::start_l() const {
  // @@protoc_insertion_point(field_get:jmc_auto.planning.SLBoundary.start_l)
  return start_l_;
}
void SLBoundary::set_start_l(double value) {
  set_has_start_l();
  start_l_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.planning.SLBoundary.start_l)
}
...
double SLBoundary::end_l() const {
  // @@protoc_insertion_point(field_get:jmc_auto.planning.SLBoundary.end_l)
  return end_l_;
}
void SLBoundary::set_end_l(double value) {
  set_has_end_l();
  end_l_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.planning.SLBoundary.end_l)
}

// repeated .jmc_auto.common.SLPoint boundary_point = 5;
int SLBoundary::boundary_point_size() const {
  return boundary_point_.size();
}
void SLBoundary::clear_boundary_point() {
  boundary_point_.Clear();
}
const ::jmc_auto::common::SLPoint& SLBoundary::boundary_point(int index) const {
  // @@protoc_insertion_point(field_get:jmc_auto.planning.SLBoundary.boundary_point)
  return boundary_point_.Get(index);
}
::jmc_auto::common::SLPoint* SLBoundary::mutable_boundary_point(int index) {
  // @@protoc_insertion_point(field_mutable:jmc_auto.planning.SLBoundary.boundary_point)
  return boundary_point_.Mutable(index);
}
::jmc_auto::common::SLPoint* SLBoundary::add_boundary_point() {
  // @@protoc_insertion_point(field_add:jmc_auto.planning.SLBoundary.boundary_point)
  return boundary_point_.Add();
}
::google::protobuf::RepeatedPtrField< ::jmc_auto::common::SLPoint >*
SLBoundary::mutable_boundary_point() {
  // @@protoc_insertion_point(field_mutable_list:jmc_auto.planning.SLBoundary.boundary_point)
  return &boundary_point_;
}
const ::google::protobuf::RepeatedPtrField< ::jmc_auto::common::SLPoint >&
SLBoundary::boundary_point() const {
  // @@protoc_insertion_point(field_list:jmc_auto.planning.SLBoundary.boundary_point)
  return boundary_point_;
}
