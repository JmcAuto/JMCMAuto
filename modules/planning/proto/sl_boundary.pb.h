...
class SLBoundary : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.planning.SLBoundary) */ {
 public:
  SLBoundary();
  virtual ~SLBoundary();
  ...
  const ::jmc_auto::common::SLPoint& boundary_point(int index) const;
  ::jmc_auto::common::SLPoint* mutable_boundary_point(int index);
  ::jmc_auto::common::SLPoint* add_boundary_point();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.planning.SLBoundary)
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::jmc_auto::common::SLPoint > boundary_point_;
  double start_s_;
  double end_s_;
  double start_l_;
  double end_l_;
