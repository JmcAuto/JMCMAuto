...
class NaviObstacleDecider : public NaviTask {
 ...
 private:
   ...
   */
  const jmc_auto::common::VehicleParam &VehicleParam();
...
inline const jmc_auto::common::VehicleParam &NaviObstacleDecider::VehicleParam() {
  const auto &vehicle_param = jmc_auto::common::VehicleConfigHelper::instance()
                                  ->GetConfig()
                                  .vehicle_param();
