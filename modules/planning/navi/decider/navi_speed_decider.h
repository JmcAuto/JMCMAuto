...
class NaviSpeedDecider : public NaviTask {
 ...
 private:
   ...
   */
  jmc_auto::common::Status MakeSpeedDecision(
   ...
   */
  jmc_auto::common::Status AddPerceptionRangeConstraints();
   ...
   * @return Status::OK() if success; error otherwise.
   */
  jmc_auto::common::Status AddObstaclesConstraints(
   ...
   * @return Status::OK() if success; error otherwise.
   */
  jmc_auto::common::Status AddTrafficDecisionConstraints();
   ...
   * @return Status::OK() if success; error otherwise.
   */
  jmc_auto::common::Status AddCentricAccelerationConstraints(
      const std::vector<common::PathPoint>& path_points);
   ...
   * @return Status::OK() if success; error otherwise.
   */
  jmc_auto::common::Status AddConfiguredConstraints();
