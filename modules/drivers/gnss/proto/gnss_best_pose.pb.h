...
#ifndef PROTOBUF_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto__INCLUDED
#define PROTOBUF_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto__INCLUDED
...
class GnssBestPose : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.gnss.GnssBestPose) */ {
 public:
  GnssBestPose();
  ...
  inline GnssBestPose* New() const PROTOBUF_FINAL { return New(NULL); }

  GnssBestPose* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  ::jmc_auto::drivers::gnss::SolutionStatus sol_status() const;
  void set_sol_status(::jmc_auto::drivers::gnss::SolutionStatus value);

  // optional .jmc_auto.drivers.gnss.SolutionType sol_type = 4;
  bool has_sol_type() const;
  void clear_sol_type();
  static const int kSolTypeFieldNumber = 4;
  ::jmc_auto::drivers::gnss::SolutionType sol_type() const;
  void set_sol_type(::jmc_auto::drivers::gnss::SolutionType value);
  ...
  ::jmc_auto::drivers::gnss::DatumId datum_id() const;
  void set_datum_id(::jmc_auto::drivers::gnss::DatumId value);

  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.gnss.GnssBestPose)
 private:
  void set_has_header();
  ...
  int datum_id_;
  friend struct protobuf_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::jmc_auto::common::Header& GnssBestPose::header() const {
...
inline ::jmc_auto::common::Header* GnssBestPose::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
...
inline ::jmc_auto::common::Header* GnssBestPose::release_header() {
...
inline void GnssBestPose::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline ::jmc_auto::drivers::gnss::SolutionStatus GnssBestPose::sol_status() const {
...
inline void GnssBestPose::set_sol_status(::jmc_auto::drivers::gnss::SolutionStatus value) {
...
inline ::jmc_auto::drivers::gnss::SolutionType GnssBestPose::sol_type() const {
...
inline void GnssBestPose::set_sol_type(::jmc_auto::drivers::gnss::SolutionType value) {
...
inline ::jmc_auto::drivers::gnss::DatumId GnssBestPose::datum_id() const {
...
inline void GnssBestPose::set_datum_id(::jmc_auto::drivers::gnss::DatumId value) {
...
template <> struct is_proto_enum< ::jmc_auto::drivers::gnss::SolutionStatus> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::drivers::gnss::SolutionStatus>() {
  return ::jmc_auto::drivers::gnss::SolutionStatus_descriptor();
}
template <> struct is_proto_enum< ::jmc_auto::drivers::gnss::SolutionType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::drivers::gnss::SolutionType>() {
  return ::jmc_auto::drivers::gnss::SolutionType_descriptor();
}
template <> struct is_proto_enum< ::jmc_auto::drivers::gnss::DatumId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::drivers::gnss::DatumId>() {
  return ::jmc_auto::drivers::gnss::DatumId_descriptor();
}
...
#endif  // PROTOBUF_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto__INCLUDED
