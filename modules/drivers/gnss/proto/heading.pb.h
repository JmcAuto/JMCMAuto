...
#ifndef PROTOBUF_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto__INCLUDED
#define PROTOBUF_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto__INCLUDED
...
class Heading : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.gnss.Heading) */ {
 public:
  Heading();
  virtual ~Heading();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.gnss.Heading)
 private:
  void set_has_header();
...
inline const ::jmc_auto::common::Header& Heading::header() const {
...
inline ::jmc_auto::common::Header* Heading::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
...
inline ::jmc_auto::common::Header* Heading::release_header() {
...
inline void Heading::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
#endif  // PROTOBUF_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto__INCLUDED
