...
#ifndef PROTOBUF_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto__INCLUDED
#define PROTOBUF_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto__INCLUDED
...
class StreamStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.gnss_status.StreamStatus) */ {
 public:
  StreamStatus();
  ...
  ::jmc_auto::drivers::gnss_status::StreamStatus_Type ins_stream_type() const;
  void set_ins_stream_type(::jmc_auto::drivers::gnss_status::StreamStatus_Type value);
  ...
  ::jmc_auto::drivers::gnss_status::StreamStatus_Type rtk_stream_in_type() const;
  void set_rtk_stream_in_type(::jmc_auto::drivers::gnss_status::StreamStatus_Type value);
  ...
  ::jmc_auto::drivers::gnss_status::StreamStatus_Type rtk_stream_out_type() const;
  void set_rtk_stream_out_type(::jmc_auto::drivers::gnss_status::StreamStatus_Type value);

  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.gnss_status.StreamStatus)
 private:
  void set_has_header();
  ...
  friend struct protobuf_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class InsStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.gnss_status.InsStatus) */ {
 public:
  InsStatus();
  virtual ~InsStatus();
  ...
  ::jmc_auto::drivers::gnss_status::InsStatus_Type type() const;
  void set_type(::jmc_auto::drivers::gnss_status::InsStatus_Type value);

  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.gnss_status.InsStatus)
 private:
  void set_has_header();
  void clear_has_header();
  void set_has_type();
...
class GnssStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.gnss_status.GnssStatus) */ {
 public:
  GnssStatus();
  virtual ~GnssStatus();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.gnss_status.GnssStatus)
 private:
  void set_has_header();
  void clear_has_header();
...
inline const ::jmc_auto::common::Header& StreamStatus::header() const {
...
inline ::jmc_auto::common::Header* StreamStatus::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
...
inline ::jmc_auto::common::Header* StreamStatus::release_header() {
...
inline void StreamStatus::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline ::jmc_auto::drivers::gnss_status::StreamStatus_Type StreamStatus::ins_stream_type() const {
...
inline void StreamStatus::set_ins_stream_type(::jmc_auto::drivers::gnss_status::StreamStatus_Type value) {
...
inline ::jmc_auto::drivers::gnss_status::StreamStatus_Type StreamStatus::rtk_stream_in_type() const {
...
inline void StreamStatus::set_rtk_stream_in_type(::jmc_auto::drivers::gnss_status::StreamStatus_Type value) {
  assert(::jmc_auto::drivers::gnss_status::StreamStatus_Type_IsValid(value));
...
inline ::jmc_auto::drivers::gnss_status::StreamStatus_Type StreamStatus::rtk_stream_out_type() const {
...
inline void StreamStatus::set_rtk_stream_out_type(::jmc_auto::drivers::gnss_status::StreamStatus_Type value) {
  assert(::jmc_auto::drivers::gnss_status::StreamStatus_Type_IsValid(value));
...
inline const ::jmc_auto::common::Header& InsStatus::header() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.gnss_status.InsStatus.header)
  return header_ != NULL ? *header_
                         : *::jmc_auto::common::Header::internal_default_instance();
}
inline ::jmc_auto::common::Header* InsStatus::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
    header_ = new ::jmc_auto::common::Header;
  }
...
inline ::jmc_auto::common::Header* InsStatus::release_header() {
...
inline void InsStatus::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline ::jmc_auto::drivers::gnss_status::InsStatus_Type InsStatus::type() const {
...
inline void InsStatus::set_type(::jmc_auto::drivers::gnss_status::InsStatus_Type value) {
...
inline const ::jmc_auto::common::Header& GnssStatus::header() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.gnss_status.GnssStatus.header)
  return header_ != NULL ? *header_
                         : *::jmc_auto::common::Header::internal_default_instance();
}
inline ::jmc_auto::common::Header* GnssStatus::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
    header_ = new ::jmc_auto::common::Header;
  }
...
inline ::jmc_auto::common::Header* GnssStatus::release_header() {
...
inline void GnssStatus::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
template <> struct is_proto_enum< ::jmc_auto::drivers::gnss_status::StreamStatus_Type> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::drivers::gnss_status::StreamStatus_Type>() {
  return ::jmc_auto::drivers::gnss_status::StreamStatus_Type_descriptor();
}
template <> struct is_proto_enum< ::jmc_auto::drivers::gnss_status::InsStatus_Type> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::drivers::gnss_status::InsStatus_Type>() {
  return ::jmc_auto::drivers::gnss_status::InsStatus_Type_descriptor();
}
...
#endif  // PROTOBUF_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto__INCLUDED
