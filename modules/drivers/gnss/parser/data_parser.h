...
using ::jmc_auto::drivers::gnss_status::GnssStatus;
using ::jmc_auto::drivers::gnss_status::InsStatus;
...
class DataParser {
 ...
 private:
  ...
  void GpsToTransformStamped(const ::jmc_auto::localization::Gps &gps,
