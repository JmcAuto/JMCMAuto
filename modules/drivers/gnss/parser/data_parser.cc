...
using ::jmc_auto::drivers::gnss::EpochObservation;
using ::jmc_auto::drivers::gnss::GnssBestPose;
using ::jmc_auto::drivers::gnss::GnssEphemeris;
using ::jmc_auto::drivers::gnss::Heading;
using ::jmc_auto::drivers::gnss::Imu;
using ::jmc_auto::drivers::gnss::Ins;
using ::jmc_auto::drivers::gnss::InsStat;
using ::jmc_auto::localization::CorrectedImu;
...
void DataParser::CheckInsStatus(::jmc_auto::drivers::gnss::Ins *ins) {
  if (ins_status_record_ != static_cast<uint32_t>(ins->type())) {
    ins_status_record_ = static_cast<uint32_t>(ins->type());
    switch (ins->type()) {
      case jmc_auto::drivers::gnss::Ins::GOOD:
        ins_status_.set_type(jmc_auto::drivers::gnss_status::InsStatus::GOOD);
        break;

      case jmc_auto::drivers::gnss::Ins::CONVERGING:
        ins_status_.set_type(
            jmc_auto::drivers::gnss_status::InsStatus::CONVERGING);
        break;

      case jmc_auto::drivers::gnss::Ins::INVALID:
      default:
        ins_status_.set_type(jmc_auto::drivers::gnss_status::InsStatus::INVALID);
        break;
    }
    AdapterManager::FillInsStatusHeader(FLAGS_sensor_node_name, &ins_status_);
    AdapterManager::PublishInsStatus(ins_status_);
...
void DataParser::CheckGnssStatus(::jmc_auto::drivers::gnss::Gnss *gnss) {
...
void DataParser::DispatchMessage(Parser::MessageType type, MessagePtr message) {
  ...
  switch (type) {
    case Parser::MessageType::GNSS:
      CheckGnssStatus(As<::jmc_auto::drivers::gnss::Gnss>(message));
      break;
    ...
    case Parser::MessageType::INS:
      CheckInsStatus(As<::jmc_auto::drivers::gnss::Ins>(message));
...
void DataParser::GpsToTransformStamped(
    const ::jmc_auto::localization::Gps &gps,
    geometry_msgs::TransformStamped *transform) {
  ros::Time time;
