...
class Rtcm3Parser : public Parser {
 ...
 private:
  ...
  void FillGlonassOrbit(const geph_t &eph,
                          jmc_auto::drivers::gnss::GlonassOrbit *keppler_orbit);
  ...
  jmc_auto::drivers::gnss::GnssEphemeris ephemeris_;
  jmc_auto::drivers::gnss::EpochObservation observation_;
...
void Rtcm3Parser::FillKepplerOrbit(
    const eph_t &eph, jmc_auto::drivers::gnss::KepplerOrbit *keppler_orbit) {
...
void Rtcm3Parser::FillGlonassOrbit(
    const geph_t &eph, jmc_auto::drivers::gnss::GlonassOrbit *orbit) {
  ...
  orbit->set_gnss_time_type(jmc_auto::drivers::gnss::GnssTimeType::GPS_TIME);
...
void Rtcm3Parser::SetObservationTime() {
  ...
  observation_.set_gnss_time_type(jmc_auto::drivers::gnss::GPS_TIME);
...
bool Rtcm3Parser::ProcessEphemerides() {
  ...
  if (gnss_type == jmc_auto::drivers::gnss::GnssType::GLO_SYS) {
