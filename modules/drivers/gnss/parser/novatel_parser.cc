...
class NovatelParser : public Parser {
 ...
 private:
  ...
  ::jmc_auto::drivers::gnss::Gnss gnss_;
  ::jmc_auto::drivers::gnss::GnssBestPose bestpos_;
  ::jmc_auto::drivers::gnss::Imu imu_;
  ::jmc_auto::drivers::gnss::Ins ins_;
  ::jmc_auto::drivers::gnss::InsStat ins_stat_;
  ::jmc_auto::drivers::gnss::GnssEphemeris gnss_ephemeris_;
  ::jmc_auto::drivers::gnss::EpochObservation gnss_observation_;
  ::jmc_auto::drivers::gnss::Heading heading_;
};
...
bool NovatelParser::HandleGnssBestpos(const novatel::BestPos* pos,
  ...
  bestpos_.set_sol_status(
      static_cast<jmc_auto::drivers::gnss::SolutionStatus>(pos->solution_status));
  bestpos_.set_sol_type(
      static_cast<jmc_auto::drivers::gnss::SolutionType>(pos->position_type));
  ...
  bestpos_.set_datum_id(
      static_cast<jmc_auto::drivers::gnss::DatumId>(pos->datum_id));
  ...
  if (pos->solution_status == novatel::SolutionStatus::SOL_COMPUTED) {
    ...
    switch (pos->position_type) {
      ...
      case novatel::SolutionType::INS_PSRSP:
        gnss_.set_type(jmc_auto::drivers::gnss::Gnss::SINGLE);
        break;
      case novatel::SolutionType::PSRDIFF:
      case novatel::SolutionType::WAAS:
      case novatel::SolutionType::INS_SBAS:
        gnss_.set_type(jmc_auto::drivers::gnss::Gnss::PSRDIFF);
        break;
      ...
      case novatel::SolutionType::INS_RTKFLOAT:
        gnss_.set_type(jmc_auto::drivers::gnss::Gnss::RTK_FLOAT);
        break;
      ...
      case novatel::SolutionType::INS_RTKFIXED:
        gnss_.set_type(jmc_auto::drivers::gnss::Gnss::RTK_INTEGER);
        break;
      ...
      case novatel::SolutionType::INS_PPP:
        gnss_.set_type(jmc_auto::drivers::gnss::Gnss::PPP);
        break;
      case novatel::SolutionType::PROPOGATED:
        gnss_.set_type(jmc_auto::drivers::gnss::Gnss::PROPAGATED);
        break;
      default:
        gnss_.set_type(jmc_auto::drivers::gnss::Gnss::INVALID);
    }
  } else {
    gnss_.set_type(jmc_auto::drivers::gnss::Gnss::INVALID);
...
bool NovatelParser::HandleInsPva(const novatel::InsPva* pva) {
  ...
  switch (pva->status) {
    ...
    case novatel::InsStatus::SOLUTION_GOOD:
      ins_.set_type(jmc_auto::drivers::gnss::Ins::GOOD);
      break;
    case novatel::InsStatus::ALIGNING:
    case novatel::InsStatus::HIGH_VARIANCE:
    case novatel::InsStatus::SOLUTION_FREE:
      ins_.set_type(jmc_auto::drivers::gnss::Ins::CONVERGING);
      break;
    default:
      ins_.set_type(jmc_auto::drivers::gnss::Ins::INVALID);
  }
...
bool NovatelParser::HandleGpsEph(const novatel::GPS_Ephemeris* gps_emph) {
  gnss_ephemeris_.set_gnss_type(jmc_auto::drivers::gnss::GnssType::GPS_SYS);

  jmc_auto::drivers::gnss::KepplerOrbit* keppler_orbit =
      gnss_ephemeris_.mutable_keppler_orbit();

  keppler_orbit->set_gnss_type(jmc_auto::drivers::gnss::GnssType::GPS_SYS);
  keppler_orbit->set_gnss_time_type(
      jmc_auto::drivers::gnss::GnssTimeType::GPS_TIME);
...
bool NovatelParser::HandleBdsEph(const novatel::BDS_Ephemeris* bds_emph) {
  gnss_ephemeris_.set_gnss_type(jmc_auto::drivers::gnss::GnssType::BDS_SYS);

  jmc_auto::drivers::gnss::KepplerOrbit* keppler_orbit =
      gnss_ephemeris_.mutable_keppler_orbit();

  keppler_orbit->set_gnss_type(jmc_auto::drivers::gnss::GnssType::BDS_SYS);
  keppler_orbit->set_gnss_time_type(
      jmc_auto::drivers::gnss::GnssTimeType::BDS_TIME);
...
bool NovatelParser::HandleGloEph(const novatel::GLO_Ephemeris* glo_emph) {
  gnss_ephemeris_.set_gnss_type(jmc_auto::drivers::gnss::GnssType::GLO_SYS);

  jmc_auto::drivers::gnss::GlonassOrbit* glonass_orbit =
      gnss_ephemeris_.mutable_glonass_orbit();
  glonass_orbit->set_gnss_type(jmc_auto::drivers::gnss::GnssType::GLO_SYS);
  glonass_orbit->set_gnss_time_type(
      jmc_auto::drivers::gnss::GnssTimeType::GLO_TIME);
...
void NovatelParser::SetObservationTime() {
  ...
  gnss_observation_.set_gnss_time_type(jmc_auto::drivers::gnss::GPS_TIME);
          ...
          for (j = 0; j < NFREQ + NEXOBS; ++j) {
            ...
            if (raw_.obs.data[i].code[i] == CODE_L1C) {
              band_obs->set_pseudo_type(
                  jmc_auto::drivers::gnss::PseudoType::CORSE_CODE);
            } else if (raw_.obs.data[i].code[i] == CODE_L1P) {
              band_obs->set_pseudo_type(
                  jmc_auto::drivers::gnss::PseudoType::PRECISION_CODE);
            } else {
