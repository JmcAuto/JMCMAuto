...
void switch_stream_status(const jmc_auto::drivers::gnss::Stream::Status &status,
                          StreamStatus_Type *report_status_type) {
  switch (status) {
    case jmc_auto::drivers::gnss::Stream::Status::CONNECTED:
      *report_status_type = StreamStatus::CONNECTED;
      break;

    case jmc_auto::drivers::gnss::Stream::Status::DISCONNECTED:
      *report_status_type = StreamStatus::DISCONNECTED;
      break;

    case jmc_auto::drivers::gnss::Stream::Status::ERROR:
    default:
      *report_status_type = StreamStatus::DISCONNECTED;
      break;
  }
...
std::string getLocalTimeFileStr() {
  ...
  CHECK(jmc_auto::common::util::EnsureDirectory(FLAGS_gpsbin_folder))
