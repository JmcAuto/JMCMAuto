...
int main(int32_t argc, char **argv) {
  ...
  using jmc_auto::drivers::canbus::CANCardParameter;
  using jmc_auto::drivers::canbus::CanClient;
  using jmc_auto::drivers::canbus::CanClientFactory;
  using jmc_auto::drivers::canbus::TestCanParam;
  using jmc_auto::drivers::canbus::CanAgent;
  ...
  if (!jmc_auto::common::util::GetProtoFromFile(FLAGS_can_client_conf_file_a,
                                              &can_client_conf_a)) {
  ...
  if (!FLAGS_only_one_send) {
    if (!jmc_auto::common::util::GetProtoFromFile(FLAGS_can_client_conf_file_b,
                                                &can_client_conf_b)) {
      AERROR << "Unable to load canbus conf file: "
