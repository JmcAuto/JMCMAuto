...
class CanClient {
 public:
   ...
   *         jmc_auto::common::ErrorCode.
   */
  virtual jmc_auto::common::ErrorCode Send(const std::vector<CanFrame> &frames,
   ...
   *         jmc_auto::common::ErrorCode.
   */
  virtual jmc_auto::common::ErrorCode SendSingleFrame(
   ...
   *         jmc_auto::common::ErrorCode.
   */
  virtual jmc_auto::common::ErrorCode Receive(std::vector<CanFrame> *const frames,
                                            int32_t *const frame_num) = 0;
