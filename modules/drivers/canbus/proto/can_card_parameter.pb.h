...
class CANCardParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.canbus.CANCardParameter) */ {
 public:
  ...
  ::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId channel_id() const;
  void set_channel_id(::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId value);
...
inline ::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId CANCardParameter::channel_id() const {
...
inline void CANCardParameter::set_channel_id(::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId value) {
...
template <> struct is_proto_enum< ::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId>() {
  return ::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId_descriptor();
}
