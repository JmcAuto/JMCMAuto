...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/drivers/canbus/proto/sensor_canbus_conf.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
SensorCanbusConf::SensorCanbusConf()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fdrivers_2fcanbus_2fproto_2fsensor_5fcanbus_5fconf_2eproto::InitDefaults();
  }
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.drivers.canbus.SensorCanbusConf)
}
SensorCanbusConf::SensorCanbusConf(const SensorCanbusConf& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.drivers.canbus.SensorCanbusConf)
}
...
SensorCanbusConf::~SensorCanbusConf() {
  // @@protoc_insertion_point(destructor:jmc_auto.drivers.canbus.SensorCanbusConf)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:jmc_auto.drivers.canbus.SensorCanbusConf)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.drivers.canbus.SensorCanbusConf)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.drivers.canbus.SensorCanbusConf)
  return false;
#undef DO_
}
...
void SensorCanbusConf::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:jmc_auto.drivers.canbus.SensorCanbusConf)
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.drivers.canbus.SensorCanbusConf)
}

::google::protobuf::uint8* SensorCanbusConf::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.drivers.canbus.SensorCanbusConf)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.drivers.canbus.SensorCanbusConf)
  return target;
}

size_t SensorCanbusConf::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.drivers.canbus.SensorCanbusConf)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.drivers.canbus.SensorCanbusConf)
  GOOGLE_DCHECK_NE(&from, this);
  const SensorCanbusConf* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const SensorCanbusConf>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.drivers.canbus.SensorCanbusConf)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.drivers.canbus.SensorCanbusConf)
    MergeFrom(*source);
  }
}

void SensorCanbusConf::MergeFrom(const SensorCanbusConf& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.drivers.canbus.SensorCanbusConf)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.drivers.canbus.SensorCanbusConf)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.drivers.canbus.SensorCanbusConf)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
bool SensorCanbusConf::enable_debug_mode() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.canbus.SensorCanbusConf.enable_debug_mode)
...
bool SensorCanbusConf::enable_receiver_log() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.canbus.SensorCanbusConf.enable_receiver_log)
  return enable_receiver_log_;
}
void SensorCanbusConf::set_enable_receiver_log(bool value) {
  set_has_enable_receiver_log();
  enable_receiver_log_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.canbus.SensorCanbusConf.enable_receiver_log)
}
