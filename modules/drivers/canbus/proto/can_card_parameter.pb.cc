...
const CANCardParameter_CANCardBrand CANCardParameter::MDC_CAN;
...
::google::protobuf::uint32 CANCardParameter::channel_id() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.canbus.CANCardParameter.channel_id)
  return channel_id_;
}
void CANCardParameter::set_channel_id(::google::protobuf::uint32 value) {
  set_has_channel_id();
  channel_id_ = value;
