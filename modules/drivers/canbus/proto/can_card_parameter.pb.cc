...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/drivers/canbus/proto/can_card_parameter.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "parameter.proto\022\027jmc_auto.drivers.canbus"
      "\"\307\003\n\020CANCardParameter\022E\n\005brand\030\001 \001(\01626.j"
      "mc_auto.drivers.canbus.CANCardParameter."
      "CANCardBrand\022C\n\004type\030\002 \001(\01625.jmc_auto.dr"
      "ivers.canbus.CANCardParameter.CANCardTyp"
      "e\022J\n\nchannel_id\030\003 \001(\01626.jmc_auto.drivers"
      ".canbus.CANCardParameter.CANChannelId\"M\n"
      ...
      "CHANNEL_ID_ONE\020\001\022\022\n\016CHANNEL_ID_TWO\020\002\022\024\n\020"
      "CHANNEL_ID_THREE\020\003"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 538);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "modules/drivers/canbus/proto/can_card_parameter.proto", &protobuf_RegisterTypes);
...
const ::google::protobuf::EnumDescriptor* CANCardParameter_CANCardBrand_descriptor() {
  protobuf_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto::file_level_enum_descriptors[0];
}
...
const ::google::protobuf::EnumDescriptor* CANCardParameter_CANCardType_descriptor() {
  protobuf_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto::file_level_enum_descriptors[1];
}
...
const ::google::protobuf::EnumDescriptor* CANCardParameter_CANChannelId_descriptor() {
  protobuf_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto::file_level_enum_descriptors[2];
}
...
CANCardParameter::CANCardParameter()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto::InitDefaults();
  }
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.drivers.canbus.CANCardParameter)
}
CANCardParameter::CANCardParameter(const CANCardParameter& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.drivers.canbus.CANCardParameter)
}
...
CANCardParameter::~CANCardParameter() {
  // @@protoc_insertion_point(destructor:jmc_auto.drivers.canbus.CANCardParameter)
  SharedDtor();
}
...
const ::google::protobuf::Descriptor* CANCardParameter::descriptor() {
  protobuf_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.drivers.canbus.CANCardParameter)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:jmc_auto.drivers.canbus.CANCardParameter)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::jmc_auto::drivers::canbus::CANCardParameter_CANCardBrand_IsValid(value)) {
            set_brand(static_cast< ::jmc_auto::drivers::canbus::CANCardParameter_CANCardBrand >(value));
          } else {
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::jmc_auto::drivers::canbus::CANCardParameter_CANCardType_IsValid(value)) {
            set_type(static_cast< ::jmc_auto::drivers::canbus::CANCardParameter_CANCardType >(value));
          } else {
      ...
      // optional .jmc_auto.drivers.canbus.CANCardParameter.CANChannelId channel_id = 3;
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId_IsValid(value)) {
            set_channel_id(static_cast< ::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.drivers.canbus.CANCardParameter)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.drivers.canbus.CANCardParameter)
  return false;
#undef DO_
}
...
void CANCardParameter::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:jmc_auto.drivers.canbus.CANCardParameter)
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.drivers.canbus.CANCardParameter)
}

::google::protobuf::uint8* CANCardParameter::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.drivers.canbus.CANCardParameter)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.drivers.canbus.CANCardParameter)
  return target;
}

size_t CANCardParameter::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.drivers.canbus.CANCardParameter)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.drivers.canbus.CANCardParameter)
  GOOGLE_DCHECK_NE(&from, this);
  const CANCardParameter* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const CANCardParameter>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.drivers.canbus.CANCardParameter)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.drivers.canbus.CANCardParameter)
    MergeFrom(*source);
  }
}

void CANCardParameter::MergeFrom(const CANCardParameter& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.drivers.canbus.CANCardParameter)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.drivers.canbus.CANCardParameter)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.drivers.canbus.CANCardParameter)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata CANCardParameter::GetMetadata() const {
  protobuf_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
::jmc_auto::drivers::canbus::CANCardParameter_CANCardBrand CANCardParameter::brand() const {
...
void CANCardParameter::set_brand(::jmc_auto::drivers::canbus::CANCardParameter_CANCardBrand value) {
...
::jmc_auto::drivers::canbus::CANCardParameter_CANCardType CANCardParameter::type() const {
...
void CANCardParameter::set_type(::jmc_auto::drivers::canbus::CANCardParameter_CANCardType value) {
...
::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId CANCardParameter::channel_id() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.canbus.CANCardParameter.channel_id)
  return static_cast< ::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId >(channel_id_);
}
void CANCardParameter::set_channel_id(::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId value) {
  assert(::jmc_auto::drivers::canbus::CANCardParameter_CANChannelId_IsValid(value));
  set_has_channel_id();
  channel_id_ = value;
