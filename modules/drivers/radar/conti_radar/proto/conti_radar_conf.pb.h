...
#ifndef PROTOBUF_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto__INCLUDED
#define PROTOBUF_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto__INCLUDED
...
class CanConf : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.conti_radar.CanConf) */ {
 public:
  CanConf();
  virtual ~CanConf();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.conti_radar.CanConf)
 private:
  ...
  friend struct protobuf_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class RadarConf : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.conti_radar.RadarConf) */ {
 public:
  RadarConf();
  virtual ~RadarConf();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.conti_radar.RadarConf)
 private:
...
class ContiRadarConf : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.conti_radar.ContiRadarConf) */ {
 public:
  ContiRadarConf();
  ...
  const ::jmc_auto::drivers::conti_radar::CanConf& can_conf() const;
  ::jmc_auto::drivers::conti_radar::CanConf* mutable_can_conf();
  ::jmc_auto::drivers::conti_radar::CanConf* release_can_conf();
  void set_allocated_can_conf(::jmc_auto::drivers::conti_radar::CanConf* can_conf);
  ...
  const ::jmc_auto::drivers::conti_radar::RadarConf& radar_conf() const;
  ::jmc_auto::drivers::conti_radar::RadarConf* mutable_radar_conf();
  ::jmc_auto::drivers::conti_radar::RadarConf* release_radar_conf();
  void set_allocated_radar_conf(::jmc_auto::drivers::conti_radar::RadarConf* radar_conf);

  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.conti_radar.ContiRadarConf)
 private:
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::jmc_auto::drivers::conti_radar::CanConf* can_conf_;
  ::jmc_auto::drivers::conti_radar::RadarConf* radar_conf_;
  friend struct protobuf_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::jmc_auto::drivers::canbus::CANCardParameter& CanConf::can_card_parameter() const {
...
inline ::jmc_auto::drivers::canbus::CANCardParameter* CanConf::mutable_can_card_parameter() {
...
inline ::jmc_auto::drivers::canbus::CANCardParameter* CanConf::release_can_card_parameter() {
...
inline void CanConf::set_allocated_can_card_parameter(::jmc_auto::drivers::canbus::CANCardParameter* can_card_parameter) {
...
inline ::jmc_auto::drivers::conti_radar::OutputType RadarConf::output_type() const {
...
inline void RadarConf::set_output_type(::jmc_auto::drivers::conti_radar::OutputType value) {
...
inline ::jmc_auto::drivers::conti_radar::RcsThreshold RadarConf::rcs_threshold() const {
...
inline void RadarConf::set_rcs_threshold(::jmc_auto::drivers::conti_radar::RcsThreshold value) {
...
inline const ::jmc_auto::drivers::conti_radar::CanConf& ContiRadarConf::can_conf() const {
...
inline ::jmc_auto::drivers::conti_radar::CanConf* ContiRadarConf::mutable_can_conf() {
  set_has_can_conf();
  if (can_conf_ == NULL) {
...
inline ::jmc_auto::drivers::conti_radar::CanConf* ContiRadarConf::release_can_conf() {
...
inline void ContiRadarConf::set_allocated_can_conf(::jmc_auto::drivers::conti_radar::CanConf* can_conf) {
  delete can_conf_;
  can_conf_ = can_conf;
  if (can_conf) {
    set_has_can_conf();
...
inline const ::jmc_auto::drivers::conti_radar::RadarConf& ContiRadarConf::radar_conf() const {
...
inline ::jmc_auto::drivers::conti_radar::RadarConf* ContiRadarConf::mutable_radar_conf() {
  set_has_radar_conf();
  if (radar_conf_ == NULL) {
...
inline ::jmc_auto::drivers::conti_radar::RadarConf* ContiRadarConf::release_radar_conf() {
...
inline void ContiRadarConf::set_allocated_radar_conf(::jmc_auto::drivers::conti_radar::RadarConf* radar_conf) {
  delete radar_conf_;
...
template <> struct is_proto_enum< ::jmc_auto::drivers::conti_radar::OutputType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::drivers::conti_radar::OutputType>() {
  return ::jmc_auto::drivers::conti_radar::OutputType_descriptor();
}
template <> struct is_proto_enum< ::jmc_auto::drivers::conti_radar::RcsThreshold> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::drivers::conti_radar::RcsThreshold>() {
  return ::jmc_auto::drivers::conti_radar::RcsThreshold_descriptor();
}
...
#endif  // PROTOBUF_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto__INCLUDED
