...
#ifndef PROTOBUF_modules_2fdrivers_2fproto_2fconti_5fradar_2eproto__INCLUDED
#define PROTOBUF_modules_2fdrivers_2fproto_2fconti_5fradar_2eproto__INCLUDED
...
class ClusterListStatus_600 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.ClusterListStatus_600) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.ClusterListStatus_600)
 private:
  void set_has_near();
  void clear_has_near();
  void set_has_far();
  ...
  friend struct protobuf_modules_2fdrivers_2fproto_2fconti_5fradar_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class ObjectListStatus_60A : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.ObjectListStatus_60A) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.ObjectListStatus_60A)
 private:
...
class RadarState_201 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.RadarState_201) */ {
 public:
  RadarState_201();
  ...
  ::jmc_auto::drivers::conti_radar::OutputType output_type() const;
  void set_output_type(::jmc_auto::drivers::conti_radar::OutputType value);
  ...
  ::jmc_auto::drivers::conti_radar::RcsThreshold rcs_threshold() const;
  void set_rcs_threshold(::jmc_auto::drivers::conti_radar::RcsThreshold value);
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.RadarState_201)
 private:
...
class ContiRadarObs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.ContiRadarObs) */ {
 public:
  ContiRadarObs();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.ContiRadarObs)
 private:
  void set_has_header();
...
class ContiRadar : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.ContiRadar) */ {
 public:
  ContiRadar();
  virtual ~ContiRadar();
  ...
  const ::jmc_auto::drivers::ContiRadarObs& contiobs(int index) const;
  ::jmc_auto::drivers::ContiRadarObs* mutable_contiobs(int index);
  ::jmc_auto::drivers::ContiRadarObs* add_contiobs();
  ...
  const ::jmc_auto::drivers::RadarState_201& radar_state() const;
  ::jmc_auto::drivers::RadarState_201* mutable_radar_state();
  ::jmc_auto::drivers::RadarState_201* release_radar_state();
  void set_allocated_radar_state(::jmc_auto::drivers::RadarState_201* radar_state);
  ...
  const ::jmc_auto::drivers::ClusterListStatus_600& cluster_list_status() const;
  ::jmc_auto::drivers::ClusterListStatus_600* mutable_cluster_list_status();
  ::jmc_auto::drivers::ClusterListStatus_600* release_cluster_list_status();
  void set_allocated_cluster_list_status(::jmc_auto::drivers::ClusterListStatus_600* cluster_list_status);
  ...
  const ::jmc_auto::drivers::ObjectListStatus_60A& object_list_status() const;
  ::jmc_auto::drivers::ObjectListStatus_60A* mutable_object_list_status();
  ::jmc_auto::drivers::ObjectListStatus_60A* release_object_list_status();
  void set_allocated_object_list_status(::jmc_auto::drivers::ObjectListStatus_60A* object_list_status);

  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.ContiRadar)
 private:
  void set_has_header();
  void clear_has_header();
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::jmc_auto::drivers::ContiRadarObs > contiobs_;
  ::jmc_auto::common::Header* header_;
  ::jmc_auto::drivers::RadarState_201* radar_state_;
  ::jmc_auto::drivers::ClusterListStatus_600* cluster_list_status_;
  ::jmc_auto::drivers::ObjectListStatus_60A* object_list_status_;
  friend struct protobuf_modules_2fdrivers_2fproto_2fconti_5fradar_2eproto::TableStruct;
};
// ===================================================================
...
inline ::jmc_auto::drivers::conti_radar::OutputType RadarState_201::output_type() const {
...
inline void RadarState_201::set_output_type(::jmc_auto::drivers::conti_radar::OutputType value) {
...
inline ::jmc_auto::drivers::conti_radar::RcsThreshold RadarState_201::rcs_threshold() const {
...
inline void RadarState_201::set_rcs_threshold(::jmc_auto::drivers::conti_radar::RcsThreshold value) {
...
inline const ::jmc_auto::common::Header& ContiRadarObs::header() const {
...
inline ::jmc_auto::common::Header* ContiRadarObs::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
...
inline ::jmc_auto::common::Header* ContiRadarObs::release_header() {
...
inline void ContiRadarObs::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline const ::jmc_auto::common::Header& ContiRadar::header() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.ContiRadar.header)
  return header_ != NULL ? *header_
                         : *::jmc_auto::common::Header::internal_default_instance();
}
inline ::jmc_auto::common::Header* ContiRadar::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
    header_ = new ::jmc_auto::common::Header;
  }
...
inline ::jmc_auto::common::Header* ContiRadar::release_header() {
...
inline void ContiRadar::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline const ::jmc_auto::drivers::RadarState_201& ContiRadar::radar_state() const {
...
inline ::jmc_auto::drivers::RadarState_201* ContiRadar::mutable_radar_state() {
  set_has_radar_state();
...
inline ::jmc_auto::drivers::RadarState_201* ContiRadar::release_radar_state() {
...
inline void ContiRadar::set_allocated_radar_state(::jmc_auto::drivers::RadarState_201* radar_state) {
  delete radar_state_;
...
inline const ::jmc_auto::drivers::ClusterListStatus_600& ContiRadar::cluster_list_status() const {
...
inline ::jmc_auto::drivers::ClusterListStatus_600* ContiRadar::mutable_cluster_list_status() {
...
inline ::jmc_auto::drivers::ClusterListStatus_600* ContiRadar::release_cluster_list_status() {
...
inline void ContiRadar::set_allocated_cluster_list_status(::jmc_auto::drivers::ClusterListStatus_600* cluster_list_status) {
...
inline const ::jmc_auto::drivers::ObjectListStatus_60A& ContiRadar::object_list_status() const {
...
inline ::jmc_auto::drivers::ObjectListStatus_60A* ContiRadar::mutable_object_list_status() {
...
inline ::jmc_auto::drivers::ObjectListStatus_60A* ContiRadar::release_object_list_status() {
...
inline void ContiRadar::set_allocated_object_list_status(::jmc_auto::drivers::ObjectListStatus_60A* object_list_status) {
...
#endif  // PROTOBUF_modules_2fdrivers_2fproto_2fconti_5fradar_2eproto__INCLUDED
