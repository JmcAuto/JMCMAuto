...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/drivers/proto/radar.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  _RadarObstacle_default_instance_.get_mutable()->relative_position_ = const_cast< ::jmc_auto::common::Point2D*>(
      ::jmc_auto::common::Point2D::internal_default_instance());
  _RadarObstacle_default_instance_.get_mutable()->relative_velocity_ = const_cast< ::jmc_auto::common::Point2D*>(
      ::jmc_auto::common::Point2D::internal_default_instance());
  _RadarObstacle_default_instance_.get_mutable()->absolute_position_ = const_cast< ::jmc_auto::common::Point2D*>(
      ::jmc_auto::common::Point2D::internal_default_instance());
  _RadarObstacle_default_instance_.get_mutable()->absolute_velocity_ = const_cast< ::jmc_auto::common::Point2D*>(
      ::jmc_auto::common::Point2D::internal_default_instance());
  ...
  _RadarObstacles_default_instance_.get_mutable()->header_ = const_cast< ::jmc_auto::common::Header*>(
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      "\n!modules/drivers/proto/radar.proto\022\020jmc"
      "_auto.drivers\032%modules/common/proto/erro"
      "r_code.proto\032!modules/common/proto/heade"
      "r.proto\032#modules/common/proto/geometry.p"
      "roto\"\330\005\n\rRadarObstacle\022\n\n\002id\030\001 \001(\005\0223\n\021re"
      "lative_position\030\002 \001(\0132\030.jmc_auto.common."
      "Point2D\0223\n\021relative_velocity\030\003 \001(\0132\030.jmc"
      "_auto.common.Point2D\022\013\n\003rcs\030\004 \001(\001\022C\n\rmov"
      "ing_status\030\005 \001(\0162,.jmc_auto.drivers.Rada"
      "rObstacle.MovingStatus\022\r\n\005width\030\006 \001(\001\022\016\n"
      "\006length\030\007 \001(\001\022\016\n\006height\030\010 \001(\001\022\r\n\005theta\030\t"
      " \001(\001\0223\n\021absolute_position\030\n \001(\0132\030.jmc_au"
      "to.common.Point2D\0223\n\021absolute_velocity\030\013"
      " \001(\0132\030.jmc_auto.common.Point2D\022\r\n\005count\030"
      "\014 \001(\005\022\033\n\023moving_frames_count\030\r \001(\005\0226\n\006st"
      "atus\030\016 \001(\0162&.jmc_auto.drivers.RadarObsta"
      "cle.Status\"\256\001\n\006Status\022\r\n\tNO_TARGET\020\000\022\016\n\n"
      "NEW_TARGET\020\001\022\026\n\022NEW_UPDATED_TARGET\020\002\022\022\n\016"
      "UPDATED_TARGET\020\003\022\022\n\016COASTED_TARGET\020\004\022\021\n\r"
      "MERGED_TARGET\020\005\022\032\n\026INVALID_COASTED_TARGE"
      "T\020\006\022\026\n\022NEW_COASTED_TARGET\020\007\"B\n\014MovingSta"
      "tus\022\016\n\nSTATIONARY\020\000\022\013\n\007NEARING\020\001\022\013\n\007AWAY"
      "ING\020\002\022\010\n\004NONE\020\003\"\221\002\n\016RadarObstacles\022K\n\016ra"
      "dar_obstacle\030\001 \003(\01323.jmc_auto.drivers.Ra"
      "darObstacles.RadarObstacleEntry\022\'\n\006heade"
      "r\030\002 \001(\0132\027.jmc_auto.common.Header\0222\n\nerro"
      "r_code\030\003 \001(\0162\032.jmc_auto.common.ErrorCode"
      ":\002OK\032U\n\022RadarObstacleEntry\022\013\n\003key\030\001 \001(\005\022"
      ".\n\005value\030\002 \001(\0132\037.jmc_auto.drivers.RadarO"
      "bstacle:\0028\001"
  };
...
RadarObstacle::RadarObstacle()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fdrivers_2fproto_2fradar_2eproto::InitDefaults();
  }
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.drivers.RadarObstacle)
}
RadarObstacle::RadarObstacle(const RadarObstacle& from)
  ...
  if (from.has_relative_position()) {
    relative_position_ = new ::jmc_auto::common::Point2D(*from.relative_position_);
  } else {
    relative_position_ = NULL;
  }
  if (from.has_relative_velocity()) {
    relative_velocity_ = new ::jmc_auto::common::Point2D(*from.relative_velocity_);
  } else {
    relative_velocity_ = NULL;
  }
  if (from.has_absolute_position()) {
    absolute_position_ = new ::jmc_auto::common::Point2D(*from.absolute_position_);
  } else {
    absolute_position_ = NULL;
  }
  if (from.has_absolute_velocity()) {
    absolute_velocity_ = new ::jmc_auto::common::Point2D(*from.absolute_velocity_);
  } else {
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.drivers.RadarObstacle)
}
...
RadarObstacle::~RadarObstacle() {
  // @@protoc_insertion_point(destructor:jmc_auto.drivers.RadarObstacle)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.drivers.RadarObstacle)
  if (_has_bits_[0 / 32] & 15u) {
    if (has_relative_position()) {
      GOOGLE_DCHECK(relative_position_ != NULL);
      relative_position_->::jmc_auto::common::Point2D::Clear();
    }
    if (has_relative_velocity()) {
      GOOGLE_DCHECK(relative_velocity_ != NULL);
      relative_velocity_->::jmc_auto::common::Point2D::Clear();
    }
    if (has_absolute_position()) {
      GOOGLE_DCHECK(absolute_position_ != NULL);
      absolute_position_->::jmc_auto::common::Point2D::Clear();
    }
    if (has_absolute_velocity()) {
      GOOGLE_DCHECK(absolute_velocity_ != NULL);
      absolute_velocity_->::jmc_auto::common::Point2D::Clear();
    }
  }
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:jmc_auto.drivers.RadarObstacle)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // optional .jmc_auto.common.Point2D relative_position = 2;
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
      ...
      // optional .jmc_auto.common.Point2D relative_velocity = 3;
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
      ...
      // optional .jmc_auto.drivers.RadarObstacle.MovingStatus moving_status = 5;
      case 5: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::jmc_auto::drivers::RadarObstacle_MovingStatus_IsValid(value)) {
            set_moving_status(static_cast< ::jmc_auto::drivers::RadarObstacle_MovingStatus >(value));
          } else {
      ...
      // optional .jmc_auto.common.Point2D absolute_position = 10;
      case 10: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
      ...
      // optional .jmc_auto.common.Point2D absolute_velocity = 11;
      case 11: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
      ...
      // optional .jmc_auto.drivers.RadarObstacle.Status status = 14;
      case 14: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::jmc_auto::drivers::RadarObstacle_Status_IsValid(value)) {
            set_status(static_cast< ::jmc_auto::drivers::RadarObstacle_Status >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.drivers.RadarObstacle)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.drivers.RadarObstacle)
  return false;
#undef DO_
}
...
void RadarObstacle::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:jmc_auto.drivers.RadarObstacle)
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.drivers.RadarObstacle)
}

::google::protobuf::uint8* RadarObstacle::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.drivers.RadarObstacle)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.drivers.RadarObstacle)
  return target;
}

size_t RadarObstacle::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.drivers.RadarObstacle)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.drivers.RadarObstacle)
  GOOGLE_DCHECK_NE(&from, this);
  const RadarObstacle* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const RadarObstacle>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.drivers.RadarObstacle)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.drivers.RadarObstacle)
    MergeFrom(*source);
  }
}

void RadarObstacle::MergeFrom(const RadarObstacle& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.drivers.RadarObstacle)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 255u) {
    if (cached_has_bits & 0x00000001u) {
      mutable_relative_position()->::jmc_auto::common::Point2D::MergeFrom(from.relative_position());
    }
    if (cached_has_bits & 0x00000002u) {
      mutable_relative_velocity()->::jmc_auto::common::Point2D::MergeFrom(from.relative_velocity());
    }
    if (cached_has_bits & 0x00000004u) {
      mutable_absolute_position()->::jmc_auto::common::Point2D::MergeFrom(from.absolute_position());
    }
    if (cached_has_bits & 0x00000008u) {
      mutable_absolute_velocity()->::jmc_auto::common::Point2D::MergeFrom(from.absolute_velocity());
    }
    if (cached_has_bits & 0x00000010u) {
      id_ = from.id_;
    }
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.drivers.RadarObstacle)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.drivers.RadarObstacle)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::int32 RadarObstacle::id() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.id)
  return id_;
}
void RadarObstacle::set_id(::google::protobuf::int32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.RadarObstacle.id)
}
...
void RadarObstacle::clear_relative_position() {
  if (relative_position_ != NULL) relative_position_->::jmc_auto::common::Point2D::Clear();
  clear_has_relative_position();
}
const ::jmc_auto::common::Point2D& RadarObstacle::relative_position() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.relative_position)
  return relative_position_ != NULL ? *relative_position_
                         : *::jmc_auto::common::Point2D::internal_default_instance();
}
::jmc_auto::common::Point2D* RadarObstacle::mutable_relative_position() {
  set_has_relative_position();
  if (relative_position_ == NULL) {
    relative_position_ = new ::jmc_auto::common::Point2D;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.drivers.RadarObstacle.relative_position)
  return relative_position_;
}
::jmc_auto::common::Point2D* RadarObstacle::release_relative_position() {
  // @@protoc_insertion_point(field_release:jmc_auto.drivers.RadarObstacle.relative_position)
  clear_has_relative_position();
  ::jmc_auto::common::Point2D* temp = relative_position_;
  relative_position_ = NULL;
  return temp;
}
void RadarObstacle::set_allocated_relative_position(::jmc_auto::common::Point2D* relative_position) {
  delete relative_position_;
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.drivers.RadarObstacle.relative_position)
}
...
void RadarObstacle::clear_relative_velocity() {
  if (relative_velocity_ != NULL) relative_velocity_->::jmc_auto::common::Point2D::Clear();
  clear_has_relative_velocity();
}
const ::jmc_auto::common::Point2D& RadarObstacle::relative_velocity() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.relative_velocity)
  return relative_velocity_ != NULL ? *relative_velocity_
                         : *::jmc_auto::common::Point2D::internal_default_instance();
}
::jmc_auto::common::Point2D* RadarObstacle::mutable_relative_velocity() {
  set_has_relative_velocity();
  if (relative_velocity_ == NULL) {
    relative_velocity_ = new ::jmc_auto::common::Point2D;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.drivers.RadarObstacle.relative_velocity)
  return relative_velocity_;
}
::jmc_auto::common::Point2D* RadarObstacle::release_relative_velocity() {
  // @@protoc_insertion_point(field_release:jmc_auto.drivers.RadarObstacle.relative_velocity)
  clear_has_relative_velocity();
  ::jmc_auto::common::Point2D* temp = relative_velocity_;
  relative_velocity_ = NULL;
  return temp;
}
void RadarObstacle::set_allocated_relative_velocity(::jmc_auto::common::Point2D* relative_velocity) {
  delete relative_velocity_;
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.drivers.RadarObstacle.relative_velocity)
}
...
double RadarObstacle::rcs() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.rcs)
  return rcs_;
}
void RadarObstacle::set_rcs(double value) {
  set_has_rcs();
  rcs_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.RadarObstacle.rcs)
}
...
::jmc_auto::drivers::RadarObstacle_MovingStatus RadarObstacle::moving_status() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.moving_status)
  return static_cast< ::jmc_auto::drivers::RadarObstacle_MovingStatus >(moving_status_);
}
void RadarObstacle::set_moving_status(::jmc_auto::drivers::RadarObstacle_MovingStatus value) {
  assert(::jmc_auto::drivers::RadarObstacle_MovingStatus_IsValid(value));
  set_has_moving_status();
  moving_status_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.RadarObstacle.moving_status)
}
...
double RadarObstacle::width() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.width)
  return width_;
}
void RadarObstacle::set_width(double value) {
  set_has_width();
  width_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.RadarObstacle.width)
}
...
double RadarObstacle::length() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.length)
  return length_;
}
void RadarObstacle::set_length(double value) {
  set_has_length();
  length_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.RadarObstacle.length)
}
...
double RadarObstacle::height() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.height)
  return height_;
}
void RadarObstacle::set_height(double value) {
  set_has_height();
  height_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.RadarObstacle.height)
}
...
double RadarObstacle::theta() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.theta)
  return theta_;
}
void RadarObstacle::set_theta(double value) {
  set_has_theta();
  theta_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.RadarObstacle.theta)
}
...
void RadarObstacle::clear_absolute_position() {
  if (absolute_position_ != NULL) absolute_position_->::jmc_auto::common::Point2D::Clear();
  clear_has_absolute_position();
}
const ::jmc_auto::common::Point2D& RadarObstacle::absolute_position() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.absolute_position)
  return absolute_position_ != NULL ? *absolute_position_
                         : *::jmc_auto::common::Point2D::internal_default_instance();
}
::jmc_auto::common::Point2D* RadarObstacle::mutable_absolute_position() {
  set_has_absolute_position();
  if (absolute_position_ == NULL) {
    absolute_position_ = new ::jmc_auto::common::Point2D;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.drivers.RadarObstacle.absolute_position)
  return absolute_position_;
}
::jmc_auto::common::Point2D* RadarObstacle::release_absolute_position() {
  // @@protoc_insertion_point(field_release:jmc_auto.drivers.RadarObstacle.absolute_position)
  clear_has_absolute_position();
  ::jmc_auto::common::Point2D* temp = absolute_position_;
  absolute_position_ = NULL;
  return temp;
}
void RadarObstacle::set_allocated_absolute_position(::jmc_auto::common::Point2D* absolute_position) {
  delete absolute_position_;
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.drivers.RadarObstacle.absolute_position)
}
...
void RadarObstacle::clear_absolute_velocity() {
  if (absolute_velocity_ != NULL) absolute_velocity_->::jmc_auto::common::Point2D::Clear();
  clear_has_absolute_velocity();
}
const ::jmc_auto::common::Point2D& RadarObstacle::absolute_velocity() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.absolute_velocity)
  return absolute_velocity_ != NULL ? *absolute_velocity_
                         : *::jmc_auto::common::Point2D::internal_default_instance();
}
::jmc_auto::common::Point2D* RadarObstacle::mutable_absolute_velocity() {
  set_has_absolute_velocity();
  if (absolute_velocity_ == NULL) {
    absolute_velocity_ = new ::jmc_auto::common::Point2D;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.drivers.RadarObstacle.absolute_velocity)
  return absolute_velocity_;
}
::jmc_auto::common::Point2D* RadarObstacle::release_absolute_velocity() {
  // @@protoc_insertion_point(field_release:jmc_auto.drivers.RadarObstacle.absolute_velocity)
  clear_has_absolute_velocity();
  ::jmc_auto::common::Point2D* temp = absolute_velocity_;
  absolute_velocity_ = NULL;
  return temp;
}
void RadarObstacle::set_allocated_absolute_velocity(::jmc_auto::common::Point2D* absolute_velocity) {
  delete absolute_velocity_;
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.drivers.RadarObstacle.absolute_velocity)
}
...
::google::protobuf::int32 RadarObstacle::count() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.count)
  return count_;
}
void RadarObstacle::set_count(::google::protobuf::int32 value) {
  set_has_count();
  count_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.RadarObstacle.count)
}
...
::google::protobuf::int32 RadarObstacle::moving_frames_count() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.moving_frames_count)
...
void RadarObstacle::set_moving_frames_count(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.RadarObstacle.moving_frames_count)
}
...
::jmc_auto::drivers::RadarObstacle_Status RadarObstacle::status() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacle.status)
  return static_cast< ::jmc_auto::drivers::RadarObstacle_Status >(status_);
}
void RadarObstacle::set_status(::jmc_auto::drivers::RadarObstacle_Status value) {
  assert(::jmc_auto::drivers::RadarObstacle_Status_IsValid(value));
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.RadarObstacle.status)
}
...
RadarObstacles::RadarObstacles()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:jmc_auto.drivers.RadarObstacles)
}
RadarObstacles::RadarObstacles(const RadarObstacles& from)
  ...
  // @@protoc_insertion_point(copy_constructor:jmc_auto.drivers.RadarObstacles)
}
...
RadarObstacles::~RadarObstacles() {
  // @@protoc_insertion_point(destructor:jmc_auto.drivers.RadarObstacles)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:jmc_auto.drivers.RadarObstacles)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:jmc_auto.drivers.RadarObstacles)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // map<int32, .jmc_auto.drivers.RadarObstacle> radar_obstacle = 1;
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(10u)) {
          RadarObstacles_RadarObstacleEntry::Parser< ::google::protobuf::internal::MapField<
              RadarObstacles_RadarObstacleEntry,
              ::google::protobuf::int32, ::jmc_auto::drivers::RadarObstacle,
              ::google::protobuf::internal::WireFormatLite::TYPE_INT32,
              ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
              0 >,
            ::google::protobuf::Map< ::google::protobuf::int32, ::jmc_auto::drivers::RadarObstacle > > parser(&radar_obstacle_);
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
              input, &parser));
        } else {
          goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:jmc_auto.drivers.RadarObstacles)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:jmc_auto.drivers.RadarObstacles)
  return false;
#undef DO_
}
...
void RadarObstacles::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:jmc_auto.drivers.RadarObstacles)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  // map<int32, .jmc_auto.drivers.RadarObstacle> radar_obstacle = 1;
  if (!this->radar_obstacle().empty()) {
    typedef ::google::protobuf::Map< ::google::protobuf::int32, ::jmc_auto::drivers::RadarObstacle >::const_pointer
        ConstPtr;
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      typedef ::google::protobuf::Map< ::google::protobuf::int32, ::jmc_auto::drivers::RadarObstacle >::size_type size_type;
      size_type n = 0;
      for (::google::protobuf::Map< ::google::protobuf::int32, ::jmc_auto::drivers::RadarObstacle >::const_iterator
  ...
  // @@protoc_insertion_point(serialize_end:jmc_auto.drivers.RadarObstacles)
}

::google::protobuf::uint8* RadarObstacles::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:jmc_auto.drivers.RadarObstacles)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jmc_auto.drivers.RadarObstacles)
  return target;
}

size_t RadarObstacles::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jmc_auto.drivers.RadarObstacles)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:jmc_auto.drivers.RadarObstacles)
  GOOGLE_DCHECK_NE(&from, this);
  const RadarObstacles* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const RadarObstacles>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:jmc_auto.drivers.RadarObstacles)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:jmc_auto.drivers.RadarObstacles)
    MergeFrom(*source);
  }
}

void RadarObstacles::MergeFrom(const RadarObstacles& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:jmc_auto.drivers.RadarObstacles)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:jmc_auto.drivers.RadarObstacles)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:jmc_auto.drivers.RadarObstacles)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void RadarObstacles::clear_radar_obstacle() {
 ...
 const ::google::protobuf::Map< ::google::protobuf::int32, ::jmc_auto::drivers::RadarObstacle >&
RadarObstacles::radar_obstacle() const {
  // @@protoc_insertion_point(field_map:jmc_auto.drivers.RadarObstacles.radar_obstacle)
  return radar_obstacle_.GetMap();
}
 ::google::protobuf::Map< ::google::protobuf::int32, ::jmc_auto::drivers::RadarObstacle >*
RadarObstacles::mutable_radar_obstacle() {
  // @@protoc_insertion_point(field_mutable_map:jmc_auto.drivers.RadarObstacles.radar_obstacle)
...
const ::jmc_auto::common::Header& RadarObstacles::header() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacles.header)
  return header_ != NULL ? *header_
                         : *::jmc_auto::common::Header::internal_default_instance();
}
::jmc_auto::common::Header* RadarObstacles::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
    header_ = new ::jmc_auto::common::Header;
  }
  // @@protoc_insertion_point(field_mutable:jmc_auto.drivers.RadarObstacles.header)
  return header_;
}
::jmc_auto::common::Header* RadarObstacles::release_header() {
  // @@protoc_insertion_point(field_release:jmc_auto.drivers.RadarObstacles.header)
  clear_has_header();
  ::jmc_auto::common::Header* temp = header_;
  header_ = NULL;
  return temp;
}
void RadarObstacles::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
  ...
  // @@protoc_insertion_point(field_set_allocated:jmc_auto.drivers.RadarObstacles.header)
}
...
::jmc_auto::common::ErrorCode RadarObstacles::error_code() const {
  // @@protoc_insertion_point(field_get:jmc_auto.drivers.RadarObstacles.error_code)
  return static_cast< ::jmc_auto::common::ErrorCode >(error_code_);
}
void RadarObstacles::set_error_code(::jmc_auto::common::ErrorCode value) {
  assert(::jmc_auto::common::ErrorCode_IsValid(value));
  set_has_error_code();
  error_code_ = value;
  // @@protoc_insertion_point(field_set:jmc_auto.drivers.RadarObstacles.error_code)
}
