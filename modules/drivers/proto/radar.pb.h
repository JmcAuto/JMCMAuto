...
#ifndef PROTOBUF_modules_2fdrivers_2fproto_2fradar_2eproto__INCLUDED
#define PROTOBUF_modules_2fdrivers_2fproto_2fradar_2eproto__INCLUDED
...
class RadarObstacle : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.RadarObstacle) */ {
 public:
  RadarObstacle();
  ...
  const ::jmc_auto::common::Point2D& relative_position() const;
  ::jmc_auto::common::Point2D* mutable_relative_position();
  ::jmc_auto::common::Point2D* release_relative_position();
  void set_allocated_relative_position(::jmc_auto::common::Point2D* relative_position);
  ...
  const ::jmc_auto::common::Point2D& relative_velocity() const;
  ::jmc_auto::common::Point2D* mutable_relative_velocity();
  ::jmc_auto::common::Point2D* release_relative_velocity();
  void set_allocated_relative_velocity(::jmc_auto::common::Point2D* relative_velocity);
  ...
  const ::jmc_auto::common::Point2D& absolute_position() const;
  ::jmc_auto::common::Point2D* mutable_absolute_position();
  ::jmc_auto::common::Point2D* release_absolute_position();
  void set_allocated_absolute_position(::jmc_auto::common::Point2D* absolute_position);
  ...
  const ::jmc_auto::common::Point2D& absolute_velocity() const;
  ::jmc_auto::common::Point2D* mutable_absolute_velocity();
  ::jmc_auto::common::Point2D* release_absolute_velocity();
  void set_allocated_absolute_velocity(::jmc_auto::common::Point2D* absolute_velocity);
  ...
  ::jmc_auto::drivers::RadarObstacle_MovingStatus moving_status() const;
  void set_moving_status(::jmc_auto::drivers::RadarObstacle_MovingStatus value);
  ...
  ::jmc_auto::drivers::RadarObstacle_Status status() const;
  void set_status(::jmc_auto::drivers::RadarObstacle_Status value);

  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.RadarObstacle)
 private:
  void set_has_id();
  void clear_has_id();
  ...
  ::jmc_auto::common::Point2D* relative_position_;
  ::jmc_auto::common::Point2D* relative_velocity_;
  ::jmc_auto::common::Point2D* absolute_position_;
  ::jmc_auto::common::Point2D* absolute_velocity_;
...
class RadarObstacles : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jmc_auto.drivers.RadarObstacles) */ {
 public:
  RadarObstacles();
  ...
  // @@protoc_insertion_point(class_scope:jmc_auto.drivers.RadarObstacles)
 private:
  void set_has_header();
...
inline const ::jmc_auto::common::Point2D& RadarObstacle::relative_position() const {
...
inline ::jmc_auto::common::Point2D* RadarObstacle::mutable_relative_position() {
...
inline ::jmc_auto::common::Point2D* RadarObstacle::release_relative_position() {
...
inline void RadarObstacle::set_allocated_relative_position(::jmc_auto::common::Point2D* relative_position) {
...
inline const ::jmc_auto::common::Point2D& RadarObstacle::relative_velocity() const {
...
inline ::jmc_auto::common::Point2D* RadarObstacle::mutable_relative_velocity() {
...
inline ::jmc_auto::common::Point2D* RadarObstacle::release_relative_velocity() {
...
inline void RadarObstacle::set_allocated_relative_velocity(::jmc_auto::common::Point2D* relative_velocity) {
...
inline ::jmc_auto::drivers::RadarObstacle_MovingStatus RadarObstacle::moving_status() const {
...
inline void RadarObstacle::set_moving_status(::jmc_auto::drivers::RadarObstacle_MovingStatus value) {
...
inline const ::jmc_auto::common::Point2D& RadarObstacle::absolute_position() const {
...
inline ::jmc_auto::common::Point2D* RadarObstacle::mutable_absolute_position() {
...
inline ::jmc_auto::common::Point2D* RadarObstacle::release_absolute_position() {
...
inline void RadarObstacle::set_allocated_absolute_position(::jmc_auto::common::Point2D* absolute_position) {
...
inline const ::jmc_auto::common::Point2D& RadarObstacle::absolute_velocity() const {
...
inline ::jmc_auto::common::Point2D* RadarObstacle::mutable_absolute_velocity() {
...
inline ::jmc_auto::common::Point2D* RadarObstacle::release_absolute_velocity() {
...
inline void RadarObstacle::set_allocated_absolute_velocity(::jmc_auto::common::Point2D* absolute_velocity) {
...
inline ::jmc_auto::drivers::RadarObstacle_Status RadarObstacle::status() const {
...
inline void RadarObstacle::set_status(::jmc_auto::drivers::RadarObstacle_Status value) {
...
inline const ::google::protobuf::Map< ::google::protobuf::int32, ::jmc_auto::drivers::RadarObstacle >&
...
inline ::google::protobuf::Map< ::google::protobuf::int32, ::jmc_auto::drivers::RadarObstacle >*
...
inline const ::jmc_auto::common::Header& RadarObstacles::header() const {
...
inline ::jmc_auto::common::Header* RadarObstacles::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
...
inline ::jmc_auto::common::Header* RadarObstacles::release_header() {
...
inline void RadarObstacles::set_allocated_header(::jmc_auto::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline ::jmc_auto::common::ErrorCode RadarObstacles::error_code() const {
...
inline void RadarObstacles::set_error_code(::jmc_auto::common::ErrorCode value) {
...
template <> struct is_proto_enum< ::jmc_auto::drivers::RadarObstacle_Status> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::drivers::RadarObstacle_Status>() {
  return ::jmc_auto::drivers::RadarObstacle_Status_descriptor();
}
template <> struct is_proto_enum< ::jmc_auto::drivers::RadarObstacle_MovingStatus> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::jmc_auto::drivers::RadarObstacle_MovingStatus>() {
  return ::jmc_auto::drivers::RadarObstacle_MovingStatus_descriptor();
}
...
#endif  // PROTOBUF_modules_2fdrivers_2fproto_2fradar_2eproto__INCLUDED
