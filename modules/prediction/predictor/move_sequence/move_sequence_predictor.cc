...
using ::jmc_auto::prediction::math_util::EvaluateQuarticPolynomial;
using ::jmc_auto::prediction::math_util::EvaluateQuinticPolynomial;
...
std::pair<double, double> MoveSequencePredictor::ComputeLonEndState(
  ...
  double v_end = jmc_auto::prediction::predictor_util::AdjustSpeedByCurvature(
      init_s[1], max_kappa);
