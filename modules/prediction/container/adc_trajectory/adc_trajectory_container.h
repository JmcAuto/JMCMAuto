...
class ADCTrajectoryContainer : public Container {
 public:
   ...
   */
  bool IsPointInJunction(const jmc_auto::common::PathPoint& point) const;
   ...
   */
  void SetPosition(const ::jmc_auto::common::math::Vec2d& position);
 ...
 private:
  ::jmc_auto::planning::ADCTrajectory adc_trajectory_;
  ::jmc_auto::common::math::Polygon2d adc_junction_polygon_;
