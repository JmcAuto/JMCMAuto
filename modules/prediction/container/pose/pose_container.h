...
class PoseContainer : public Container {
 public:
   ...
   */
  jmc_auto::perception::PerceptionObstacle* ToPerceptionObstacle();
 ...
 public:
  ...
  static const jmc_auto::perception::PerceptionObstacle::Type type_ =
      perception::PerceptionObstacle::VEHICLE;

 private:
  std::unique_ptr<jmc_auto::perception::PerceptionObstacle> obstacle_ptr_;
};
